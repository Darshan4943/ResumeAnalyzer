...
function TransformJob() {
  ...
  const transformHandler = () => {
    ...
    axios
      .post("https://api.shindedarshan.com/api/cv/transform", {
        jd: text,
        json: selected,
      })
      .then((res) => {
    ...
    if (userDataGlobal.role == "recruiter") {
      axios
        ...
        .then((res) => {
          ...
          if (result?.length > 0) {
            axios
              .get("https://api.shindedarshan.com/api/resume/" + res.data.data[0]?._id)
              .then((res) => {
  ...
  const selectHandler = (data) => {
    if (userDataGlobal.role == "recruiter") {
      ...
      axios
        .get("https://api.shindedarshan.com/api/resume/" + data.value)
        .then((res) => {
          setResumeList(res.data.data);
          setSelect(res.data.data[0]);
        })
