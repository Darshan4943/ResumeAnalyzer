...
function OfferAccept() {
    ...
    const getOfferAcceptanceStatus = async () => {
        try {
            const response = await axios.get(`https://api.skilotech.com/api/preboarding/offerAcceptanceStatus/${applicantId}/${jobId}`);
    ...
    const OfferUpdate = async () => {
        ...
        try {
            const response = await axios.put(`https://api.skilotech.com/api/preboarding/offerAccept/${applicantId}/${jobId}`, { status })
            setLoading(false)
            setLoading1(false)
