...
function BulkUploads() {
      ...
      icon: (
        ...
        >
          <g mask="url(#mask0_7804_70338)">
            <path
              d="M11.1407 16.5378H7.37146C6.11582 16.5378 5.04551 16.0953 4.16051 15.2105C3.27551 14.3256 2.83301 13.2554 2.83301 11.9999C2.83301 10.7444 3.27551 9.67406 4.16051 8.78881C5.04551 7.90356 6.11582 7.46094 7.37146 7.46094H11.1407V8.96089H7.37146C6.53171 8.96089 5.81536 9.25736 5.22241 9.85031C4.62946 10.4433 4.33298 11.1596 4.33298 11.9994C4.33298 12.8391 4.62946 13.5555 5.22241 14.1484C5.81536 14.7414 6.53171 15.0378 7.37146 15.0378H11.1407V16.5378ZM8.58301 12.7493V11.2494H16.083V12.7493H8.58301ZM13.5253 16.5378V15.0378H17.2945C18.1343 15.0378 18.8506 14.7414 19.4436 14.1484C20.0365 13.5555 20.333 12.8391 20.333 11.9994C20.333 11.1596 20.0365 10.4433 19.4436 9.85031C18.8506 9.25736 18.1343 8.96089 17.2945 8.96089H13.5253V7.46094H17.2945C18.5501 7.46094 19.6205 7.90338 20.5055 8.78826C21.3905 9.67315 21.833 10.7433 21.833 11.9988C21.833 13.2543 21.3905 14.3247 20.5055 15.2099C19.6205 16.0952 18.5501 16.5378 17.2945 16.5378H13.5253Z"
              fill="#333333"
            />
          </g>
        </svg>
  ...
  return (
    <>
        ...
        <div className="grid items-start gap-4 ml:h-[80vh] overflow-y-auto pb-2">
          ...
          <div className=" flex p-[24px] w-[100%]  flex-col justify-center items-center gap-4 rounded-[8px] border-[2px] border-dashed border-[#06A9EF] bg-[#EFFAFF]">
            ...
            <div className="flex flex-col">
              <p className="text-[12px] sm:text-[14px] text-[#333] font-[400] leading-[160%] ">
                {" "}
                <span className="text-[#06A9EF] font-[400] ">
                  Browse file
                </span>{" "}
                or drag and drop
              </p>
          ...
          <div className="flex gap-6 items-center">
            <div className="flex gap-3 items-center">
              <p className="text-[11px] sm:text-[16px] text-[#333]">
                Set Filter Limit
              </p>
          ...
          <div className="flex flex-col">
            ...
            <p className="font-[400] text-[10px] sm:text-[14px]">
              ...
              <span className="text-[#06A9EF] text-[10px] sm:text-[14px] font-[500]">
                fetching data
              </span>{" "}
              for you ...... let,s shortlist best candidates for your
              preference....
            </p>
          </div>
              ...
              >
                ...
                <div className=" w-[100%]  flex flex-col items-start gap-4">
                  ...
                  {contact_info.map((e, index) => (
                    <div key={index} className="flex break-all gap-[8px]">
                      {e.icon}
                      <p className="text-[14px] sm:text-[16px] text-[#333] font-[400]">
                        {e.text}
                      </p>
                    </div>
                  ))}
                ...
                <div className=" flex flex-col w-[100%] items-start gap-4">
                  <div className="flex justify-center w-[100%] p-[15px] scr1200:p-[24px] items-center gap-[15px] scr1350:gap-[24px] rounded-[12px] border-[1px] border-[#06A9EF] bg-[#fff]">
                    <p className="text-[#333] scr1350:text-[20px] scr1200:text-[17px] text-[14px] font-[500] ">
                      Profile Match Score
                    </p>
                    <p className="text-[#333] text-[23px] scr1350:text-[36px] scr1200:text-[30px] font-[500] ">
                      87 %
                    </p>
                  </div>
                    ...
                    <div className="flex p-4 justify-betweeen items-center bg-[#fff] border-[1px] border-t-[#DEDEDE] border-r-[#DEDEDE] border-b-[#DEDEDE] border-l-[#fff] rounded-tr-[12px] rounded-br-[12px]">
                      <div className="flex flex-col gap-[8px] items-start ">
                        <p className="text-[14px] text-[#333] font-[500] ">
                          John Doe Resume Bsc CS 2024.pdf (Default)
                        </p>
                        <p className="text-[12px] text-[#646464] font-[400]">
                          190 Kb
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex gap-[16px] w-[100%] items-start">
                    <button
                      onClick={() =>
                        router.push(
                          "/employer/afterLogin/Hiring?content=JobPost"
                        )
                      }
                      className="flex py-[12px] w-[50%] scr1200:px-[9px] scr1350:px-[22px] justify-center items-center gap-[10px] rounded-[12px] bg-[#06A9EF] text-[12px] sm:text-[16px] text-[#fff] font-[600] leading-[160%]"
                    >
                      Move to Hiring
                    </button>
                    <button
                      onClick={toggleContent}
                      className="flex py-[12px] w-[50%] scr1200:px-[9px] scr1350:px-[22px] justify-center items-center gap-[10px] rounded-[12px] text-[12px] sm:text-[15px] text-[#333] font-[500] border-[1px] border-[#06A9EF] leading-[160%]"
                    >
                      See Application
                    </button>
                  </div>
      ...
      {toggle === 1 && (
        <ApplicantsDetails
          setIsApplicantDetails={setIsApplicantDetails}
          setTogglee={setToggle}
        />
      )}
    </>
  );
