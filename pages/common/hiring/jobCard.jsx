...
const JobCard = () => {
    ...
    return (
        <div >
                        ...
                        >
                            <div className="flex justify-between w-[100%]">
                                ...
                                <div className="flex gap-[6px]">
                                    <svg onClick={(e) => { e.stopPropagation(); router.push(`/common/jobPosting/CreateNewJob?id=${job._id}`) }} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {totalCount > 5 ?
                <>
                    <div className="sm:px-[16px] px-0 pt-[24px] w-full justify-between flex ">
