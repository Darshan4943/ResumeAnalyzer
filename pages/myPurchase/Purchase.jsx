    ...
    return (
        <div className='pt-9 flex flex-col gap-9'>
            <div className='flex flex-col justify-center items-center bg-blue h-[89px]  py-3'>
                ...
                <div className=' font-medium text-[16px] text-white'>Purchase plan and make payment here to start using Skilotech</div>

            </div>
            <div className='flex items-center justify-center pb-12 scr1100:px-[100px] px-6'>
                <div style={{ boxShadow: "0px 0px 6px 0px #00000040"}} className=' flex gap-12 p-6 rounded-[16px] w-[100%]'>
                    <div className='flex flex-col gap-4 justify-between w-[40%]'>
                        ...
                        {plans.map((plan, index) => (
                            <div key={index} className=' relative bg-white  flex flex-col gap-4 items-center rounded-[16px] ' style={{ boxShadow: "0px 0px 6px 0px #00000040" }}>
                        ...
                        <button onClick={() => router.push("/myPurchase/MyPurchase")} className="px-9 py-3 border border-[#06A9EF] w-[150px] rounded-[12px] text-[16px] font-medium ">Go Back</button>
