    ...
    return (
        <div className='flex flex-col gap-4 p-6'>
            <div className='flex text-[24px] font-semibold gap-4 items-center'>
                <svg className=' cursor-pointer' onClick={() => router.push("/myClients")} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">

                    <g mask="url(#mask0_629_16604)">
                        <path d="M11.9583 21.3892L21.9584 31.3892L20 33.3337L6.66669 20.0003L20 6.66699L21.9584 8.61141L11.9583 18.6115H33.3334V21.3892H11.9583Z" fill="#1C1B1F" />
                    </g>
                </svg>
