...
function Notifications() {
  ...
  return (
    <div className="flex flex-col w-[100%] items-center gap-4 customMargins">
      <div
      ...
      >
        ...
        <div className="flex w-[100%] ms:flex-row flex-col">
          <div className="ms:w-[70%] w-[100%] pb-[5px] flex items-start gap-[12px] overflow-x-auto">
            {notification.map((e) => (
              <button
          ...
          <div className="ms:w-[30%] w-[100%] flex justify-end items-end">
