      ...
      <div className="rounded-md bg-white shadow-md flex  justify-center items-center group relative ">
        <div className="text-[#333] justify-center items-center text-[14px] flex font-medium w-auto px-4 py-3 gap-1">
          <div class="">
            ...
            <div class="  hidden dropdown mt-1 bg-[#fff] p-4 group-hover:block  rounded-[6px] dropdown-hover:block absolute bottom-100 left-[1px] w-[340px] gap-[10px] top-[46px]" style={{ boxShadow: "0px 2px 4px 0px rgba(0, 0, 0, 0.25)" }}>
      ...
      <div className="bg-[#F9F9F9]">
        <div className=" customMargins ">
          <div className="grid grid-cols-12 py-[24px] gap-[24px] ">
            ...
            {/* SECOND SECTION   */}
            <div className={`flex flex-col p-3 ${toggle ? 'col-span-4' : 'col-span-5'} rounded-md border-primary bg-white shadow-md`} style={{
              boxShadow: "0px 2px 2px 0px rgba(0, 0, 0, 0.25)",
            }}>
            <div
            className="p-[8px]  leading-tight"
          ...
          >
            ...
            {/* LAST SECTION   */}
            <div className={`flex ${toggle ? 'col-span-5' : 'col-span-7'} flex-col  `}>
            <div
