    ...
    const parseData = (file, setText) => {
        return new Promise((resolve, reject) => {
            ...
            // PDF file extraction
                ...
                for (let i = 1; i <= 1; i++) {
                    pdfTextPromises.push(fileToText(file, i)); // Assuming fileToText extracts PDF text by page
                }
            ...
            <div className="customMargins wl:w-[80%] w-[100%]">
                ...
                >
                    <div className=" flex ml:flex-row flex-col sm:gap-4 gap-2 ml:items-center ">
                        ...
                        <svg className=" cursor-pointer" onClick={() => router.back()} width="28" height="29" viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg">

                            <g mask="url(#mask0_5716_128816)">
                                <path d="M9.12656 15.665L15.6599 22.1984L13.9974 23.8317L4.66406 14.4984L13.9974 5.16504L15.6599 6.79837L9.12656 13.3317H23.3307V15.665H9.12656Z" fill="#1C1B1F" />
                            </g>
                        </svg>
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-row justify-between items-center sm:p-4 p-2 w-full">
                                            ...
                                            <div className="flex flex-row sm:gap-4 gap-2 h-[40px] py-1 items-center">
                                                <div onClick={() => handleDownload(item.resumeUrl, item.fileName)} className='px-[10px] py-1 border border-[#06A9EF] rounded-[8px] cursor-pointer'>
