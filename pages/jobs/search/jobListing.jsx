...
const JobListing = ({ jobs }) => {
  ...
  return (
    <div className="flex flex-col gap-4 min-h-[70vh] ">
      {jd && <Details data={jd} setSelectedFile={setJd} />}
            ...
            {jobs?.length > 0 ? (
              <>
                {jobs
                  ...
                  ?.map((data, index) => (
                    <div
                      className="flex flex-col gap-[8px] md:w-[48%] w-[100%] max-w-[380px] rounded-[16px] border border-[#DEDEDE] bg-white shadow-lg py-[16px] ml:px-[24px] px-3 min-w-[300px] group"
                      key={index}
                    >
                      ...
                      <div className="flex flex-row justify-between items-center">
                        ...
                        <button className="px-[16px] py-[8px] w-[112px] bg-[#06A9EF] rounded-[8px] text-[#fff]">
                          Apply
                        </button>
                      </div>
                    </div>
