...
function ApplyForm() {
  ...
  useEffect(() => {
    axios
      .get(`https://api.skilotech.com/api/job/getByJobId/${id}`)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.skilotech.com/api/userJobDetails/getUserJobDetailsById/${userDataGlobal?._id}`
      )
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`https://api.skilotech.com/api/resume/${userDataGlobal?._id}`)
      .then((res) => {
  ...
  const updateApplyCount = () => {
    axios
      .put(
        `https://api.skilotech.com/api/subscription/updateApplyLimit/${userDataGlobal?._id}`
      )
      .then((res) => {})
      .catch((err) => console.error(err));
  };
  ...
  const applyForJob = () => {
    ...
    axios
      .post(`https://api.skilotech.com/api/job/apply/${id}`, formDataToSend, {
        headers: {
      ...
      .finally(() => {
        axios
          .post(
            "https://api.skilotech.com/api/userJobDetails/createOrUpdateUserJobDetails",
            {
