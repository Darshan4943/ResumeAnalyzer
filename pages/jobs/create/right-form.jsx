        ...
        <div className="flex flex-col gap-[16px] w-[100%]">
          <div className="flex sm:flex-row flex-col w-[100%] sm:gap-4 gap-[16px] ">
            ...
            <div className="sm:w-[50%] w-full flex flex-col gap-[8px]">
              ...
              <div className="flex flex-col items-center rounded-lg border border-[#DEDEDE] bg-white text-[14px] font-montserrat font-small relative min-w-[100px] max-w-[308px] overflow-visible h-[42px]">
                <ReactSelect
