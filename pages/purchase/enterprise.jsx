  ...
  const planEnquiry = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://api.skilotech.com/api/planEnquiry/create",
        data
      );
      ...
      {successModel && (
        <>
          ...
          <div className="fixed z-[300] top-0 left-0 right-0 bottom-0 flex items-center justify-center customMargins   ">
            <div className=" absolute rounded-[16px] bg-white shadow-lg pt-[60px] pb-6 px-6 flex flex-col gap-6 ml:min-w-[350px] ml:w-[30%] ms:w-[50%] scr420:w-[80%] w-[90%] ">
              <svg
        ...
        >
          ...
          >
            <div className="flex text-center flex-col gap-9 text-[#333333] items-center  justify-between">
              ...
              <p className="scr700:text-[1vw] text-[20px] font-[500]">
