      ...
      <div className="flex flex-col gap-[14px]">
        ...
        <div className="w-full h-[calc(100vh-220px)] rounded-[32px] bg-[url('/images/ChatBotBG.png')] bg-cover bg-center grid grid-cols-[1fr_2fr] gap-9 p-6">
          <div className="w-full h-full flex flex-col justify-between">
            ...
            <div className="flex border-[1px] border-[#DEDEDE]   px-[16px] py-2 justify-between  rounded-[8px] w-full">
              <input
          ...
          <div className="w-full h-full bg-white border border-[#DEDEDE] rounded-[8px]"></div>
        </div>
        {/* <div className=" bg-[#FFFFFF] relative rounded-[14px] w-full scr800:p-6 p-3 h-[calc(100vh-220px)] flex flex-col items-center">
          {!jdResult && (
            ...
            >
              ...
              <div className="text-[18px] font-[400] text-center">
                Let our Gen AI craft the perfect <br /> Job Description for you.
              </div>
            </div>
          )}
          {jdResult ? (
