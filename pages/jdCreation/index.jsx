    ...
    <>
      ...
      <div className="flex flex-col gap-[14px]">
        <div className="flex  w-full justify-between items-center">
          ...
          <button
            onClick={() => router.push("/jdCreation/list")}
            className="  bg_Button h-[40px] px-[16px] py-[12px] rounded-[30px]"
          >
...
const LoadingComponet = () => {
  return (
    <div className="backdrop-blur-[3px] bg-white absolute bottom-0 w-full  z-10 h-[100%] flex  justify-center items-center">
