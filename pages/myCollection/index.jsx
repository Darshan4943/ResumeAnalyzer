        ...
        <div className="  flex ml:flex-row flex-col ml:justify-between  gap-4   relative  ">
          <div className="flex flex-col gap-5  justify-between ml:w-[25%] w-[100%]   ">
            <div className="flex flex-col gap-4 min-h-[calc(95vh-104px)]">
              ...
              <div className="flex ml:flex-col flex-row  sm:gap-2 w-full  h-full bg-white rounded-[16px] scr420:px-4 scr420:py-4  ml:justify-start justify-between py-2  px-2  overflow-x-auto ">
                <button
                  onClick={() => {
                    // setTab(1);
                    // setTabIndex(0);
