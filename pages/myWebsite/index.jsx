...
const PdfViewer = ({ pdfUrl,loadingg,setLoadingg }) => {
  ...
  return (
    <div style={{ boxShadow: "0px 2px 10px 1px #00000040" }} className={`w-[192px] h-[272px] rounded-lg overflow-hidden `}>
      {loadingg && (
    ...
    if (selectedIndexes) {
      try {
        const response = await axios.put(
          ...
          { selectedIndexes, selectedResumeUrl, _id: userDataGlobal._id, resumeName: selectedResumeName }
        );
        ...
        if (response.status === 200) {
          ...
          setSelectedLink(`https://www.skilotech.com/${userDataGlobal.id}/${userDataGlobal.firstName}`)
        ...
        <div className="customMargins py-6 min-h-[80vh]">
          {resumeList.length > 0 ?
            ...
            <div className="flex flex-col items-center justify-center text-[24px] font-medium ">
              <img className='w-[400px] h-[340px] ' src="/images/noFile.png" alt="" />
