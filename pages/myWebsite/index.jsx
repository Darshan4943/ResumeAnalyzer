    ...
    <div className="customMargins py-6 min-h-[80vh]">
      <div className="flex flex-col gap-4">
        <div className="flex justify-between">
          ...
          <div className="flex gap-4 text-[16px] font-medium items-center">
            {selectedLink &&
              <svg    onClick={() => copyToClipboard(selectedLink)} className=" cursor-pointer" width="24" height="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className=" cursor-pointer" onClick={() => openInNewTab(`${selectedLink}`)} >
