    ...
    <div className="w-full flex flex-col gap-[16px] border border-[#06A9EF] rounded-[16px] scr390:px-4 scr390:py-4 px-2 py-4 bg-white ">
      ...
      {resumeList &&
        resumeList?.map((user, index) => (
          <div
            key={index}
            className="  justify-between scr390:p-4  p-3 rounded-[16px] gap-4 bg-white flex  flex-col items-start relative "
            style={{ boxShadow: "0px 1px 2px 0px #00000040" }}
          >
            <div className="flex scr1024:flex-row flex-col gap-4 items-start justify-between w-full">
              ...
              <div className="flex flex-col gap-[20px] scr1300:min-w-[386px] scr390:min-w-[300px] min-w-full ">
                {fromSkilotechCollection &&
                  <>
