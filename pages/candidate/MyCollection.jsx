...
const MyCollection = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      // .get("https://api.skilotech.com/api/cover/get/" + userDataGlobal?._id)
      .get("https://api.skilotech.com/api/cover/get/" + userDataGlobal?._id)
  ...
  const deleteResume = () => {
    ...
    axios
      .delete("https://api.skilotech.com/api/resume/deleteResume", {
        data: { ids },
      })
      .then((response) => {
  ...
  const deleteCoverLetter = () => {
    ...
    axios
      .delete(`https://api.skilotech.com/api/cover/delete/${ids}`)
      .then((response) => {
