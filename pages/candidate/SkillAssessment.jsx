...
function SkillAssessment() {
  ...
  useEffect(() => {
    axios
      .get("https://api.skilotech.com/api/allSkills")
      .then((res) => {
  ...
  const handleInputChange = async (selectedOption) => {
    ...
    if (!found) {
      try {
        const response = await fetch("https://api.skilotech.com/api/skills", {
          method: "POST",
          headers: {
  ...
  useEffect(() => {
    setMainLoading(true);
    axios
      .get("https://api.skilotech.com/api/resume/skills/" + userDataGlobal?._id)
      .then((res) => {
  ...
  const toggleContent = () => {
    if (assesmentType !== "Normal" && !userDataGlobal?.firstName) {
      ...
      if (
        ...
        axios
          .post("https://api.skilotech.com/api/qnaSkill", {
            skill: selectedSkill,
            level: level,
  ...
  const sumbit = () => {
    ...
    if (assesmentType === "Normal" ? questionIndex == 9 : questionIndex == 59) {
      axios
        .post("https://api.skilotech.com/api/assessment/add", {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.skilotech.com/api/assessment/getByUser/${userDataGlobal?._id}`
      )
      .then((res) => {
