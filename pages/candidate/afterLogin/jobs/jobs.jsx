      ...
      <div className={` ${isViewportBelow850 ? " sticky top-[3.5rem]" : " sticky top-[5.6rem]"} z-50`}>
        <div style={{ backgroundColor: "#BCECFF", overflowX: "auto" }}>
          <div className=" customMargins overflow-x-auto  ">
            <div className={`flex items-start lg:gap-4 gap-3 py-3 overflow-x-auto `}>
              {headings.map((item, index) => (
                <div
                  key={index}
                  className={`flex gap-2 py-2 lg:px-4 px-2 items-center min-w-[165px]  ${toggleHeadings === index &&
                    "bg-[#06A9EF] rounded-[6px]"
                    }`}
                >
                  {item.img}
                  <p
                    className={`text-[16px] text-black font-semibold cursor-pointer  ${toggleHeadings === index &&
                      " text-white"
                      }`}
                    onClick={() => {
                      forceUpdate();
        ...
        {toggleHeadings <= 2 &&
          <div style={{ backgroundColor: "#E0F6FF" }} className="">
            ...
            <div onClick={() => setMobileFilter(!mobileFilter)} className="p-2 mobile ">
              <button
      ...
      <div className="bg-[#F9F9F9]  ">
        <div className=" customMargins   ">
          ...
          <div className="grid grid-cols-12 py-[16px] gap-[24px]  ">
              ...
              {mobileFilter && (
                <>
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                    ref={taskRef}
                    className="fixed z-[2000]  rounded-[8px]" style={{ background: 'rgba(255, 255, 255, 0.50)', backdropFilter: 'blur(10px)' }}
                  >
              ...
              toggleHeadings === 2) && (
                <  >
                  ...
                  {!isDescription &&
                    ...
                    <div onClick={() => setIsDescription(true)} className={`mobile1024 ml:mt-4  ${isViewportBelow600 ? "col-span-12" : "col-span-8"}`}>
                  ...
                  <div className={`web1024  ${filter ? "col-span-4" : "col-span-4"} ml:mt-4`}>
                    <AllJobs selectedJob={selectedJob} setIsDescription={setIsDescription} setSelectedJob={setSelectedJob} savedJobList={savedJobList} setSavedJobList={setSavedJobList} />
                  </div>


                  <div className={`web1024   ${filter ? "col-span-5" : "col-span-5"} ml:mt-4`}>
                  ...
                  {isDescription &&
                    ...
                    <div className={`mobile1024 ${isViewportBelow600 ? "col-span-12" : "col-span-8"} flex flex-col gap-3 ml:mt-4 `}>
                      <div onClick={() => setIsDescription(false)} className="flex gap-3">
            ...
            {toggleHeadings === 3 && (
              <div className={` ${isViewportBelow1024 ? (isViewportBelow600 ? "col-span-12" : "col-span-8") : "col-span-9"}`}>
                <AppliedJobs />
              </div>
            )}
