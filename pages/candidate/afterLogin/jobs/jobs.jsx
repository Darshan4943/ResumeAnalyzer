          ...
          <div className=" customMargins  ">
            <div className={`flex items-start gap-4 py-3  `}>
              {headings.map((item, index) => (
                <div
                  key={index}
                  className={`flex gap-2 py-2 px-4 items-center ${toggleHeadings === (item.title == "Saved Jobs" ? 4 : 0) &&
                    "bg-[#06A9EF] rounded-[6px]"
                    }`}
                >
                  {item.img}
                  <p
                    className={`text-[16px] text-black font-semibold cursor-pointer  ${toggleHeadings === (item.title == "Saved Jobs" ? 4 : 0) &&
                      " text-white"
                      }`}
                    onClick={() => {
                      forceUpdate();
      ...
      <div className="bg-[#F9F9F9]  ">
        <div className=" customMargins  ">
          <div className="grid grid-cols-12 py-[16px] gap-[24px]  ">
                ...
                <  >
                 ...
                 {Application_status.map((item, index) => (
                  ...
                  {!isDescription &&
                    ...
                    <div onClick={() => setIsDescription(true)} className=" mobile col-span-12 mt-6">
                  ...
                  {isDescription &&
                    ...
                    <div className={`mobile col-span-12  flex flex-col gap-3`}>
            ...
            {toggleHeadings === 3 && (
              <div className={` ${filter ? "col-span-10" : "col-span-12"}`}>
                <AppliedJobs />
              </div>
            )}
