...
function Jobs() {
  ...
  const Application_status = [
    {
      ...
      img: <img className="p-[6px] rounded-[32px] h-[32px] w-[32px] bg-[#06A9EF]" src="./images/jobs/work_white.png" alt="" />,
      num: '60'
    },
    {
      tittle: "New Updates",
      img: <img className="p-[6px] rounded-[32px] h-[32px] w-[32px] bg-[#FF9B52]" src="./images/jobs/work_history.png" alt="" />,
      num: '09'
    },
    {
      tittle: "Search appearances",
      img: <img className="p-[6px] rounded-[32px] h-[32px] w-[32px] bg-[#D197FF]" src="./images/jobs/Icon.png" alt="" />,
      num: '60'
    },
    {
      tittle: "Shortlisted",
      img: <img className="p-[6px] rounded-[32px] h-[32px] w-[32px] bg-[#47C945]" src="./images/jobs/check.png" alt="" />,
      num: '04'
    },
  ...
  const headings = [
    ...
    {
      img: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="22" viewBox="0 0 16 22" fill="none">
        <path d="M13.9322 0.714355H2.70242C1.60925 0.714355 0.714844 1.60877 0.714844 2.70193V20.0435C0.714844 20.5156 0.988136 20.9628 1.4105 21.1616C1.8577 21.3603 2.3546 21.3106 2.72727 21.0125L2.75211 20.9876L8.31733 16.292L13.8825 20.9876L13.9074 21.0125C14.131 21.1864 14.4043 21.2858 14.6776 21.2858C14.8515 21.2858 15.0502 21.2361 15.2242 21.1367C15.6465 20.938 15.9198 20.4908 15.9198 20.0187V2.70193C15.9198 1.60877 15.0254 0.714355 13.9322 0.714355Z" fill={toggleHeadings === 4 ? "#FFF" : " #333"} />
      </svg>,
      title: "Saved Jobs"
    },
  ]
              ...
              {headings.map((item, index) => (
                <div key={index} className={`flex gap-2 py-2 px-4 items-center ${toggleHeadings === index && 'bg-[#06A9EF] rounded-[6px]'}`}>
                  ...
                  <p
                    ...
                    onClick={() => setToggleHeadings(index)}
                  >
                    {item.title}
                  </p>
                </div>
      ...
      <div className="bg-[#F9F9F9]">
        <div className=" customMargins ">
          ...
          <div className="grid grid-cols-12 py-[12px] gap-[24px] ">
              ...
              <div className="flex flex-col col-span-2 rounded-md bg-white shadow-md py-6 px-4 mt-6 items-start gap-4 h-fit ">
                <div className="flex flex-col items-center gap-[8px]">
                  ...
                  <p className="text-[12px] leading-[18px] text-[#333]">
                    Track your job applications, get updates on views and profile activity.
                  </p>
                </div>
...

                {
                  Application_status.map((item, index) => (
                    <>
                      ...
                      <div
                        className={`w-[100%] h-[1px] ${index === Application_status.length - 1 ? '' : 'bg-[#06A9EF] '
                          }`}
                      ></div>
                    </>
                  ))
            ...
            {(toggleHeadings === 0 || toggleHeadings === 1 || toggleHeadings === 2) &&
              <>
