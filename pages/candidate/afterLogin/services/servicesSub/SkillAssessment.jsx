        ...
        {toggle === 0 && (
          <div className="flex flex-col gap-[35px] pt-[24px] pb-[95px] items-center justify-center customMargins">
            ...
            <div className="flex justify-start w-full gap-6">
              {showSecondDiv && (
                <div className="flex flex-col justify-start rounded-lg shadow-md w-[50%]">
                  <div className="flex h-16 px-4 py-3  items-center self-stretch border-b border-solid border-[#DEDEDE] bg-[#E0F6FF] rounded-lg">
                  ...
                  <div className="h-[388px] overflow-auto ">
                    {assessmentList?.map((item) => (
                      <div class="flex py-2 px-4 w-full items-center self-stretch border-b border-solid border-[#DEDEDE]">
                        <div className="flex w-[35.18%] gap-3 items-center self-stretch  ">
                          <div className="w-[40px] h-[40px]">
                            <img src="./images/profile/qu.png" alt="" />
                          </div>
                        ...
                        <div className="flex w-[19.95%] justify-center  items-center self-stretch  ">
                          <p
                            className={`${
                              item.score > 60 ? "text-[#0C8A0A]" : "text-[red]"
              ...
              <div
                className={`py-[24px] customMargins ${
                  showSecondDiv ? "w-[50%]" : "w-[65.95%]"
                }  px-[60px] rounded-[12px] bg-[#005A81] flex flex-col  items-center gap-[16px]`}
              >
          ...
          <>
            <div className="flex flex-col gap-[35px] pt-[24px] pb-[95px] items-center justify-center customMargins">
              <div className="py-[24px] customMargins w-[65.95%] px-[60px] rounded-[12px] bg-[#005A81] flex flex-col  items-center gap-[16px]">
                ...
                <div className="flex justify-center w-[78%] mt-3">
                  {/* <button
                    className=" h-[42px] w-[108px] flex items-center justify-center  rounded-[8px] border-[1px] border-solid border-[#06A9EF] bg-[#fff] text-[#333] text-[14px] font-[500] transition-all transition-[0.2s]"
                    disabled={loading}
                    onClick={() => {
...
//       setShowSecondDiv((prevShowSecondDiv) => !prevShowSecondDiv);
//     };
...
//                 <button className="px-4 py-2 border-[1px] border-solid border-[#06A9EF] rounded-[25px] text-[14px]  font-medium text-[#333] ">
//                   User Interface Designing
//                 </button>
//                 <button className="px-4 py-2 border-[1px] border-solid border-[#06A9EF] rounded-[25px] text-[14px] font-[500] text-[#333] ">
//                   User Research
//                 </button>
//                 <button className="px-4 py-2 border-[1px] border-solid border-[#06A9EF] rounded-[25px] text-[14px] font-[500] text-[#333] ">
//                   Figma
...
//             </div>
//             <div className="flex justify-start w-full ">
//               <button className="text-[#C00000] " onClick={handleButtonClick}>{showSecondDiv ? <span className="text-[#0C8A0A] font-montserrat text-lg font-medium leading-normal">Results</span> :'X Close'}</button>
//             </div>
//             <div className="flex justify-start w-full gap-6">
//                 {
//                     showSecondDiv && (

//               <div className="flex flex-col justify-start rounded-lg shadow-md w-[57.44%]">
//                 <div className="flex h-16 px-4 py-3  items-center self-stretch border-b border-solid border-[#DEDEDE] bg-[#E0F6FF] rounded-lg">
//                   <div className="flex w-[35.18%] justify-between items-center self-stretch border-r border-solid border-[#DEDEDE] ">
//                     <p className="text-text-primary font-montserrat text-base font-medium leading-6">
//                       Assessment Name
...
//                 </div>
//                 <div className="h-[388px] overflow-auto ">
//                 <div className="flex justify-start p-2 gap-[10px] self-stretch items-start">
//                     <p className="text-[#333] text-[16px]  leading-normal font-montserrat font-semibold">Today</p>
//                 </div>
//                 <div class="flex py-2 px-4 w-full items-center self-stretch border-b border-solid border-[#DEDEDE]">
//                 <div className="flex w-[35.18%] gap-3 items-center self-stretch  ">
//                     <div className="w-[40px] h-[40px]">
...
//                   </div>
//                   <div className="flex w-[19.95%] justify-center  items-center self-stretch  ">
//                     <p className="text-[#C00000] items-center  font-montserrat text-sm font-semibold leading-7">
//                     Retry
//                     </p>
//                   </div>
//                   <div className="flex w-[19.95%] justify-center items-center self-stretch ">
...
//                 </div>
//                 <div className="flex justify-start p-2 gap-[10px] self-stretch items-start">
//                     <p className="text-[#333] text-[16px]  leading-normal font-montserrat font-semibold">Last Week</p>
//                 </div>
//                 <div class="flex py-2 px-4 w-full items-center self-stretch border-b border-solid border-[#DEDEDE]">
//                 <div className="flex w-[35.18%] gap-3 items-center self-stretch  ">
//                     <div className="w-[40px] h-[40px]">
...
//               </div>
//               )}
//               <div className={`py-[24px] customMargins ${ showSecondDiv? "w-[40.42%]": 'w-[65.95%]' }  px-[60px] rounded-[12px] bg-[#005A81] flex flex-col  items-center gap-[16px]`}>
//                 <div className="text-[20px] font-[600] text-[#fff] flex flex-row gap-[12px]">
//                   <svg
//                     xmlns="http://www.w3.org/2000/svg"
//                     width="30"
...
//                 </div>
//                 <div className={`flex  ${showSecondDiv ? "gap-[8px]": "gap-[40px]" } justify-between text-center `}>
//                   <div
//                     className="w-[136px] p-[8px] flex flex-col rounded-[12px] justify-center items-center gap-[8px]"
//                     style={{
//                       backgroundColor: "rgba(6, 169, 239, 0.50)",
