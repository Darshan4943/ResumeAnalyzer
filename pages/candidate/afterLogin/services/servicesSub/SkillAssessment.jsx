        ...
        {toggle === 0 && (
          <div className="flex flex-col gap-[35px] pt-[24px] pb-[95px] items-center justify-center customMargins">
            ...
            >
              ...
              <div className="w-full flex flex-row gap-[16px] overflow-x-auto  ">
            ...
            <div className="flex flex-col ml:flex-row justify-center items-center w-full gap-6">
              ...
              <div
                className={`p-[12px] ms:px-[60px] ms:customMargins ${
                  showSecondDiv ? "ml:w-[50%]" : "w-[100.95%] sm:w-[60.95%]"
          ...
          <>
            ...
            <div className="fixed z-[2000] top-0 left-0 right-0 bottom-0 flex items-center justify-center customMargins   ">
              <div className="absolute ms:w-[75.08%] w-[90%]  flex items-center justify-center ">
                <div
                  className="rounded-[12px] bg-[#fff] w-[330px]  flex flex-col gap-[8px] items-center"
                  style={{
                ...
                >
                  ...
                  <div className="flex justify-center items-center pb-[12px]">
                    <button onClick={()=>router.push("/profile")} className="border-[1px] border-solid border-[#06A9EF] rounded-[12px] px-[36px] py-[12px] text-[16px] text-[#333] font-[500]">
                      Go To Profile
                    </button>
                  </div>
                </div>
