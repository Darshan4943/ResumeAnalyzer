          ...
          <div className="w-full flex justify-center items-center flex-row py-[36px] customMargins ">
            <div className="w-[82.97%] flex flex-col gap-[24px]">
                ...
                <div className="flex flex-col gap-[24px]">
                  ...
                  >
                    ...
                    <div className="text-[16px] text-[#333] font-[600]">
                      Which programming language is known for its use in
                      developing web-based applications and is often associated
              ...
              <div className="flex w-full justify-between">
                ...
                <button
                  className="px-9 py-3 items-center border border-[#06A9EF] rounded-[12px] text-[16px] font-[500]"
