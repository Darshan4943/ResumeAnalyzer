...
function AiResumePage() {
    ...
    const [ratingsLanguages, setRatingsLanguages] = useState(initialRatingsLanguages);
    ...
    const addLanguages = () => {
        if (currentLanguages.trim() !== '') {
            setLanguages([...languages, { languages: currentLanguages, rating: [...ratingsLanguages] }]);
            setCurrentLanguages('');
                ...
                <div className='flex flex-col gap-4 py-6 customMargins'>
                    <div className='flex gap-6 bg-white p-4 rounded-lg items-center' style={{
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                            <g clip-path="url(#clip0_5716_136244)">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M6.66797 20.0002C6.66797 19.0797 7.41416 18.3335 8.33464 18.3335H31.668C32.5884 18.3335 33.3346 19.0797 33.3346 20.0002C33.3346 20.9206 32.5884 21.6668 31.668 21.6668H8.33464C7.41416 21.6668 6.66797 20.9206 6.66797 20.0002Z" fill="#333333" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.15612 18.8217C7.807 18.1708 8.86227 18.1708 9.51315 18.8217L19.5131 28.8217C20.164 29.4725 20.164 30.5278 19.5131 31.1787C18.8623 31.8295 17.807 31.8295 17.1561 31.1787L7.15612 21.1787C6.50525 20.5278 6.50525 19.4725 7.15612 18.8217Z" fill="#333333" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M19.5131 8.82165C20.164 9.47253 20.164 10.5278 19.5131 11.1787L9.51315 21.1787C8.86227 21.8295 7.807 21.8295 7.15612 21.1787C6.50525 20.5278 6.50525 19.4725 7.15612 18.8217L17.1561 8.82165C17.807 8.17078 18.8623 8.17078 19.5131 8.82165Z" fill="#333333" />
                            </g>
                            <defs>
                        ...
                        <div className='flex flex-col gap-1'>
                            ...
                            <p className='text-[14px] font-normal'>Quickly create your own resume. Creating resume here won’t change your Skilotech profile.</p>
                    ...
                    <div className=" h-fit flex gap-6">
                        <div className="flex flex-col w-[49%] px-2 pb-4 gap-4 rounded-lg overflow-y-auto ">
                            ...
                            <div className='flex flex-col gap-4 p-4 bg-white rounded-lg' style={{ boxShadow: "0px 0.5px 3px 0px rgba(0, 0, 0, 0.25)" }}>
                            ...
                            <div
                                ...
                                style={{ boxShadow: "0px 0.5px 3px 0px rgba(0, 0, 0, 0.25)", opacity: isChecked ? 1 : 0.5 }} >
                                ...
                                <div className="flex flex-col gap-4"  >
                                    ...
                                    <div className="flex justify-end ">
                                        <div className='flex justify-between  py-2 gap-2'>
                                            <button className=" font-montserrat text-xs font-semibold px-[12px] rounded-[8px] border border-[#06A9EF] w-[137px] h-[32px]" disabled={!isChecked} >
                                                Update to Profile
                                            </button>
                                            <button className=" font-montserrat text-white font-medium text-[12px] px-[12px] rounded-[8px]  bg-[#06A9EF] w-[60px] h-[32px]" style={{ opacity: isModified ? 1 : 0.3 }} onClick={handleSave} disabled={!isModified || !isChecked}>
                                                Save
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div
                                className="flex flex-col p-4 gap-2 rounded-lg bg-white"
                                style={{ boxShadow: "0px 0.5px 3px 0px rgba(0, 0, 0, 0.25) ", opacity: isCheckedEducation ? 1 : 0.5 }}
                            >
                                <div className="w-full flex justify-between text-[20px] font-montserrat font-medium">
                                    <p> Education</p>

                                    <label className="switch">
                                        <input type="checkbox" checked={isCheckedEducation} onChange={handleSwitchChangeEducation} />
                                        <span className="slider round"></span>
                                    </label>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex justify-end ">
                                            <div className='flex justify-between  py-2 gap-2'>
                                                ...
                                                <button style={{ opacity: isModifiedEducation ? 1 : 0.3 }} onClick={handleSaveEducation} disabled={!isModifiedEducation || !isCheckedEducation} className=" font-montserrat text-white font-medium text-[12px] px-[12px] rounded-[8px]  bg-[#06A9EF] w-[60px] h-[32px]">
                                                    Save
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div className="flex flex-col gap-2 w-full">
                                        ...
                                        {skills.map((skill, index) => (
                                            <div key={index} className='flex gap-4 justify-between'>
                                                <div className='flex gap-1 px-3 py-2 border border-[#06A9EF] rounded-[24px] justify-between items-center'>
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" onClick={() => deleteSkill(index)}>
                                    ...
                                    <div className="flex justify-end ">
                                        <div className='flex justify-between  py-2 gap-2'>
                                            ...
                                            <button onClick={addSkill} className=" font-montserrat text-white font-medium text-[12px] px-[12px] rounded-[8px]  bg-[#06A9EF] w-[60px] h-[32px] ">
                                                Save
                                            </button>
                                        </div>
                                    </div>
