...
function JobPostingUi() {
  ...
  return (
    <div className="flex ml:flex-row flex-col-reverse scr1024:gap-[100px] ml:gap-[60px] w-[100%] justify-center items-center customMargins ">
   
       

      <div className="flex flex-col ml:gap-6 gap-4 ml:w-[55%] w-[100%] ml:items-start items-center">
        <div className="flex flex-col gap-2 ml:text-start text-center">
        <p className="font-semibold ml:text-[3.2vw] text-[28px] leading-tight xl:text-[42px]">
          Reach Top Talent with Skilotech&apos;s <span className="text-[#06A9EF]">Job Posting</span>  Platform
          
          </p>
        </div>
        <div className="ml:text-[1.2vw] text-[14px] font-medium ml:text-start text-center xl:text-[16px] ">
      ...
      <img
          className=" ml:h-[45vw] ml:w-[45vw] h-[75vw] w-[75vw] xl:w-[648px] xl:h-[648px]  object-contain  "
