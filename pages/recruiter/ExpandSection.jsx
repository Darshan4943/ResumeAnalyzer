        ...
        <div class="flex_class w-full flex flex-col ml:flex ml:flex-row mt-[49px] mb-[26px] gap-[16px] ml:gap-[43px]">
          ...
          <div class="ml:h-[580px] bg-[#fff] z-10 ml:flex flex justify-center flex-col w-[100%] ml:w-[50%]">
            ...
            <div className="expand_button">
              <button class="border-none rounded-[8px] border border-shadow-color bg-yellow shadow-ml flex items-center justify-center px-[16px] py-[8px] ml:px-[48px] ml:py-[18px] font-[600] ml:font-bold mt-[8px] ml:mt-[24px] text-[14px] ml:text-[18px]">
                Register Now
              </button>
            </div>
          </div>
