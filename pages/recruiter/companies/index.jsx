  ...
  const fetchCompanyData = async () => {
    try {
      const response = await axios.get(
        `https://api.skilotech.com/api/company/getCompaniesById/${id}`,
        {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://api.skilotech.com/api/company/deleteCompany/${selectedJobId}`
      );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 w-full">
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          <button
            ...
            className="h-[40px] bg_Button rounded-[30px] px-6 py-2 flex items-center justify-center gap-2 text-white w-full sm:w-auto"
          >
          ...
          >
            ...
            <span className="whitespace-nowrap">Bulk Company Upload</span>
          </button>
        </div>
        ...
        <div className="w-full sm:w-auto">
          <input
            type="text"
            className="rounded-[30px] text-[13px] border border-[#DEDEDE] w-full sm:w-[220px] px-4 py-2"
