  ...
  return (
    <div className="customMargins ">
      <div className="flex flex-col">
        <div className="recruiter_animation heroBlock">
          {showAnimationn ? (
            <>
              <motion.p
              ...
              >
                <div className="collaborate_left">
                  ...
                  <p3>
                    Connect your consulting firm with a diverse range of
                    employers through our platform. We offer a wide-reaching
                    network to help you expand your reach and grow your
                    business. Partner with us to access a broad spectrum of
                    employment.
                  </p3>
                </div>
                <motion.div
        ...
        <div className="collaborate_section flex flex-col-reverse gap-[20px] flex_class unblockRecruiter">
          <div className="collaborate_left flex flex-col gap-2 w-[100%] ml:w-[60%] unblockRecruiter">
            <p1
            className="text-[30px] unblockRecruiter font-[700] leading-normal text-[#333]"
            >Collaborate with employers easily</p1>
            <p2
            className="text-[18px] font-[500] unblockRecruiter leading-normal text-[#333]"
            >Increase the opportunities for your references</p2>
            <p3
             className="text-[14px] font-[500] unblockRecruiter leading-[20px] text-[#646464]"
            >
              Connect your consulting firm with a diverse range of employers
              through our platform. We offer a wide-reaching network to help you
              expand your reach and grow your business. Partner with us to
              access a broad spectrum of employment.
            </p3>
          </div>
          <div className="collaborate_img flex w-[100%] ml:w-[40%]  unblockRecruiter justify-center items-center">
            <img
            className="w-[30vw] unblockRecruiter"
             src="/images/recruiter/collaborate_handshake.png" alt="kk" />
          </div>
        </div>
      </div>
    </div>
