...
function ClientSection() {
  ...
  return (
    <div className="flex ml:flex-row flex-col ml:gap-[80px] gap-4 w-[100%] items-center justify-between  ml:pb-12 pb-6 customMargins">
      
        <img
          className="ml:h-[45vw] ml:w-[45vw] h-[75vw] w-[75vw] xl:h-[489px] xl:w-[554px]  object-contain "
      ...
      <div className="flex flex-col ml:gap-6 gap-4 ml:w-[40%] w-[95%] ml:items-start items-center">
        <div className="flex flex-col gap-2 ml:text-start text-center">
          <p className="ml:text-[3vw] text-[28px] font-semibold leading-tight xl:text-[42px]">
