...
function UploadDocuments() {
  ...
  const [previousStatus, setPreviousStatus] = useState("");
    ...
    const getDocumentsUploadStatus = async () => {
        try {
            const response = await axios.get(`http://192.168.1.208:2000/api/preboarding/documentsUploadStatus/${applicantId}/${jobId}`);
    ...
    const uploadDocuments = async () => {
        ...
        try {
            const response = await axios.post(
                `http://192.168.1.208:2000/api/preboarding/uploadDocuments/${applicantId}/${jobId}`,
                uploadedFiles, 
