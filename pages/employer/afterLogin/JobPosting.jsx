      ...
      {toggle === 0 && (
        <div className="pb-4">
              ...
              <div className=" ">
                <div className="h-[84px] bg-[#06A9EF]  flex flex-row p-[16px] justify-between  text-[#333] sticky top-[72px] ">
                  ...
                  <div className=" w-[19.87%] bg-white p-4 flex gap-[10px]">
                    ...
                    <input
                      className="w-[100%] text-[14px] font-normal "
                      type="text"
                      placeholder="search"
                    />
                  </div>
                ...
                <div className=" ">
                  {requisition
                    ...
                    .map((req, index) => (
                      <div
                        key={index}
                        className={`items-center flex flex-row py-[12px] px-[16px] gap-4 border-b border-solid  border-[rgba(100, 100, 100, 0.60)] ${index % 2 === 0 ? "bg-[#FFF]" : "bg-[#E0F6FF]"}  `}
                      >
                        <div className=" w-[14%]">
          ...
          <TablePagination
            ...
            component="div"
            className="h-[64px] rounded-b-[12px] py-[12px] px-[16px] border-t bg-white sticky bottom-0 w-[100%]"
