  ...
  return (
    <div className="grid items-start gap-4">
      <div className="flex gap-2">
        <p className="text-[10px] sm:text-[14px] text-[#333] font-[500] leading-normal">
          Skilotech
        </p>
        <svg
          ...
          fill="none"
        >
          <g mask="url(#mask0_7804_70246)">
            <path
              d="M10.4665 8.2832L6.46654 12.2832L5.5332 11.3499L8.59987 8.2832L5.5332 5.21654L6.46654 4.2832L10.4665 8.2832Z"
              fill="#333333"
            />
          </g>
        </svg>
        <p className="text-[10px] sm:text-[14px] text-[#333] font-[600] leading-normal">
          Bulk Upload
        </p>
      </div>
      <div
            ...
            </p>
{
    contact_info.map((e) =>(        <div className="flex gap-[8px]">
      ...
      <p className="text-[12px] text-[#646464] font-[400]">190 Kb</p>
           ...
           <button className="flex py-[12px] w-[50%] scr1200:px-[9px] scr1350:px-[22px] justify-center items-center gap-[10px] rounded-[12px] bg-[#06A9EF] text-[12px] sm:text-[16px] text-[#fff] font-[600] leading-[160%]">Move to Hiring</button>
           <button className="flex py-[12px] w-[50%] scr1200:px-[9px] scr1350:px-[22px] justify-center items-center gap-[10px] rounded-[12px] text-[12px] sm:text-[15px] text-[#333] font-[500] border-[1px] border-[#06A9EF] leading-[160%]">See Application</button>
