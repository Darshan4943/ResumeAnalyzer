...
function EmployerHome({ toggleContentt }) {
  ...
  return (
    <div className=" ml:h-[80vh] w-[100%]  overflow-y-auto">
      ...
      <div className="pt-5 lg:flex flex lg:flex-row flex-col flex-wrap items-start lg:justify-between gap-3">
        <div
                ...
                <div className="flex flex-col px-2 ml:p-0 items-start gap-[2px]">
                  ...
                  <div className="flex gap-2 items-start">
                    ...
                    <div className="flex text-center">
                      <p className="text-[#06A9EF] items-center text-[18px] font-medium">
                        6.4%
                      </p>
                      <svg
                        xlgns="http://www.w3.org/2000/svg"
  ...
  <g mask="url(#mask0_7540_117295)">
    <path d="M2.15385 10.2499C1.90128 10.2499 1.6875 10.1624 1.5125 9.98745C1.3375 9.81245 1.25 9.59867 1.25 9.3461V4.15383C1.25 3.90126 1.3375 3.68747 1.5125 3.51247C1.6875 3.33747 1.90128 3.24997 2.15385 3.24997H4.25V2.40384C4.25 2.15128 4.3375 1.9375 4.5125 1.7625C4.6875 1.5875 4.90128 1.5 5.15385 1.5H6.84613C7.09869 1.5 7.31248 1.5875 7.48748 1.7625C7.66248 1.9375 7.74998 2.15128 7.74998 2.40384V3.24997H9.84613C10.0987 3.24997 10.3125 3.33747 10.4875 3.51247C10.6625 3.68747 10.75 3.90126 10.75 4.15383V9.3461C10.75 9.59867 10.6625 9.81245 10.4875 9.98745C10.3125 10.1624 10.0987 10.2499 9.84613 10.2499H2.15385ZM2.15385 9.49996H9.84613C9.88459 9.49996 9.91986 9.48394 9.95191 9.45189C9.98396 9.41983 9.99999 9.38457 9.99999 9.3461V4.15383C9.99999 4.11536 9.98396 4.0801 9.95191 4.04804C9.91986 4.01599 9.88459 3.99996 9.84613 3.99996H2.15385C2.11538 3.99996 2.08012 4.01599 2.04806 4.04804C2.01601 4.0801 1.99999 4.11536 1.99999 4.15383V9.3461C1.99999 9.38457 2.01601 9.41983 2.04806 9.45189C2.08012 9.48394 2.11538 9.49996 2.15385 9.49996ZM4.99999 3.24997H6.99999V2.40384C6.99999 2.36537 6.98396 2.33011 6.95191 2.29806C6.91985 2.266 6.88459 2.24997 6.84613 2.24997H5.15385C5.11538 2.24997 5.08012 2.266 5.04806 2.29806C5.01601 2.33011 4.99999 2.36537 4.99999 2.40384V3.24997Z" fill="white"/>
  </g>
</svg>
                  </div>
                </div>
                <div className="flex flex-col items-start gap-[2px]">
                  ...
                  <div className="flex gap-2 items-start">
                    ...
                    <div className="flex text-center">
                      <p className="text-[#C00000] items-center text-[18px] font-medium">
                        0.5%
                      </p>
                      <svg
                        xlgns="http://www.w3.org/2000/svg"
      ...
      <div className="pt-6">
        ...
        >
          <div className="flex lg:flex-row flex-col  w-[100%] py-[24px] px-[16px] gap-4 lg:justify-between items-start lg:items-center bg-[#fff]">
            <p className="font-[600] text-[16px]">Total Applicants : 19</p>
            <div className="flex items-start gap-[8px] lg:w-[33.59%] w-[100%]">
              <div className="w-full flex justify-between items-center">
                <div className="flex py-[12px] px-[16px] w-[68.02%]  rounded-[6px] border border-[#D6DDEB] bg-[#fff]">
                  <img
                    className="w-[24px]"
                ...
                <div className="w-[28.11%] items-center flex py-[12px] lg:px-[16px] justify-center gap-1 lg:gap-[8px] rounded-[6px] border border-[#D6DDEB] object-contain">
                  <div className="h-[22.22%] w-[22.22%]">
                    <svg
                      xlgns="http://www.w3.org/2000/svg"
                      width="18"
                      height="18  "
                  ...
                  <div className="w-[54.77%] object-contain">
                    <p className="font-[600] text-[14px] text-[#333]">Filter</p>
                  </div>
                </div>
              </div>
            </div>
