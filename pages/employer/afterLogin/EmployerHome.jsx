...
function EmployerHome({ toggleContentt }) {
  ...
  return (
    <div className=" h-[80vh] w-[100%] pr-2 ms:overflow-y-auto">
      ...
      >
        <div className="px-4 flex lg:flex-row flex-col justify-between w-[100%]">
          <div className="flex flex-col items-start gap-2 ">
            <p className="text-white font-montserrat text-6 font-semibold leading-[120%]">
              Good morning, Rajveer
            </p>

            <p className="text-white font-montserrat text-4 font-medium leading-[160%] ">
                ...
                <div className="flex justify-between items-center self-stretch">
                  ...
                  <div className="flex p-[6px] rounded-[32px] bg-[#06A9EF]">
                    <svg
                      ...
                      fill="none"
                    >
                      <g clip-path="url(#clip0_6622_117275)">
                        <path
                        ...
                        />
                        <path
                          d="M10.8324 2.5H9.16569C8.24522 2.5 7.49902 3.24619 7.49902 4.16667C7.49902 5.08714 8.24522 5.83333 9.16569 5.83333H10.8324C11.7528 5.83333 12.499 5.08714 12.499 4.16667C12.499 3.24619 11.7528 2.5 10.8324 2.5Z"
                          stroke="white"
                          stroke-width="2"
                          stroke-linecap="round"
                          stroke-linejoin="round"
