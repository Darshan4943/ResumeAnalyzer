  ...
  const job_card = [
    {
      ...
      time3: "",
      button: (
        <button className="py-[4px] px-[16px] text-[#0C8A0A] rounded-[6px] font-[500] border border-[#0C8A0A] bg-[#E2FFE1]">
          Live
        </button>
      ),
    ...
    },
    {
      ...
      time3: "",
      button: (
        <button className="py-[4px] px-[16px] text-[#C00000] rounded-[6px] font-[500] border border-[#C00000] bg-[#FFEBEB]">
          Closed
        </button>
      ),
      img: "",
      ...
      {toggle === 0 && (
        <div className="flex flex-col gap-3 w-[100%] ml:max-h-[80vh]  relative ">
          ...
          <div  className="w-[1024px]">
            ...
            <div className="h-[62px] mt-4 flex flex-row W-[1024px] justify-between  text-[#333] sticky top-[72px] ">
              ...
              <div className=" w-[19.87%] bg-white p-4 flex gap-[10px]">
               ...
               <button className="px-[36px] py-[12px] rounded-[30px]  flex items-center bg-[#06A9EF] text-[14px] font-[600] text-[#FFFFFF]">Search </button>
              </div>
            </div>

          </div>
         
          <div className="grid scr1300:grid-cols-2 scr1024:grid-cols-3 ml:grid-cols-2 ms:grid-cols-2  grid-cols-1 ms:gap-[20px] gap-2 pb-2 overflow-y-scroll">
            {job_card.map((job_card) => (
              <div
                onClick={toggleContent}
                className="flex py-[16px] px-[0px] flex-col items-start gap-[12px] flex-shrink-0 rounded-lg bg-[#fff] shadow-md"
              >
                <div className="flex w-[100%] py-0 px-[16px] justify-between items-start ">
                  <div className="flex w-[70%] flex-col items-start gap-[2px]">
                    ...
                    <p className="text-[#2706EF] font-[500] text-[10px]">
                      {job_card.time1}
                    </p>
                    <p className="text-[#DB0000] font-[500] text-[10px]">
                      {job_card.time2}
                    </p>
                    <p className="text-[#CE06EF] font-[500] text-[10px]">
                      {job_card.time3}
                    </p>
                  </div>
