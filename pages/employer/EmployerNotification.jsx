    ...
    },
    {
      img: (
        <img
          src="/images/icons/doc_icon.png"
          alt=""
          className="ms:w-[50px] ms:h-[50px] w-[35px] h-[35px] rounded-[8px] "
        />
      ),
      description: "HR xyz from XYZ COMPANY has viewed your profile.",
      profile: "",
          ...
          >
            <div className="flex gap-2 w-[85%]">
              ...
              <div className="flex flex-col">
                <p className="sm:text-[16px] text-[14px] text-[#333] leading-[160%] font-[500]">
                  {e.description}
                </p>
                <p className="sm:text-[16px] text-[14px] text-[#06A9EF] leading-[160%] font-[600]">
                  {e.profile}
                </p>
                <p className="text-[#646464] flex justify-end ms:text-[14px] text-[12px] font-[400] items-right leading-[160%]">
                  {e.time}
                </p>
              </div>
            </div>
