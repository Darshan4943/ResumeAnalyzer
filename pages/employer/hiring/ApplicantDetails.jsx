      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-6 relative ">
          <div className=" flex w-full gap-3 justify-between rounded-[16px] items-center">
            <img
              onClick={() => setTogglee(1)}
              className="w-[40px] cursor-pointer"
              src="/images/employer/Icon_left.png"
              alt=""
            />
            <p className="text-[24px]  w-[100%] text-start flex justify-start font font-medium  ">
              Applicant Details
            </p>
          </div>
                ...
                <div className="flex flex-col overflow-y-auto gap-6 px-6 py-4">
                  ...
                  <div className="flex flex-col gap-2 rounded-[12px] p-4 bg-[#EFFAFF]">
                    <div className="flex justify-between">
                      <p className="text-[16px] font-[600]">Applied Job</p>
                  ...
                  <div className="flex gap-2">
                    <div className="px-4 w-[84.65%] items-center flex justify-center py-3 border-solid border-[1px] border-[#06A9EF] text-[16px] font-medium text-[#FFFFFF] hover:text-[#06A9EF] rounded-[30px] bg-[#06A9EF] hover:bg-[#FFFFFF]">
                      Schedule Interview
                    </div>
                    <div className="p-3 items-center flex justify-center text-[16px] font-medium text-[#06A9EF] rounded-[30px] border border-[#06A9EF]">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  <div className="flex flex-col gap-4 text-[16px] font-normal">
                    <p className="font-[600] text-[16px] text-[#333333]">
                      Contact
                    </p>
                    <div className="flex gap-2">
                      <svg
