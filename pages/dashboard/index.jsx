    ...
    return (
        <div className='customMargins flex flex-col gap-12 py-6 min-h-[70vh]'>
            <div className='flex ml:flex-row flex-col gap-4'>
                <div className='flex flex-col gap-6 p-4 rounded-[16px] ml:min-w-[336px] ml:max-w-[336px] ml:h-[297px]' style={{
                    background: "linear-gradient(31.62deg, #06A9EF 14.94%, #A2E3FF 99.61%)"
                }}>
                    ...
                    <div className='flex gap-4 items-center'>
                        ...
                        <div className='flex flex-col gap-3'>
                            <div className='text-[18px] font-semibold p-2 rounded-l-[6px] leading-tight text-[#06A9EF] scr360:w-[186px] w-[156px] mr-[-16px]' style={{ background: "linear-gradient(89.03deg, #FFFFFF 0.83%, rgba(255, 254, 254, 0) 98.41%)", boxShadow: "0px 2px 2px 0px rgba(103, 100, 100, 0.25)" }}>
                                Hello,
                            </div>
                    ...
                    <div className='text-[14px] font-medium text-[#FFFFFF] flex flex-col gap-4'>
                        Unleash the power of AI to build a resume that speaks volumes and lands your dream job effortlessly.
                        <div onClick={() => toggle()} className='rounded-[8px] bg-[#FFFFFF] px-4 py-3 text-[16px] flex gap-1 text-[#06A9EF] justify-center items-center leading-tight ml:w-full w-[150px] cursor-pointer'>
                            Get Started
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">

                                <g mask="url(#mask0_1787_24766)">
                                    <path d="M13.124 10.7493H3.99902V9.24927H13.124L8.93652 5.06177L9.99902 3.99927L15.999 9.99927L9.99902 15.9993L8.93652 14.9368L13.124 10.7493Z" fill="#06A9EF" />
                                </g>
                            </svg>
            ...
            <div className='flex gap-12 flex-wrap justify-center'>
                {list().map((item, index) => (
                    <div
                        key={index}
                        className={"job-card scr420:w-[162.67px] w-[120px] scr420:h-[154px] h-[120px] scr420:p-4 p-3 cursor-pointer flex flex-col items-center scr420:gap-3 gap-2 justify-center text-center"}
                    ...
                    >
                        ...
                        <div className='scr420:text-[14px] text-[12px] font-medium'>{item.name}</div>
