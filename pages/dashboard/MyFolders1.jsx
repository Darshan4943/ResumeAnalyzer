  ...
  return (
    <div className="h-[calc(85vh-180px)] overflow-y-auto">
      <div className="flex justify-end mb-4 gap-4">
        ...
        {loading1 ? (
          <button className="text-[14px] w-[108.49px] font-[500] flex items-center justify-center  rounded-[30px] bg_Button px-4 h-[40px]">
            <MiniLoader />
          </button>
        ) : (
          <button
            ...
            <table className="w-[100%] flex flex-col">
              <thead className="flex w-full">
                <tr className="flex w-full ">
                  ...
                  <th className="py-3 px-2 w-[10%] scr390:px-4 bg-[#C2E7FF]  text-left text-[12px] scr390:text-[14px] border-r border-[#FFF]  rounded-r-[12px] font-medium">
                    Action
                  </th>
                </tr>
              </thead>
                ...
                {sortFoldersAndFiles(data).map((item, index) => (
                  ...
                  >
                    ...
                    <td className="w-[20%] scr460:px-4 justify-between flex  items-center  text-[12px] scr390:text-[14px]">
                      {item?.enhancedVersion?.firstName}{" "}
                      {item?.enhancedVersion?.lastName}
                    </td>
                      ...
                      {item.type === "file" && (
                        <p
                          className={`text-[14px] font-[600] ${
                            item?.paymentStatus ? "text-green" : "text-red"
                          }`}
                        >
                          ...
                          {loading === item._id ? (
                            ...
                            <button
                              ...
                              className={`text-[14px] font-[500] rounded-[30px] bg_Button px-4 h-[40px] ${
                                (!item.isEvaluate || item.paymentStatus) &&
                                "opacity-50"
                              }`}
