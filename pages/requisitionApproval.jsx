...
function RequisitionApproval() {
    ...
    const getRequisitionLevelStatus = async () => {
        try {
            const response = await axios.get(`http://192.168.1.208:2000/api/requisition/requisitionLevelStatus/${requisitionId}/${levelId}`);
    ...
    const requisitionUpdate = async () => {
        ...
        try {
            const response = await axios.put(`http://192.168.1.208:2000/api/requisition/requisitionUpdate/${requisitionId}/${levelId}`, { status })
