  ...
  return (
    <div className="w-full relative flex items-center flex-col gap-[18px] pb-[62px]">
          ...
          <div className="flex w-full px-[44px] justify-center items-center">
            ...
            >
              ...
              <circle
                ...
                cy="12"
                r="8"
                fill={role === "recruiter" ? "#06A9EF" : "#FFDA1D"}
              />
            </svg>
            <div className="relative h-[2px] w-full md:w-[312px]">
              ...
              <div
                ...
                className={`absolute top-0 h-full ${
                  role === "recruiter" ? "bg-blue" : "bg-[#FFDA1D]"
                } `}
              ></div>
            </div>
            <svg
      ...
      <div
        ...
        className={`p-6 flex flex-col gap-4 bg-white w-[95%] lg:w-[75%] scr1024:w-[65%] scr1400:w-[45%]  rounded-[8px] md:rounded-[16px] ${
          role === "recruiter" && recOptions === "individual" && "mt-6"
        }`}
      >
        {role === "recruiter" && tog !== 3 && (
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-4">
              <button
                onClick={selectRecruiterFirm}
                style={{
                  boxShadow: "0px 1px 3px 1px #00000026",
                  boxShadow: "0px 1px 2px 0px #0000004D",
                }}
                className={`rounded-[30px] px-4 h-[32px] w-[137px] ${
                  recOptions === "firm"
                    ? "bg-blue text-white font-[500] hover:bg-[#0275A7]"
                    : "bg-white text-[#333333] hover:bg-[#0275A7] hover:text-white text-[500]"
                } sm:text-[14px] text-[9px]  `}
              >
                Recruiter Firm
              </button>
              <button
                onClick={selectRecruiterIndividual}
                style={{
                  boxShadow: "0px 1px 3px 1px #00000026",
                  boxShadow: "0px 1px 2px 0px #0000004D",
                }}
                className={`rounded-[30px] px-4 h-[32px] w-[180px] ${
                  recOptions === "individual"
                    ? "bg-blue text-white font-[500] hover:bg-[#0275A7]"
                    : "bg-white text-[#333333] hover:bg-[#0275A7] hover:text-white text-[500]"
      ...
      <div className="text-[14px] font-[500] text-[#646464]">
        ...
        <span
          onClick={() =>
            router.push(
              role === "recruiter"
                ? "/auth/Sign_in?role=recruiter "
                : "/auth/Sign_in?role=employer"
            )
          }
