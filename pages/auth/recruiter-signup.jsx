...
function Recruiter_signup({ }) {
  ...
  const submitHandler = (e) => {
    ...
    if (hasErrors) {
      ...
      const url = isUpdate
        ? "http://locahost:2000/api/updateUser"
        : "http://locahost:2000/api/skiloteckuser/recruiter";
      // setLoading(true);
  ...
  const handleVerification = (e) => {
    ...
    setOtp(otp)
    axios.post('http://locahost:2000/api/otpMailSignup', { userEmail: data.email, otp }).then(res => {
      setLoadingg(false)
