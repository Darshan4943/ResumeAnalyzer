...
const EmployerSignUp = () => {
    ...
    return (
        <div className="w-full relative flex items-center flex-col gap-[18px] pb-[62px]">
            <div className="sticky z-[100] w-full top-[47px] bg-[#F3F4F5] pt-[24px]">
                <div className="w-full bg-[#FFDA1D] flex items-center flex-col gap-2 py-[6px] ">
                    <span className="text-[40px] font-[600] text-[#333333]">Register as Employer</span>
                    <span className="text-[16px] font-[500] text-[#333333]">Start your Search with Skilotech</span>
                </div>
            </div>
            <div className="flex items-center flex-col gap-1 pb-[18px]">
                <div className="flex items-center">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="12" cy="12" r="11.5" fill="transparent" stroke="#C7C7C7" />
                        <circle cx="12" cy="12" r="8" fill="#FFDA1D" />
                    </svg>
                    <div className="relative h-[2px] w-[312px]">
                ...
                <div className="flex items-center gap-[188px]">
                    <span className="text-[16px] font-[500] text-[#333333]">Company Details</span>
                    <span className="text-[16px] font-[500] text-[#333333]">Upload Documents</span>
                </div>
            </div>


            {/* Company Details */}
            <div style={{ boxShadow: "0px 1px 6px 0px #00000040" }} className={`${tog === 1 ? "flex" : "hidden"} w-[45%] rounded-[16px] p-6 flex-col gap-6 `}>
                {companyFields.map((field, index) => (
                    <div key={index} className="flex w-full flex-col gap-1">
                        <div className="text-[16px] font-[500] text-[#333333]">{field.title} <span className="text-red">*</span></div>
                ...
                <div className="w-full flex justify-between">
                    <button onClick={() => { router.back() }} className="py-[12px] px-[36px] border border-[#06A9EF] rounded-[12px] text-[16px] font-[500] text-[#333333]">Go Back</button>
                    <button onClick={handleSubmit} className="py-[12px] px-[36px] border border-[#06A9EF] bg-blue rounded-[12px] text-[16px] font-[500] text-[#FFFFFF]">Continue</button>
                </div>
            </div>

            {/* Upload Documents */}
            <div style={{ boxShadow: "0px 1px 6px 0px #00000040" }} className={`${tog === 2 ? "flex" : "hidden"}  w-[45%] rounded-[16px] p-6 flex-col gap-6`}>
                ...
                <div className="w-full flex justify-between">
                    <button onClick={handleBack} className="py-[12px] px-[36px] border border-[#06A9EF] rounded-[12px] text-[16px] font-[500] text-[#333333]">Go Back</button>
