        ...
        {!isSidebarOpen &&
          <>
            <motion.div
              ...
              className="absolute z-[2000] w-[90%] mt-[2rem] h-[90vh] rounded-r-[12px] mobile overflow-y-auto left-0 "

            >
              <div className="w-full relative flex   ">
                <div className="flex flex-col w-[100%] h-[100%] bg-[#fff] ">
                  <div className=" p-4 flex flex-col gap-4  items-end ">
                    <div className="flex gap-3 w-[80%] items-center justify-between">
                      <div className="flex gap-3 items-center justify-center">
                        <img
                          src="/images/resumeBuilder/sklogo.png"
                          alt=""
                      ...
                      <div onClick={() => setIsSidebarOpen(!isSidebarOpen)} >
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <g mask="url(#mask0_3079_40864)">
                            <path d="M3.54922 11.9996L10.8992 19.3496C11.1492 19.5996 11.2701 19.8913 11.2617 20.2246C11.2534 20.558 11.1242 20.8496 10.8742 21.0996C10.6242 21.3496 10.3326 21.4746 9.99922 21.4746C9.66589 21.4746 9.37422 21.3496 9.12422 21.0996L1.42422 13.4246C1.22422 13.2246 1.07422 12.9996 0.974219 12.7496C0.874219 12.4996 0.824219 12.2496 0.824219 11.9996C0.824219 11.7496 0.874219 11.4996 0.974219 11.2496C1.07422 10.9996 1.22422 10.7746 1.42422 10.5746L9.12422 2.87462C9.37422 2.62462 9.67005 2.50379 10.0117 2.51212C10.3534 2.52046 10.6492 2.64962 10.8992 2.89962C11.1492 3.14962 11.2742 3.44129 11.2742 3.77462C11.2742 4.10796 11.1492 4.39962 10.8992 4.64962L3.54922 11.9996Z" fill="#333333" />
                          </g>
                        </svg>
                      </div>
                    </div>
