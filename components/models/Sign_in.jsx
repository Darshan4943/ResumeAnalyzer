      ...
      >
        ...
        <div className="w-full flex flex-col gap-[24px]">
          ...
          <div className="flex flex-col gap-[10px] relative mb-4">
            ...
            {error && (
              <div
                className={`flex justify-start text-[16px] gap-2  absolute bottom-[-30px]  ${error ? "text-[#c00000] font-[600]" : "text-green font-[600]"
                  }`}
              >
                <svg
                  width="24"
