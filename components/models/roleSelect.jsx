        ...
        <div className="flex flex-col sm:gap-[24px] gap-4  scr1024:p-6 p-3  rounded-[12px] max-w-[400px] scr1024:min-w-[400px]">
          ...
          <div className="flex justify-center item-center">
            <div className="flex flex-col gap-[24px] px-[8px]">
                  ...
                  <div className=" border-[1px] border-[#333] rounded-[50%] flex justify-center items-center  sm:h-[40px] h-[32px] sm:w-[40px] w-[32px]">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_7608_92288)">
                        <path d="M24 11.2851H21.615C21.2645 6.53381 17.4665 2.73605 12.7149 2.38485V0H11.2851V2.38485C6.5337 2.73605 2.73536 6.5337 2.38485 11.2851H0V12.7149H2.38485C2.73536 17.4666 6.5337 21.264 11.2851 21.6151V24H12.7149V21.6151C17.4665 21.264 21.2645 17.4666 21.615 12.7149H24V11.2851ZM12.0001 20.2215C7.46689 20.2215 3.7785 16.5331 3.7785 11.9999C3.7785 7.46677 7.46689 3.77839 12.0001 3.77839C16.5332 3.77839 20.2216 7.46677 20.2216 11.9999C20.2216 16.5331 16.5332 20.2215 12.0001 20.2215Z" fill="#333333" />
                        <path d="M13.4311 12.3467C14.481 11.6402 15.2043 10.2467 15.2043 8.9921C15.2043 7.22192 13.7688 5.78711 11.9984 5.78711C10.2289 5.78711 8.79423 7.22249 8.79423 8.9921C8.79423 10.2467 9.51611 11.6402 10.5672 12.3467C8.05481 12.9835 6.19531 15.1631 6.19531 16.7786C6.19531 18.6888 17.8029 18.6888 17.8029 16.7786C17.8029 15.1639 15.9416 12.9835 13.4311 12.3467ZM11.9984 18.2099L10.3734 16.5845L11.7418 13.2761H11.7275L11.1955 12.6666C11.4521 12.7588 11.7201 12.8146 11.9984 12.8146C12.2762 12.8146 12.5444 12.7588 12.8012 12.668L12.2692 13.2769H12.2567L13.6252 16.5855L11.9984 18.2099Z" fill="#333333" />
                      </g>
                      <defs>
              ...
              <div onClick={() => { signin ? router.push("/auth/Sign_in?role=employer") : router.push("/auth/EmployerSignUp") }} className="p-[16px] z-0 flex flex-row justify-between rounded-[16px] gap-4 relative sign_up_shadow cursor-pointer">
                <div className="flex flex-row justify-center item-center gap-[12px] ">
                  <div className=" border-[1px] border-[#333] rounded-[50%] flex justify-center items-center sign_iu_text_border sm:h-[40px] h-[32px] sm:w-[40px] w-[32px]">
                  ...
                  <div>
                    <div className="text-[14px]  sm:text-[16px] font-[500] sign_ip_text">Employer</div>
                    <div className="text-[10px]  sm:text-[12px] font-[500] text-[#646464] sign_ip_text ">
                      Create resumes for various clients
                    </div>
                  </div>
