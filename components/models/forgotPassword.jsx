...
function ForgotPassword({ setIsForgot }) {
  ...
  const handleVerification = (e) => {
    ...
    axios
      .post("http://192.168.1.161:2000/api/otpMail", {
        userEmail: email,
...
e.preventDefault();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://192.168.1.161:2000/api/updatePassword",
        {
          email: email,
  ...
  return (
    <>
      {tabIndex === 1 && (
        <div className=" absolute rounded-[16px] bg-white shadow-lg p-6 flex flex-col gap-6 ml:min-w-[400px] ml:w-[28%] ms:w-[60%] scr420:w-[80%] w-[90%]">
          <div className="flex justify-center scr420:text-[20px] text-[24px] font-[600] ">
            Forgot Password
          </div>
          ...
          <div className=" flex flex-col gap-2">
            ...
            <input
              ...
              className="border border-[#DEDEDE] rounded-[8px] px-4 py-[9px] leading-[20.67px] w-[100%] text-[14px] font-[400]"
          ...
          {verify && (
            <div className=" flex flex-col gap-2">
              ...
              <div className="text-[10px] font-[500] text-[#C00000]">
      ...
      {tabIndex === 2 && (
        <div className=" absolute rounded-[16px] bg-white shadow-lg p-6 flex flex-col gap-6 ml:min-w-[400px] ml:w-[28%] ms:w-[60%] scr420:w-[80%] w-[90%]">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-row px-[16px] py-[10px] border-[1px] rounded-[8px] items-center border-solid border-[#DEDEDE] justify-between leading-[18.67px]">
              <input
          ...
          {passwordError != null && (
            <div className="text-black flex flex-row text-[10px] font-[500]">
              <span className="p-0">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-row px-[16px] py-[10px] border-[1px]  items-center rounded-[8px] border-solid border-[#DEDEDE] justify-between leading-[18.67px]">
              <input
            ...
            {errorMessage && <div className="text-red text-[10px] font-[500]">{errorMessage}</div>}
          </div>
      ...
      {tabIndex === 3 && (
        <>
          <div className=" absolute rounded-[16px] bg-white shadow-lg pt-[42px] pb-6 px-11 flex flex-col gap-4 ml:min-w-[350px] ml:w-[25%] ms:w-[50%] scr420:w-[80%] w-[90%] ">
            <svg
              className="absolute top-[-33px]  left-[42%] right-[62%] flex"
              xmlns="http://www.w3.org/2000/svg"
              width="59"
              height="59"
              viewBox="0 0 85 85"
            ...
            <div className="text-center flex flex-col gap-2">
              <div className="scr420:text-[24px] text-[24px] font-[600] text-[#333]">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="py-[12px] px-[24px] rounded-[30px] bg-[#06A9EF] leading-[18px] text-[#fff] text-[14px] font-[600]"
              >
                Done
              </button>
            </div>
