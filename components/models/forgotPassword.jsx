...
function ForgotPassword({ setIsForgot }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:2000/api/updatePassword', {
                email: email,
        ...
        <>
            {tabIndex === 1 &&
                ...
                <div className=' absolute rounded-[16px] bg-white shadow-lg p-6 flex flex-col gap-6 w-[33%]'>
                    ...
                    {verify &&
                        <div className=" flex flex-col gap-2">
                            ...
                            <div className='text-[12px] flex gap-2 font-[600] '>
                                ...
                                <button onClick={handleVerification} disabled={!resend} className={` ${resend ? "text-blue border-blue" : "text-[#BEBEBE] border-[#BEBEBE]"} border-b  leading-tight `}>Re-send Code</button>
                                {!resend &&
                    ...
                    {verify ?
                        ...
                        :
                        <button onClick={handleVerification} className='h-[55.33px] border border-[#06A9EF] items-center text-white text-[20px] flex justify-center font-[500] bg-[#06A9EF] rounded-[12px] px-4 py-3 w-[100%]'>
                            {loading ?
                                <MiniLoader />
                                :
                                "Verify Email  "
            ...
            {tabIndex === 2 &&
                <div className=' absolute rounded-[16px] bg-white shadow-lg p-6 flex flex-col gap-6 w-[33%]'>
                    ...
                    <button onClick={(e) => handleSubmit(e)} className='border border-[#06A9EF] text-white text-[20px] font-[500] bg-[#06A9EF] rounded-[12px] px-4 py-3 w-[100%]'>
                        Submit
                    </button>
