...
const ResetPasswordModal = () => {
  ...
  const submitHandler = () => {
    ...
    if (userDataGlobal.tempPassword == data.new) {
      setError("New password and current password cannot be same");
      return true;
    }
    if (data.newConfirm != data.new) {
              ...
              <div className="flex flex-col gap-[24px] items-center">
                ...
                <div className="flex flex-col w-full gap-[16px]">
                  ...
                  <div className="flex flex-col gap-[8px] w-full">
                    ...
                    <div className="w-full flex flex-row px-[16px] py-[12px] border-[1px] rounded-[8px] border-solid border-[#9D9D9D] justify-between">
                      <input
                        type={passwordVisible.newConfirm ? "text" : "password"}
                        name=""
                        id=""
                        placeholder="Confirm password"
                        className="w-full"
                  ...
                  {
                    error && <span className="text-[14px] text-red font-medium">
                    {error} !
                  </span>
                  }
