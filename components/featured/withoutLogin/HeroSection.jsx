    ...
    return (
        <div className='bg-[#EBF9FF] py-[30px] relative'>
            <div className='  flex gap-[33px] items-center customMargins justify-between'>
                ...
                <div className='xl:h-[463px] xl:w-[541px] w-[37.5vw] h-[32.1vw] xl:hidden'>

                </div>
                <img
                    src="/images/withoutLogin/hero.png"
                    alt=""
                    className="xl:h-[463px] xl:w-[541px] w-[37.5vw] h-[32.1vw] xl:relative  absolute right-[24px]  object-cover xl:pl-[168px] xl:overflow-visible   "
