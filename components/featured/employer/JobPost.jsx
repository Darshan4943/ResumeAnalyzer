      ...
      <div className="w-[100%] max-h-[80vh] flex flex-col  relative   ">
        <div className="">
          ...
          <div className="flex   px-[16px] pb-[12px] items-start  gap-[40px] bg-[#fff]">
            ...
            <p onClick={() => setOption(1)} className="text-[16px] text-[#646464] font-[600]">Job Details</p>
            <p onClick={() => setOption(2)} className="text-[16px] text-[#646464] font-[600]">Analytics</p>
          </div>
        ...
        {option === 0 &&
          <>
            ...
            <div className="flex  p-[16px] justify-between items-center bg-[#fff]">
