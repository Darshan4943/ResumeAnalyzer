          ...
          <div className="flex flex-col w-[100%] scr700:px-[32px] px-[16px] py-[24px] justify-between rounded-[12px] gap-[17px] bg-[#fff] ">
            <div className="flex justify-between w-[100%] items-center">
              <div className="flex gap-[20px] justify-center  items-center">
                ...
                <div className="text-[16px] text-[#333333] font-[600]">Assistant Manager</div>
            ...
            <div className="flex flex-col scr1024:flex-row justify-between">
              <div className="flex gap-[10px]  justify-start">
                <div className="flex gap-[4px] items-center">
                  ...
                  <div className="text-[12px] text-[#262626] font-[500]">1-2 yrs</div>
                </div>
                ...
                <div className="flex gap-[4px] items-center">
                  ...
                  <div className="text-[12px] txet-[#262626] font-[500]">Part Time</div>
                </div>
                <div className="border-[1px] border-[#AFAFAF]"></div>
                <div className="flex gap-[4px] items-center">
                  <svg
                  ...
                  <div className="text-[12px] text-[#262626] font-[500]">Pune</div>
                </div>
              </div>
              <div className="flex gap-[10px] items-center">
                <div className="text-[14px] font-[600] text-[#333333]">Total Applications</div>
                <div className="text-[24px] font-[600] text-[#333333]">18</div>
              </div>
              <div className="flex gap-[10px] items-center">
                <div className="text-[14px] font-[600] text-[#333333]">Customer Support</div>
                <div className="text-[16px] font-[600] text-[#333333]">4 / <span className="text-[16px] font-[600] text-[#646464]"> 11 Hired</span></div>
              </div>
              <div className="flex gap-[4px] items-center">
                <div className="text-[12px] font-[500] text-[#646464]">Date posted</div>
                      ...
                      >
                        <div className="  gap-[24px]  w-full justify-between flex items-center">
                          ...
                          <div className="flex  w-[20%] items-center gap-[16px] relative">
                            ...
                            <button className="text-[10px] text-[#FFFFFF] font-[500] py-[4px] px-[8px] rounded-[30px] bg-[#06A9EF]">
                              Shortlist
                            </button>
