          ...
          <div className="flex flex-col w-[100%] scr700:px-[32px] px-[16px] py-[24px] justify-between rounded-[12px] gap-[17px] bg-[#fff] ">
            <div className="flex justify-between w-[100%] items-center">
              <div className="flex gap-[20px] justify-center  items-center">
                ...
                <div className="text-[16px] text-[600]">Assistant Manager</div>
            ...
            <div className="flex justify-between">
              <div className="flex gap-[10px]  justify-start">
                <div className="flex gap-[4px] items-center">
                  ...
                  <div className="text-[12px] font-[400]">1-2 yrs</div>
                </div>
                ...
                <div className="flex gap-[4px] items-center">
                  ...
                  <div className="text-[12px] font-[400]">Part Time</div>
                </div>
                <div className="border-[1px] border-[#AFAFAF]"></div>
                <div className="flex gap-[4px] items-center">
                  <div>
                  ...
                  <div className="text-[12px] font-[400]">Pune</div>
                </div>
              </div>
              <div className="flex gap-[10px] items-center">
                <div className="text-[14px] text-[600]">Total Applications</div>
                <div className="text-[24px] text-[600]">18</div>
              </div>
              <div className="flex gap-[10px] items-center">
                <div className="text-[14px] text-[600]">Customer Support</div>
                <div className="text-[14px] text-[600]">4 / 11 Hired</div>
              </div>
              <div className="flex gap-[10px] items-center">
                <div className="text-[14px] text-[600]">Date posted</div>
                <div className="text-[14px] text-[600]">20 Dec 2023</div>
              </div>
            </div>
          </div>

          <div>
            <div className="flex px-[16px] ms:text-[16px] text-[16px] rounded-t-[16px]  items-start  ml:gap-[40px] gap-2 bg-[#fff]">
              <div className="flex flex-col mt-[18px] items-center gap-[7px] shadow-border">
                ...
                >
                  <path
                    ...
                    fill={activeOption === "Applicants" ? "#06A9EF" : "white"}
                  />
                </svg>
              </div>
              <div className="flex flex-col mt-[18px] items-center gap-[7px] shadow-border">
          ...
          <>
            <div className="flex scr700:flex-row flex-col-reverse  p-[16px] justify-between scr700:items-center gap-4  bg-[#fff]">
              ...
              <div className="flex gap-[8px]">
                <div className="text-[14px] text-[600] text-[#fff] bg-[#06A9EF] rounded-[30px] py-[12px] px-[36px]">
                  Shortlist
                </div>
                <div className="text-[14px] text-[600] text-[#B3261E] border-[1px] border-[#B3261E] rounded-[30px] py-[12px] px-[36px]">
                  Reject
                </div>
              </div>
            </div>
                      ...
                      >
                        <div className="  gap-[24px]  w-full justify-between flex items-center">
                          ...
                          <div className="flex  w-[20%] items-center gap-[16px] relative">
                            ...
                            <button className="text-[10px] font-[500] py-[4px] px-[8px] rounded-[30px] bg-[#06A9EF]">
                              Shortlist
                            </button>
