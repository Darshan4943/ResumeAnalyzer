                                ...
                                <AnimatePresence>
                                  {moreOption && selectedDotIndex === index && (
                                    <motion.div
                                      ...
                                      transition={{ duration: 0.5 }}
                                      ref={taskRef}
                                      className='absolute flex flex-col  rounded-[8px]  z-10 top-[100%] w-[230px] border-l border-r border-b border-[#06A9EF] p-2 bg-white' style={{ boxShadow: "0px 1px 2px 0px rgba(0, 0, 0, 0.25)" }}
                                    >
