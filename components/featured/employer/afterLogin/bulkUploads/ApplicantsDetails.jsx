    ...
    return (
        ...
        <div className='flex flex-col gap-6 relative h-[75vh] overflow-y-auto'>
            ...
            <div className='scr800:flex scr800:flex-row gap-5 flex flex-col  '>
                <div className=' rounded-[16px] py-2 flex flex-col w-[100%] scr800:w-[32.26%] bg-white ' style={{ boxShadow: "0px 0.5px 3px 0px rgba(0, 0, 0, 0.25)" }}>
                    <div className='flex flex-col overflow-y-auto gap-6 px-6 py-4' >
                        <div className=' flex  gap-6' >
                            ...
                            <div className='w-[65%] flex flex-col gap-1'>
                                <p className='scr420:text-[24px] text-[18px]  text-start   font font-medium  '>John Doe</p>
                                <p className='scr420:text-[16px] text-[14px]  text-start text-[#646464]   font-normal  '>Product Designer</p>
                                <div className='flex gap-2'>
                                    ...
                                    <p className='scr420:text-[16px] text-[14px]    font-normal '>4.0</p>
                                </div>
                            </div>
                ...
                <button onClick={()=>router.push("/employer/afterLogin/Hiring?content=JobPost")} className="flex py-[12px] w-[100%] scr1200:px-[9px] scr1350:px-[22px] justify-center items-center gap-[10px] rounded-[12px] bg-[#06A9EF] text-[12px] sm:text-[16px] text-[#fff] font-[600] leading-[160%]">Move to Hiring</button>
                        ...
                        <div className='flex flex-col gap-4 break-word text-[16px] font-normal'>
                            <p className='font-medium scr420:text-[16px] text-[14px]'>Contact</p>
                            <div className='flex gap-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <p className='scr420:text-[16px] text-[14px] break-all'>kshitijwaghmare111@gmail.com</p>
                            </div>
                            <div className='flex gap-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <div className='flex gap-2'>
                                ...
                                <p className='scr420:text-[16px] text-[14px] '>Pune, Maharashtra, India</p>
                            </div>
                            <div className='flex gap-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <p className='scr420:text-[16px] text-[14px] break-all'>www.linkedin.com/in/kshitijw</p>
                            </div>
                            <div className='flex gap-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className=' rounded-[16px] py-2 flex flex-col w-[100%] scr800:w-[66.17%] bg-white ' style={{ boxShadow: "0px 0.5px 3px 0px rgba(0, 0, 0, 0.25)" }}>
                    <div className='flex flex-col  gap-4 px-6 py-4'>
                        <div className='flex flex-col '>
                            <div className='flex gap-[36px] text-[16px] font-semibold'>
                                <div>
                                    <p
                                        className=" cursor-pointer scr420:text-[16px] text-[14px]"
                        ...
                        <div className='flex flex-col gap-4 text-[16px] font-normal px-6 overflow-y-auto'>
                            ...
                            <div className='flex gap-6'>
                                <div className='flex flex-col gap-4 w-[50%]'>
                                    <div>
                                        <p className=' font-medium scr420:text-[16px] text-[14px]'>Full Name</p>
                                        <p className='scr420:text-[16px] text-[14px]'>John Doe</p>
                                    </div>
                                    <div>
                                        <p className=' font-medium scr420:text-[16px] text-[14px]'>Address</p>
                                        <p className='scr420:text-[16px] text-[14px]'>4517 Washington Ave. Manchester, Kentucky 39495</p>
                                    </div>

                                </div>
                                <div className='flex flex-col gap-4 w-[50%]'>
                                    <div>
                                        <p className=' font-medium scr420:text-[16px] text-[14px]'>Gender</p>
                                        <p className='scr420:text-[16px] text-[14px]'>Male</p>
                                    </div>
                                    <div>
                                        <p className=' font-medium scr420:text-[16px] text-[14px]'>Language</p>
                                        <p className='scr420:text-[16px] text-[14px]'>English, French, Bahasa</p>
                                    </div>
                            ...
                            <div className='flex flex-col gap-4'>
                                ...
                                <div className='flex flex-col gap-2 w-[100%] ms:w-[80%]'>
                                    <p className=' font-medium scr420:text-[16px] text-[14px]'>About Me</p>
                                    <div className='flex flex-col gap-4'>
                                        <p className='scr420:text-[16px] text-[14px]'>I’m a product designer + filmmaker currently working remotely at Twitter from beautiful Manchester, United Kingdom. I’m passionate about designing digital products that have a positive impact on the world.</p>
                                        <p className='scr420:text-[16px] text-[14px]'>For 10 years, I’ve specialised in interface, experience & interaction design as well as working in user research and product strategy for product agencies, big tech companies & start-ups.</p>
                                    </div>
                                </div>
                                ...
                                <div className='scr800:flex scr800:flex-row  flex flex-col justify-between'>
                                    <div className='flex flex-col gap-4 w-[30%] '>
                                        <div>
                                            <p className=' font-medium scr420:text-[16px] text-[14px]'>Current Job</p>
                                            <p className='scr420:text-[16px] text-[14px]'>Product Designer</p>
                                        </div>
                                        <div>
                                            <p className=' font-medium scr420:text-[16px] text-[14px]'>Highest Qualification</p>
                                            <p className='scr420:text-[16px] text-[14px]'>Bachelors in Engineering</p>
                                        </div>

                                    </div>
                                    <div className='flex flex-col gap-4 w-[70%]'>
                                        <div>
                                            <p className=' font-medium scr420:text-[16px] text-[14px]'>Experience in Years</p>
                                            <p className='scr420:text-[16px] text-[14px]'>4 Years</p>
                                        </div>
                                        <div className='flex flex-col gap-2'>
                                            <p className=' font-medium scr420:text-[16px] text-[14px]'>Skills</p>
                                            <div className='flex gap-2 font-medium flex-wrap'>
                                                <p className='border border-[#06A9EF] rounded-[24px] px-[10px] scr420:px-4 scr420:py-3 py-[10px] scr420:text-[14px] whitespace-nowrap text-[11px]'>Product Design</p>
                                                <p className='border border-[#06A9EF] rounded-[24px] px-[10px] scr420:px-4 scr420:py-3 py-[10px] scr420:text-[14px] whitespace-nowrap text-[11px]'>User Research</p>
                                                <p className='border border-[#06A9EF] rounded-[24px] px-[10px] scr420:px-4 scr420:py-3 py-[10px] scr420:text-[14px] whitespace-nowrap text-[11px]'>Wireframing</p>
                                            </div>
                                        </div>
