...
function GenerateOffer({setGenerateOffer}) {
    ...
    <>
      ...
      <div className="fixed z-[2000] top-0 left-0 right-0 bottom-0 flex items-center justify-center customMargins   ">
        <div className="absolute w-[95%] ms:w-[90%] ">
          <div
            className="flex w-[100%] p-[10px] sm:p-[24px] flex-col items-center gap-[16px] rounded-[16px] h-[100vh] overflow-y-auto bg-[#fff] "
