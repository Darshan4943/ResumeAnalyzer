                          ...
                          <div className="flex   items-center w-full  justify-between relative">
                            {
                              applicants.verifyStatus == "Verified" ? <button
                                ...
                                className={`flex lg:py-2 lg:px-4 px-1 py-1 justify-center items-center  rounded-[6px]  lg:text-[14px] text-[10px] font-[600] font-Montserrat border ${applicants.offer === "Generate Offer" ? "text-[#fff] bg-[#06A9EF]" : "text-[#333] bg-[#fff]"
                                  }`}
                              >
                                {applicants.offer}
                              </button> : <button
