...
function PersonalDetails({setToggle}) {
    ...
    return (
        <div className="flex flex-col gap-[8px] ">
            <div className="flex flex-col text-[16px] ml:text-[20px] gap-[8px] bg-[#E0F6FF] px-4">
            ...
            <div className="flex justify-end text-[#333] text-[14px] font-[600] px-4 items-center">
                <svg
            ...
            <div className="flex flex-row bg-white p-4  gap-[4px] justify-between ">
                ...
                <button onClick={() => setToggle(1)} className="  text-[#fff] text-[16px] font-semibold px-9 py-3 max-scr1100:px-6  bg-[#06A9EF] rounded-[12px]">
                    Continue
                </button>
            </div>
            ...
            {editView && (
                <>
                    <div className="opacity-25  inset-0 z-[120] "></div>
                    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto  inset-0 z-[130] outline-none focus:outline-none">
                        <div className="absolute w-[90%] ms:w-[75%]">
                            <div className="bg-[#fff]">dd</div>
                        </div>
                    </div>
                </>
            )}
