...
function Assessment({ setSuccessfull, setToggle }) {
  ...
  return (
    <div className="flex flex-col gap-[8px] ">
      ...
      <div className="flex flex-row bg-white pt-[12px] px-[12px] ml:p-4 gap-[4px] justify-between ">
        <button
          onClick={() => setToggle(2)}
          className="border-[1px] border-solid border-[#06A9EF] text-[14px] ml:text-[16px] font-medium py-[12px] px-[16px] ml:px-[36px] rounded-[12px] "
        >
          Back
        </button>
        <button
