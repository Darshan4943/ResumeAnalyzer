...
function CreateNewJob() {
  ...
  return (
    <div className="flex flex-row  gap-[20px] ml:max-h-[80vh] pb-4 ">
      ...
      <div className=" ml:w-[60%] w-full overflow-y-auto pb-4 relative ">
        <HiringPostJob setIsSetting={setIsSetting} />
          ...
          {isSetting &&
            ...
            <div className="fixed z-[2000] top-0 left-0 right-0 bottom-0 bg-black opacity-40"></div>
              <motion.div
                ...
                ref={taskRef}
                className=" fixed z-[2000] mobile  rounded-[8px] max-h-[80vh] overflow-y-auto top-[8rem] right-0 bottom-0" style={{  backdropFilter: 'blur(10px)' }}
              >
