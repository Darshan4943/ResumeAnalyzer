...
function CreateNewJob({ setToggle }) {
  ...
  const borderColor = formError.description ? "red" : "#ccc";
                  ...
                  <div className="bg-[#FFFFFF] flex flex-col rounded-[16px] gap-[16px] ">
                    <div>
                      <div className="flex flex-wrap gap-[16px] p-[16px]">
                        <div className="flex flex-col gap-[8px] w-full xxsm:w-[100%] scr360:w-[100%] sm:w-[48%] lg:w-[32%]">
                      ...
                      <div className="p-[16px] md:flex-row  md:flex flex flex-col gap-[16px] ">
                          ...
                          <div className="flex w-full flex-col gap-[8px]">
                            <div className="flex flex-col gap-[8px]">
                              ...
                              <input
                                ...
                                placeholder=" Brief description for your company. URLs are
                          hyperlinked."
                                type="text"
                            ...
                            <div className="flex flex-col gap-[8px]">
                              ...
                              <div className="text-[12px] font-[400]">
                                This image will be shown publicly as company
                                logo.
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="w-full max-w-[958px] flex flex-col">
                          <div className="flex scr540:flex-row flex-col gap-[16px]">
                            <div className="flex flex-col gap-[8px] scr540:w-[58%] w-full">
                              <div className="text-[14px] font-[500]">
                                Company Name{" "}
                            ...
                            <div className="flex flex-col gap-[8px] scr540:w-[40%] w-full ">
                              <div className="text-[14px] font-[500]">
                              ...
                              <ReactSelect
                                ...
                                isMulti
                                className="w-full min-w-[150px] rounded-[8px] text-[14px] font-montserrat font-small text-black "
                    ...
                    <div>
                      <div className="p-4 gap-4 flex flex-col">
                        ...
                        <div className="flex flex-wrap gap-5">
                          ...
                          <div className="flex flex-col gap-2 w-full sm:w-[250px] lg:w-[396px]">
                            <div className="text-sm font-medium">
                              Min Salary
                            </div>
                            <input
                    ...
                    <div>
                      <div className="flex flex-col gap-4 p-4">
                        ...
                        <div className="flex flex-wrap gap-5">
                          <div className="flex flex-col gap-2 w-full sm:w-[109px]">
                            <div className="text-sm font-medium">
                              Open Positions
                            </div>
                            <select
                          ...
                          <div className="flex flex-col gap-2 w-full sm:w-[298px]">
                            <div className="text-sm font-medium">
                              Job Sector
                            </div>
                            <select
                      ...
                      <div className="sm:flex gap-[12px] flex flex-wrap  justify-between w-full max-w-[1240px] p-4">
                        <div
                          onClick={handleClick}
