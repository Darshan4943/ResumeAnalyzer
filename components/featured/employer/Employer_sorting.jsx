              ...
              <div className="sorting_wrapper">
                ...
                <div className="sorting_para desk_para">
                  <div className="sorting_para one">
                    AI-powered candidate sorting is an automated system that
                    uses artificial
                ...
                <div className="sorting_para phone_para">
                  ...
                  artificial intelligence to quickly and objectively evaluate
                  job applicants based on specific criteria, streamlining the
                  hiring process and improving candidate selection efficiency.
                </div>
              </div>
