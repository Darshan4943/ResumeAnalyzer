...
function JobPostSetting({setIsSetting}) {
        ...
        <div className="  flex  flex-col gap-4 rounded-[16px] py-2 bg-white" style={{ boxShadow: "0px 0.5px 3px 0px rgba(0, 0, 0, 0.25)" }}>
            <div className="overflow-y-auto px-4 py-2 flex flex-col gap-4 " >
                ...
                <div className='flex flex-col gap-4 justify-center items-center'>
                    ...
                    <div class="border-dashed border-[2px] border-[#06A9EF] flex flex-col w-full rounded-[12px] px-2 py-[24px] items-center gap-[8px]">
                ...
                <div className='flex flex-col gap-2 '>
                    ...
                    <div className='flex gap-4 p-2 border border-[#646464] rounded-[6px] min-w-[200px] w-[43%] justify-between'>
