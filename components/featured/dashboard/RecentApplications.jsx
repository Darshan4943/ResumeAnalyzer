            ...
            <div className="web">
                ...
                <div className="flex flex-col gap-[16px] items-start bg-[#fff]  overflow-y-auto">
                    {!applicants?.data?.applications.length == 0 ? (
                        <>
                            {applicants?.data?.applications.map(
                                (applicant, index) => (
                                    <>
                                        <div
                                        ...
                                        >
                                            <div className="  gap-[20px]  w-full justify-between flex items-center">
                                                ...
                                                <div className="flex justify-end  w-[20%] items-center gap-[16px] relative">
                                                    ...
                                                    <>
                                                        {isPopupVisible && (
                                                            <ShortlistMail shortlist={shortlist} setPopupVisible={setPopupVisible} id={applicant?.jobId} statusChange={statusChange} setStatusChange={setStatusChange} applicantIds={applicantIds} />
                                                        )}
                                                    </                                                                                                  >
