  ...
  return (
    <>
      ...
      <div className="fixed z-[2000] top-0 left-0 right-0 bottom-0 flex items-center justify-center    px-4 py-4 ">
        <div className=" absolute bg-white rounded-lg    px-4 py-4   shadow-lg min-h-[500px] max-h-[600px] overflow-x-auto  items-end w-[40vw] flex flex-col gap-[8px]">
          <div className="flex flex-col gap-[4px]  w-full relative">
            <img
              src="/images/jobs/close.png"
              className="h-[34px] w-[34px] absolute right-0 cursor-pointer"
              alt=""
