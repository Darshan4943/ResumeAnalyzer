...
export default function AskKrutAi() {
    ...
    return (
        <div className=" customMargins flex ml:flex-row flex-col-reverse ml:gap-[2vw] gap-8 xl:gap-12 items-center justify-between py-9">
            <div className="flex flex-col gap-6 ml:w-[60%] xl:w-[712px] w-full text-[#333333] pr-6 ml:text-start text-center ml:items-start items-center ">
                <div className="font-semibold ml:text-[3vw] text-[28px] leading-tight xl:text-[42px]">
                    Get Curated Advice
                    <p className="text-[#06A9EF] ">
                        <span className='font-semibold ml:text-[3vw] xl:text-[42px] text-[28px] w-[100%] break-words text-[#333333]'>from </span> “Krut” <span className='font-semibold ml:text-[3vw] text-[28px] w-[100%] xl:text-[42px] break-words text-[#333333]'>Skilotech&apos;s </span>
                        <span className="font-semibold ml:text-[3vw] xl:text-[42px] text-[28px] w-[100%] break-words text-[#333333]">
                            Personalized
                        </span>
                        {" "}  AI Chatbot
                    </p>
                ...
                <div className='font-medium ml:text-[1.1vw] text-[14px]  w-[100%] break-words text-[#333333] xl:text-[16px]'>
