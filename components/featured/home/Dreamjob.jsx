...
function DreamJob({ isLogin }) {
  ...
  return (
    // <div className=" bg-bg_inventory bg-cover bg-no-repeat ">
      <div className="customMargins flex md:flex-row flex-col md:gap-[2vw]  gap-12 items-center py-12">
        <div className="md:w-[50%] w-full  flex justify-center  items-center md:pr-12 ">
          <img
            src="/images/resumeBuilder/dreamJob.png"
            alt=""
            className={`md:w-[40vw] w-[50vw] md:h-[45vw] h-[55vw] object-contain md:py-12`}
          />
        </div>
        <div className=" flex flex-col gap-6 md:w-[47%] w-full text-[#000000] md:text-start text-center  ">
          <div className="flex flex-col gap-[24px] md:items-start items-center">
            <div className="font-semibold md:text-[2.5vw] text-[30px] leading-tight">
               Find Your <span className="text-[#06A9EF]">Dream Job</span>
           
            <p className="font-semibold md:text-[2.5vw] text-[30px] text-[#333333] ">
