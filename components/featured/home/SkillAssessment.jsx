...
function SkillAssessment({ isLogin }) {
  ...
  return (
    ...
    //  className=" bg-SkillAssessment bg-cover bg-no-repeat"
     >
      <div className=" customMargins scr1024:py-[120px]  pt-6 pb-12   min-h-[350px] scr360:min-h-[370px] sm:min-h-[400px] scr540:min-h-[440px] ms:min-h-[480px] scr700:min-h-[530px] ml:min-h-[570px] scr1024:min-h-[30vw]  ">
        <MouseParallaxContainer
          globalFactorX={0.4}
          globalFactorY={0.4}
          resetOnLeave
        ...
        >
          <MouseParallaxChild
            factorX={0.06}
            factorY={0.06}
            className=" scr1024:mt-[51px] my-[30px] scr1024:mb-[148px] sm:px-[24px] px-3 scr1024:pb-[70px] md:pb-[200px] ms:pb-[160px] sm:pb-[140px] pb-[140px]   sm:pt-[24px] pt-3 scr1024:w-[90%] w-full scr1024:h-[18vw] md:h-[20vw] h-[30vw] "
            style={{
              borderRadius: "16px",
          ...
          >
            <div className="flex flex-col scr1024:gap-[30px] gap-4 w-full">
              <div className="flex flex-col gap-[8px] w-full">
                ...
                <div className="scr1024:text-[1.2vw] sm:text-[2.3vw] text-[10px] font-[500] w-full text-[#333]">
          ...
          <MouseParallaxChild
            factorX={0.12}
            factorY={0.12}
            className="absolute scr1024:w-[34vw] sm:w-[28%] w-[28%] scr1024:h-[10vw] scr1024:p-[16px] p-1 scr1024:rounded-[16px] rounded-[8px] flex  flex-col  scr1024:flex-row scr1024:gap-[16px] gap-1 justify-between items-center scr1024:left-[25%] md:left-[5%] sm:left-[10%] left-[10%] scr1024:top-[50%] top-[70%] "
            style={{
          ...
          <MouseParallaxChild
            factorX={0.15}
            factorY={0.15}
            className="absolute scr1024:w-[34vw] scr1024:h-[10vw] w-[28%] scr1024:p-[16px] p-1 scr1024:rounded-[16px] rounded-[8px] flex  flex-col-reverse  scr1024:flex-row scr1024:gap-[16px] gap-1  items-center justify-between scr1024:right-[0%] md:right-[30%] sm:right-[30%] right-[30%] scr1024:top-[0%] top-[80%]  "
            style={{
              background: "rgba(6, 169, 239, 0.40)",
              backdropFilter: " blur(8px)",
            }}
