        ...
        <div className=" flex flex-col gap-4 justify-center w-[100%] ">
          ...
          <div className="flex flex-col gap-6 w-[100%]">
            ...
            <div className="">
              ...
              >
                <div
                  className={`relative  min-w-[160px] ${isViewportBelow850 ? "w-[65%] " : "w-[24%] "
                    } items-center`}
                >
