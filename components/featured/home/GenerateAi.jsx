...
function GenerateAi() {
    ...
    return (
        ...
        <div ref={generateAiRef} className=' bg-cover bg-no-repeat bg_generateAi py-[78px] my-[36px]  w-screen  '>
            <div className='ml:w-[90%]  md:w-[60%] ms:w-[70%] sm:w-[80%] w-[97%] flex ml:flex-row flex-col items-center gap-6 customMargins sm:px-4 xsm:px-2 px-1 rounded-[16px] py-6 ' style={{ boxShadow: "0px 4px 14px 0px rgba(0, 0, 0, 0.25)", background: "rgba(255, 255, 255, 0.25)" }} >
                ...
                >
                    ...
                    <div className="w-full flex justify-end items-center gap-3 ">
                        <button className={`  relative flex gap-2 sm:px-3 px-[5px] py-2 border items-center border-[#06A9EF] ${isClicked && "bg-[#06A9EF] scale-90"}  rounded-[8px] min-w-[155px] sm:min-w-[170px]`}    style={{ boxShadow: isClicked ? '0 0 8px 4px rgba(6, 169, 239, 0.5)' : 'none' }}>
                            <motion.img
