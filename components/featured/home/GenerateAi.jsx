...
function GenerateAi() {
    ...
    useEffect(() => {
        const originalText = "Lorem im ipsum dolor ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor";
        let currentIndex = 0;
        ...
        <div className=' bg-cover bg-no-repeat bg_generateAi py-[78px] my-[36px]  w-screen '>
            <div className='ml:w-[90%]  md:w-[60%] ms:w-[70%] sm:w-[80%] w-[97%] flex ml:flex-row flex-col items-center gap-6 customMargins sm:px-4 xsm:px-2 px-1 rounded-[16px] py-6 ' style={{ boxShadow: "0px 4px 14px 0px rgba(0, 0, 0, 0.25)", background: "rgba(255, 255, 255, 0.25)" }} >
                ...
                >
                    ...
                    <motion.div
                        initial={{ bottom: '0.5rem', right: 0, opacity: 0 }}
