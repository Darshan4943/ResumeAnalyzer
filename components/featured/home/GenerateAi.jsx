        ...
        <div className=" ml:w-[100%]  md:w-[60%] ms:w-[70%] sm:w-[80%] w-[97%] flex ml:flex-row flex-col items-center justify-between  gap-6 sm:px-4 xsm:px-2 px-1 rounded-[16px] py-6 ">
              ...
              <button
                ...
                style={{
                  ...
                  animation: slideRobot
                    ? "shadowAnimation 3s linear infinite"
                    : "none",
                }}
              >
                <motion.img
                ...
                {isClicked && (
                  <motion.img
                    ...
                    alt=""
                    className={`h-[30px] w-[35px]  absolute left-[5%] `}
                  />
                )}
                ...
                {isClicked && (
                  <p className="absolute top-[115%] left-[65%] text-[12px] font-medium ">
                    {" "}
                    Clicked !
                  </p>
                )}
          ...
          <div className=" ml:w-[30%] ml:h-[26vw] w-[95%]  flex flex-col gap-4 justify-center text-center items-center ml:leading-loose">
            <div className="flex flex-col sm:w-[95%] w-[97%] flex-wrap text-center items-center justify-center ml:text-[1.6vw] text-[24px] font-bold">
              ...
              <p className=" text-[#BB57E1]">
                {" "}
                Improve <span className="text-[#000000]">&</span> Enhance{" "}
              </p>
            ...
            <div className="flex flex-col justify-center items-center gap-2 w-[90%] relative">
              ...
              <img
                ...
                alt=""
                className="h-[40px]  object-contain w-[41px] absolute scr1150:top-4 -right-6 top-7 web"
              />
              ...
              <button className=" cursor-not-allowed scr1300:min-w-[162px] scr1100:min-w-[145px]  scr1024:min-w-[135px] lg:min-w-[120px]  scr930:min-w-[115px]  scr900:min-w-[110px]  ml:min-w-[100px]  flex gap-2 sm:px-3 px-[5px] py-2 border items-center border-[#06A9EF] bg-white rounded-[8px]  relative">
                <img
                  src="/images/blueArrow1.png "
                  alt=""
                  className="h-[40px]  object-contain w-[41px] absolute top-3 -right-10 mobile"
                />
                <motion.img
                  initial={{ translateY: "-4px" }}
                  animate={{ translateY: "4px" }}
