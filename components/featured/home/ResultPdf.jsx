  ...
  return (
    <>
      <div className="flex flex-col gap-[24px] h-[842px] w-[595px] ">
        <div
          className="flex flex-col p-[34px] gap-[20px] w-full border  bg-watermark  bg-cover bg-no-repeat  "
          ref={firstContainer}
        >
          <>
        ...
        {pages.second?.length > 0 && (
          <>
            <div
              className="flex flex-col p-[34px] gap-[20px] border  bg-watermark  bg-cover bg-no-repeat   "
              ref={secondContainer}
            >
        ...
        {pages?.third?.length > 0 && (
          <div className="flex flex-col p-[34px] gap-[20px] w-full border  bg-watermark  bg-cover bg-no-repeat ">
            <div
