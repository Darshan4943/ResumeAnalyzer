...
function Profile_creation() {
  ...
  const containerAnimation1 = useAnimation();
  const containerAnimation2 = useAnimation();
  const containerAnimation3 = useAnimation();
  // let shouldApplyScrollListener = true;
  ...
  return (
    <div className="profile_creation_container ">
      ...
      <motion.div className="profile_creation_sub_container_one "  id="profile_creation_sub_container_one">
        ...
        <motion.p className="profile_creation_head_one" initial={{ y: '90vh' }} animate={containerAnimation}>
          Easy process to create your profile
        </motion.p>
        <motion.p className="profile_creation_head_para" initial={{ y: '80vh' }} animate={containerAnimation}>
        ...
        <motion.p className="profile_creation_head_steps" initial={{ y: '70vh' }} animate={containerAnimation}>
          1. Upload your CV/Resume.
        </motion.p>
        <motion.p className="profile_creation_head_steps" initial={{ y: '60vh' }} animate={containerAnimation}>
          2. Let system scan it and make your profile almost ready.
        </motion.p>
      </motion.div>

      <div className="profile_creation_sub_container_two"  id="profile_creation_sub_container_two">
...
//   const handleScroll = () => {
//     if (window.scrollY >= 2400 && !isAnimate) {
//       setIsAnimate(true);
//       setIsAnimation(true)
//       window.removeEventListener('scroll', handleScroll);
//     }
...
//       <div className="profile_creation_sub_container_one" data-aos="fade-up"
//      data-aos-anchor-placement="up-center"  data-aos-duration="3000">
