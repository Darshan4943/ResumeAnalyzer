  ...
  return (
    <main className={styles.main}>
      ...
      <div ref={gallery} className={styles.gallery} >
        <Column images={[images[0], images[1], images[2], images[3],images[3],]} y={y} />
        <Column images={[images[4], images[5], images[6], images[8],images[3]]} y={y2} />
        <Column images={[images[8], images[9], images[10], images[11],images[3]]} y={y3} />
