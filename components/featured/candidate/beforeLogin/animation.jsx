      ...
      {isViewportBelow850 ? (
        <div className="flex flex-col gap-2">
          ...
          <div className="ai_text flex flex-col justify-center items-start p-2 gap-1">
            ...
            <p className="text-[#333] font-Montserrat xmd:text-[15px] md:text-[18px] xsm:text-[16px] font-medium">
              Easy process to create your resume
            </p>
            <p className="text-[#333] font-Montserrat xmd:text-[12px] md:text-[14px] xsm:text-[12px] leading-5  font-medium">
            ...
            <div className="flex flex-col items-start gap-2">
              <p className="text-[#333] font-Montserrat text-[14px] font-medium leading-[20px]">
                1. Fill your details.
              </p>
              <p className="text-[#333] font-Montserrat text-[14px] font-medium leading-[20px]">
                2. Let system organize the data to a beautiful & attractive
                templet to create your resume for free.
              </p>
              <p className="text-[#333] font-Montserrat text-[14px] font-medium leading-[20px]">
                3. Download or share your ready resume in PDF.
              </p>
            </div>
            {/* <div className="candidate_Profile_list">
              ...
              <div>
                <ol className="candidate_list">
                  ...
                  <li>
                    Let system organize the data to a beautiful & attractive
                    templet to create your resume for free.
                  </li>
            ...
            <div className="customMargins">
              <div className="ai_powered_parent">
                <div className="ai_text">
                  <div>
                    <p id="ai_text" className="ml:text-[38px]">Free Ai Powered Resume creation</p>
                  </div>
                  <div className="candidate_Profile_list">
                    <p id="easy_text">
                      Stress-Free process to create your profile
                    </p>
                    <p id="streamlines_text">
                      It streamlines job searches, improves candidate-employer
                    ...
                    <div>
                      <ol className="candidate_list">
                        <li>Fill your details.</li>
                        <li>
                          Let system organize the data to a beautiful &
                          attractive templet to create your resume for free.
                        </li>
                        <li>Download or share your ready resume in PDF.</li>
                      </ol>
                    </div>
            ...
            >
              <div className="candidate_profile">
                <motion.div animate={{ rotate: "360deg" }}>
                  <img
                    className="cand_circle_img"
                    src="/images/candidate/candidate_circle.png"
                    alt=""
                    id="name_resume"
                  />
                </motion.div>
                ...
                <div className="candidate_details">
                  ...
                  <div className="candidate_profession">
                    ...
                    molestias alias minima voluptatibus debitis dolorum porro
                    iure nesciunt expedita laboriosam maiores facilis
                    praesentium tempore assumenda dicta quia et! Dolor quas
                    impedit harum natus recusandae vel, distinctio suscipit nam
                    similique earum enim voluptatibus.
                  </div>
                </div>
              </div>
                  ...
                  <div className="candidate_section1">
                      ...
                      <div className="candidate_second_head2">
                        ...
                        <div className="candidate_address2">
                          ...
                          <div className="candidate_address_cont2">
                            <div className="candidate_headline_email">
                              <p className="candidate_headline_mail1_id">
                                e-mail
                              </p>
                            </div>
                            <p className="candidate_headline_mail2_mail">
                              Lorem ipsum{" "}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="candidate_address3">
                          ...
                          <div className="candidate_address_cont3">
                            ...
                            <p className="candidate_headline_phone2">
                              +9955545455{" "}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="candidate_address4">
                          ...
                          <div className="candidate_address_cont4">
                            ...
                            <p className="candidate_headline_web2">
                              {" "}
                              www.Loremipsum.com{" "}
                            </p>
                          </div>
                          <div className="candidate_pro_line">
                            <img
                              className="cand_circle5"
                              src="/images/candidate/cand_circle.png"
                              alt=""
                            />
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              ...
                              height="4"
                              fill="none"
                              className="candidate_blue_line2"
                            >
                              <path
                                d="M160.209 0H0.841797V4H160.209V0Z"
                                fill="#06A9EF"
                              />
                            </svg>
                          </div>
                    ...
                    <div className="col candidate_midle_section">
                      <svg
                        ...
                        height="150"
                        fill="none"
                        className="candidate_blue_line1"
                      >
                    ...
                    <div className="candidate_Education">
                      <div className="candidate_child2">
                        ...
                        <div className="candidate_education_img">
                          ...
                          >
                            <path
                              d="M6 0C2.68629 0 0 2.68629 0 6V11.1317V18.8563V19.2714C0 19.6738 0.326227 20 0.728649 20H71.2714C71.6738 20 72 19.6738 72 19.2714V18.8563V13.2533V11.1317V6C72 2.68629 69.3137 0 66 0H6Z"
                              fill="#073C53"
                            />
                          </svg>
                        ...
                        <div className="candidate_master_degree">
                          <div className="candidate_jun">
                            <p className="candidate_jun_date">
                              Jun 2017-Jul 2018
                            </p>
                        ...
                        <div className="candidate_education_line">
                          <svg
                            ...
                            height="4"
                            fill="none"
                            className="candidate_second_animation_line"
                          >
                            <path
                              d="M159.558 0H0.191406V4H159.558V0Z"
                              fill="#06A9EF"
                            />
                          </svg>
                          <img
                            className="cand_circle6"
                            src="/images/candidate/cand_circle.png"
                            alt=""
                          />
                        </div>
                      ...
                      <div className="candidate_eduction_img_cap">
                        ...
                        >
                          <path
                            d="M7.10254 26.9302H52.547V19.2312L29.8242 14.4932L7.10254 19.1132V26.9302Z"
                            fill="#333333"
                          />
                          <path
                            d="M29.3735 0.78418L0.0132235 8.48219L0 17.4942L0.00551822 17.4932V36.3462L4.62306 32.2292V16.5302L29.572 11.3252L59.1307 17.6032V8.48219L29.3735 0.78418Z"
                            fill="#333333"
                          />
                        </svg>
                      </div>
                  ...
                  <div className="candidate_section2">
                    <div className="candidate_section2_1">
                      <div className="candidate_second_head_softwere_sec">
                        ...
                        <div className="candidate_second_head_img">
                          ...
                          >
                            <path
                              d="M41.679 25.784V16.8109H34.952C34.724 16.0959 34.432 15.409 34.103 14.745L39.113 9.73395L32.769 3.38895L27.886 8.27194C27.076 7.83194 26.218 7.46896 25.326 7.18396V0.417969H16.353V7.18396C15.596 7.42496 14.871 7.73396 14.171 8.08896L9.276 3.19397L2.931 9.53897L7.759 14.366C7.346 15.143 6.998 15.96 6.727 16.81H0V25.783H6.727C7.011 26.675 7.374 27.533 7.815 28.343L3.298 32.8589L9.643 39.2039L14.288 34.559C14.952 34.888 15.638 35.18 16.354 35.408V42.095H25.327V35.407C26.178 35.136 26.995 34.789 27.771 34.375L32.404 39.008L38.749 32.663L34.049 27.963C34.403 27.263 34.713 26.5379 34.954 25.7809H41.679V25.784ZM20.839 26.763C17.826 26.763 15.375 24.312 15.375 21.299C15.375 18.285 17.826 15.8329 20.839 15.8329C23.853 15.8329 26.305 18.285 26.305 21.299C26.305 24.312 23.853 26.763 20.839 26.763Z"
                              fill="#333333"
                            />
                          </svg>
                        </div>
                        <div className="candidate_softwere_head_main">
                          <div className="candidate_soft_cont_name">
                            <div className="candidate_soft_cont_child1">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className=" candidate_langauge_img_svg"
                                width="64"
                                height="20"
                                viewBox="0 0 64 20"
                                fill="none"
                              >
                                <path
                                  d="M6 0C2.68629 0 0 2.68629 0 6V11.077V18.762V19.176C0 19.5764 0.324596 19.901 0.725006 19.901H63.275C63.6754 19.901 64 19.5764 64 19.176V18.762V13.187V11.077V6C64 2.68629 61.3137 0 58 0H6Z"
                                  fill="#073C53"
                                />
                              </svg>
                          ...
                          <div className="candidate_soft_two">
                            ...
                            <div className="candidate_softwere_container2">
                              ...
                              >
                                <path
                                  d="M41.2691 4.37601H3.01515C1.80715 4.37601 0.827148 3.39599 0.827148 2.18799C0.827148 0.979988 1.80715 0 3.01515 0H41.2691C42.4771 0 43.4572 0.978988 43.4572 2.18799C43.4572 3.39699 42.4781 4.37601 41.2691 4.37601Z"
                                  fill="#BCBCBC"
                                />
                                <path
                                  d="M41.2691 4.37601H3.01515C1.80715 4.37601 0.827148 3.39599 0.827148 2.18799C0.827148 0.979988 1.80715 0 3.01515 0H41.2691C42.4771 0 43.4572 0.978988 43.4572 2.18799C43.4572 3.39699 42.4781 4.37601 41.2691 4.37601Z"
                                ...
                                />
                                <path
                                  d="M41.3251 15.8101H2.95915C1.78115 15.8101 0.827148 14.8551 0.827148 13.6781V13.5661C0.827148 12.3891 1.78215 11.4341 2.95915 11.4341H41.3251C42.5032 11.4341 43.4572 12.3891 43.4572 13.5661V13.6781C43.4572 14.8551 42.5032 15.8101 41.3251 15.8101Z"
                                  fill="#E5E5E5"
                                />
                                <path
                                  d="M35.7512 15.8101H3.01515C1.80715 15.8101 0.827148 14.8301 0.827148 13.6221C0.827148 12.4141 1.80715 11.4341 3.01515 11.4341H35.7512C36.9592 11.4341 37.9391 12.4141 37.9391 13.6221C37.9391 14.8301 36.9592 15.8101 35.7512 15.8101Z"
                                  fill="#FFDA1D"
                                />
                                <path
                                  d="M41.2691 27.4473H3.01515C1.80715 27.4473 0.827148 26.4683 0.827148 25.2593C0.827148 24.0513 1.80715 23.0713 3.01515 23.0713H41.2691C42.4771 23.0713 43.4572 24.0503 43.4572 25.2593C43.4572 26.4673 42.4781 27.4473 41.2691 27.4473Z"
                                  fill="#E5E5E5"
                                />
                                <path
                                  d="M31.0812 27.4473H3.01515C1.80715 27.4473 0.827148 26.4673 0.827148 25.2593C0.827148 24.0513 1.80715 23.0713 3.01515 23.0713H31.0812C32.2892 23.0713 33.2691 24.0503 33.2691 25.2593C33.2691 26.4673 32.2892 27.4473 31.0812 27.4473Z"
                                  fill="#FFDA1D"
                                />
                                <path
                                  d="M41.2691 38.8804H3.01515C1.80715 38.8804 0.827148 37.9004 0.827148 36.6924C0.827148 35.4844 1.80715 34.5044 3.01515 34.5044H41.2691C42.4771 34.5044 43.4572 35.4844 43.4572 36.6924C43.4572 37.9004 42.4781 38.8804 41.2691 38.8804Z"
                                  fill="#E5E5E5"
                                />
                              </svg>
                            </div>
                      ...
                      <div className="candidate_second_head_langauge">
                        ...
                        <div className="candidate_softwere_head">
                          ...
                          <div className="candidate_soft_two">
                            ...
                            <div className="candidate_softwere_container2">
                              <ImageContainer
                                className="lang_line"
                                src="/images/candidate/lang_line.png"
                                alt=""
                              />
                            </div>
                          </div>
                        ...
                        <div className="candidate_lang_line_three">
                          ...
                          <svg
                            ...
                            height="4"
                            fill="none"
                            className="candidate_blue_line5"
                          >
                            <path
                              d="M159.94 0H0.573242V4H159.94V0Z"
                              fill="#06A9EF"
                            />
                          </svg>
                          <ImageContainer
                            className="cand_circle2"
                            src="/images/candidate/cand_circle.png"
                            alt=""
                          />
                        </div>
                    ...
                    <div className=" candidate_midle_section">
                      <svg
                        ...
                        height="140"
                        fill="none"
                        className="candidate_blue_line4"
                      >
                        <path d="M4 0H0V336H4V0Z" fill="#06A9EF" />
                      </svg>
                      ...
                      <div className="candidate_proffesion_cont">
                        <div className="candidate_software_container_parent ">
                          <div className="candidate_soft_heading">
                            ...
                            <h5 className="candidate_soft_info_cont">
                          ...
                          <div className="row row-cols-3 candidate_soft_box p-0  d-flex">
                            <div
                              className=" col candidate_yellow_line "
                              style={{ maxWidth: "5px" }}
                            >
                              <ImageContainer
                                className="candidate_yellow_line"
                                src="/images/candidate/yellow_line.png"
                                alt=""
                              />
                            </div>
                            ...
                            >
                              <div className="candidate_job_title_parent">
                                <div className="candidate_job_title_head">
                                  <p className="candidate_child_title1">
                                    job titles
                                  </p>
                                </div>
                                <div className="candidate_job_title_head2">
                                  <p className="candidate_child_title2">
                                    company name
                                  </p>
                                </div>
                                <div className="candidate_job_title_head3 m-0">
                                  <p className="candidate_child_title3 m-0">
                                    Lorem ipsum dolor sit amet, consectetuer{" "}
                                  </p>
                                  <p className="candidate_child_title3 m-0">
                                    adipiscing elit, sed diam nonummy nibh.
                      ...
                      <div className="candidate_hobbie_main">
                        <div className="candidate_hobbie">
                          ...
                          <div className="candidate_hoobi_head">
                            ...
                            >
                              <path
                                d="M6 0C2.68629 0 0 2.68629 0 6V11.077V18.762V19.176C0 19.5764 0.324596 19.901 0.725006 19.901H57.275C57.6754 19.901 58 19.5764 58 19.176V18.762V13.187V11.077V6C58 2.68629 55.3137 0 52 0H6Z"
                                fill="#073C53"
                              />
                            </svg>
                          ...
                          <div className="candidate_last_line_three">
                            ...
                            <motion.div
                              className="candidate_last_line_box"
