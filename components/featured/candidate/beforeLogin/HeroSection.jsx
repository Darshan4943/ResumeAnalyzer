...
function CandidateHero() {
  ...
  return (
    <>
      <div className="w-full min-h-[100px] md:h-[300px] xxlg:h-[490px]  xlg:h-[300px] ml:h-[420px] ms:py-0 xxsm:py-4 bg-cover bg-no-repeat  bg-vector ">
        <div className="customMargins relative">
          <div className="flex flex-row justify-between gap-4">
            <div className="mr-0 ms:pt-10 ">
              ...
              <div className="flex flex-col gap-2  xlg:w-[455px] xlg:leading-[22px] ">
            ...
            <img
              className="h-[180px] w-[185px] xxlg:h-[460px] ml:top-[30px] xxlg:w-[480px]  xlg:w-[320px] xlg:h-[300px] ml:h-[390px] ml:w-[390px]  absolute right-0 "
