...
function CandidateHero() {
  ...
  return (
    <div className="min-h-[560px] bg-cover bg-no-repeat pt-[81px] overflow-hidden bg-vector w-screen">
      <div className="customMargins">
        <div className="flex flex-row justify-between gap-4 max-w-1128">
          <div className="mr-0 p-0">
            <div className=" leading-[105px]">
              <p className="font-Montserrat text-[86px] text-black font-bold ">
                <span className=" text-[#06A9EF]">Create</span> your <br />
                future with us
              </p>
            </div>
            <div className="flex flex-col gap-4 mt-5 max-w-[485px] leading-[44px]">
              <div className="">
                <p className="font-Montserrat text-[36px] text-black font-bold">
                  Find your next{" "}
            ...
            <div className="candidate_searchbox">
              <div
                class="mt-8 flex justify-between z-10 gap-5 px-6 py-4 items-center rounded-[16px] bg-white shadow-xl min-h-[93.33px] relative mb-11 max-scr1100:gap-2 max-scr1024:gap-1 max-scr1024:max-w-[600px] 
          ...
          <img
            className="h-[559px] absolute right-[14px] -mt-[61px] xl:relative xl:right-32"
