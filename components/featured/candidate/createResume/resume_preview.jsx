...
const ResumePreview = ({
  ...
  const callData = () => {
    ...
    if (id) {
      axios
        .get(`https://api.skilotech.com/api/resume/${id}`)
  ...
  const saveResume = async (blob, download) => {
    ...
    const uploadProfilePhotoAndSave = async () => {
      ...
      if (
        ...
        try {
          const res = await axios.post(
            "https://api.skilotech.com/api/upload/profile-photo",
            photoForm
          );
      ...
      if (isEdit) {
        ...
        axios
          .put(`https://api.skilotech.com/api/resume/${id}`, formData)
          .then((res) => {
        ...
        axios
          .post("https://api.skilotech.com/api/resume/add", formData)
          .then((res) => {
            const pdfUrl = res.data.data.resumeUrl;
  ...
  const updateDownloadCount = async () => {
    ...
    axios
      .put(
        "https://api.skilotech.com/api/subscription/updateDownloadLimit/" +
          userDataGlobal?._id
      )
      .then((res) => {
