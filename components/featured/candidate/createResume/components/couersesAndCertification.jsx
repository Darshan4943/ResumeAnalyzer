  ...
  return (
    ...
    >
      <div className="w-full flex justify-between text-[20px] font-montserrat font-medium">
        ...
        }} className="w-[32px] h-[32px] rounded-[50%] border border-[#DEDEDE] bg-[#F7F7F7] flex justify-center items-center cursor-pointer">
...
export default CouersesAndCertification;
