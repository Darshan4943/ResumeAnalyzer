                ...
                <>
                  {resumeList
                    ...
                    ?.map((data, index) => (
                      <div
                        key={index}
                        className="flex flex-col gap-[8px]  scr1100:w-[48%] w-[100%] max-w-[368px] rounded-[16px] border border-[#DEDEDE] bg-white shadow-lg py-[16px] ml:px-[24px] px-3 min-w-[262px]"
                      >
