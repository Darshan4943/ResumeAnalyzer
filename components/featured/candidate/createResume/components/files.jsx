...
function Files({ tabIndex, setTabIndex, data, setData, setFolderData, files, setFiles, clientData, setClientData, tab,select,setSelect }) {
                        ...
                        <div className='rounded-[16px] p-4 flex flex-row gap-12 flex-wrap  w-full h-full'>
                            {clientData?.length > 0 ?
                                ...
                                clientData?.map((item, index) => (
                                    <>
                                        <div onClick={() => openClientFolder(index)} key={index} className='  flex flex-col gap-2 items-center cursor-pointer h-fit'>
