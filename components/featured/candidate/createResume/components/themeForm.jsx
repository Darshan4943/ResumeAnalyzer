        ...
        <div>
          <div className="mt-2 flex flex-wrap gap-3">
            {fontFamily.map((font, idx) => (
              <div
                className={`flex h-[40px] w-[115px] cursor-pointer items-center justify-center rounded-md text-sm border transition-transform duration-300 ease-in-out hover:scale-105 ${
