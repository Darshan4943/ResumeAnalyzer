                ...
                <div className="flex flex-col scr460:flex-row gap-[4px] scr460:items-center">
                  ...
                  <div className="flex w-full items-center gap-4">
                    ...
                    <div className="scr420:min-w-[85px] min-w-[70px] flex items-center">
                      {isActive ? (
                        <>
                          {limits.used.coverStored >limits.total.coverStoredLimit?limits.total.coverStoredLimit:limits.used.coverStored}/
                ...
                <div className="flex flex-col scr460:flex-row gap-[4px] scr460:items-center">
                  ...
                  <div className="flex w-full items-center gap-4">
                    ...
                    <div className="scr420:min-w-[85px] min-w-[70px] flex items-center">
                      {isActive ? (
                        <>
                          {limits.used.resumeStored>limits.total.resumeStoredLimit?limits.total.resumeStoredLimit:limits.used.resumeStored}/
                  ...
                  <div className="flex flex-col scr460:flex-row gap-[4px] scr460:items-center">
                    ...
                    <div className="flex w-full items-center gap-4">
                      ...
                      <div className="scr420:min-w-[85px] min-w-[70px] flex items-center">
                        {isActive ? (
                          <>
                            {limits.used.skillTest>limits.total.skillTestLimit?limits.total.skillTestLimit:limits.used.skillTest}/
                  ...
                  <div className="flex flex-col scr460:flex-row gap-[4px] scr460:items-center">
                    ...
                    <div className="flex w-full items-center gap-4">
                      ...
                      <div className="scr420:min-w-[85px] min-w-[70px] flex items-center">
                        {isActive ? (
                          <>
                            {limits.used.skillCertified>limits.total.skillCertifiedLimit?limits.total.skillCertifiedLimit:limits.used.skillCertified}/
                ...
                <div className="flex flex-col scr460:flex-row gap-[4px] scr460:items-center">
                  ...
                  <div className="flex w-full items-center gap-4">
                    ...
                    <div className="scr420:min-w-[85px] min-w-[70px] flex items-center">
                      {isActive ? (
                        <>
                          {limits.used.chatBot.monthly>limits.total.chatBotLimit.monthly?limits.total.chatBotLimit.monthly:limits.used.chatBot.monthly}/
                  ...
                  <div className="flex flex-col scr460:flex-row gap-[4px] scr460:items-center">
                    ...
                    <div className="flex w-full items-center gap-4 ">
                      ...
                      <div className="scr420:min-w-[85px] min-w-[70px] flex items-center">
                        {isActive ? (
                          <>
                            {limits.used.jdMatching.monthly>limits.total.jdMatchingLimit.monthly?limits.total.jdMatchingLimit.monthly:limits.used.jdMatching.monthly}/
                    ...
                    <div className="flex w-full items-center gap-4">
                      <div className="relative  w-full  h-[10px] bg-[#DEDEDE] rounded-[6px] overflow-hidden">
                        <div
                          style={{
                            width: `${isActive ? Math.round(
                              ((limits.used.collectionStored.monthly * 100) /
                                limits.total.collectionStoredLimit.monthly)
                            ) : 0}% `,
                            maxWidth: `${Math.round(
                              ((limits.total.collectionStoredLimit.monthly * 100) /
                                limits.total.collectionStoredLimit.monthly)
                            )}%`
                          }}
                          className={`absolute  h-[10px] bg-[#06A9EF] rounded-[6px]`}
                      ...
                      <div className="scr420:min-w-[85px] min-w-[70px] flex items-center">
                        {isActive ? (
                          <>
                            {limits.used.collectionStored.monthly>limits.total.collectionStoredLimit.monthly?limits.total.collectionStoredLimit.monthly:limits.used.collectionStored.monthly}/
