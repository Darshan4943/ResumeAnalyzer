...
const PersonalDetails = ({
  ...
  return (
    <>
      <div
        className="flex flex-col sm:py-4 py-2 gap-4 rounded-lg bg-white"
        style={{
          opacity: isChecked ? 1 : 0.5,
        }}
      >
        <div className="w-full flex justify-between text-[18px] font-montserrat font-semibold leading-tight">
          ...
          {inputFields.map((item, index) => (
            ...
            >
              ...
              {item.name === "mobileNumber" ? (
                  ...
                  <div className={`flex w-[100%] items-start`} id="single_input">
                        ...
                        <div className="flex items-center justify-center gap-2 cursor-pointer min-w-[160px] w-[100%]">
                          <div className="flex items-center gap-1 cursor-pointer w-[100%]">
                            <ReactSelect
                              ...
                              className="w-[100%] flex items-center rounded-[8px] outline-none border-none cursor-pointer"
                              name=""
                              placeholder="Select"
                              value={selectedItem}
                    ...
                    <input
                      ...
                      placeholder={item.placeholder}
                        className="w-full text-[14px] leading-[14.67px] text"
                ...
                <div
                  className={`border-[1px] rounded-[8px] px-[16px] py-3 leading-[12px] ${
                    formErrors[item.name]
                      ? "border-[#C00000]"
                      : "border-[#9D9D9D]"
                  } `}
