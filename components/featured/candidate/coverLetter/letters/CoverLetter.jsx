  ...
  return (
    <>
      <div className="w-[800px] h-[842px] p-[32px] gap-[16px] flex flex-col absolute left-[4000px]">
        ...
        <div
          className="w-full h-[1px] bg-[#414042]"
          ref={secondContainer}
        ></div>
        <div
          className="flex flex-row justify-between w-full"
      ...
      <div className="flex flex-col gap-[24px]">
        <div
          ref={page1Ref}
          className="   w-[800px] h-[842px] p-[32px] gap-[16px] flex flex-col border-2   "
        >
        ...
        {Object?.values(splitContents?.second)?.length > 0 && (
          <div
            ref={page2Ref}
            className=" h-[842px] p-[24px] w-[800px] flex border-2 flex-col bg-[#fff] overflow-hidden "
          >
