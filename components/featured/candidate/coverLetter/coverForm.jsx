    ...
    return (
        <div className="flex flex-col pr-[10px] ml:w-[100%] w-[100%]  pb-4 gap-4 rounded-lg ">
            ...
            <div className='bg-[#F9F9F9] w-full flex rounded-[8px] text-[14px] font-semibold' >
                <button className='bg-[#06A9EF] py-[8px] px-[16px] flex justify-center items-center rounded-[8px]  w-[50%] text-white'>
                    Standard Format
                </button>
                <button className=' py-[8px] px-[16px] flex justify-center items-center rounded-[8px] w-[50%] '>
                    Custom Format
                </button>
            ...
            <div className="flex flex-col gap-2">
                <label htmlFor="letter-date" className="text-[14px] font-medium">Letter Date</label>
                <div className="relative flex gap-2 justify-between">
                    <DatePicker
                        ...
                        className="w-full  py-2 px-4 border  border-[#646464] rounded-[8px] shadow-sm focus:outline-none focus:ring focus:border-blue-300"
                    />
                    ...
                    <span className="absolute inset-y-0 left-[180px] flex items-center pointer-events-none gap-3  py-2">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 4h10M5 11h14m-7 4h.01m-6 0h.01M6 17h12a2 2 0 002-2V7a2 2 0 00-2-2H6a2 2 0 00-2 2v8a2 2 0 002 2z" />
                        </svg>
                    </span>
                </div>
            </div>
