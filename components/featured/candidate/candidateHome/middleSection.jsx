...
function MiddleSection() {
    ...
    return (
        <div className='flex flex-col gap-5 max-w-[548px]'>
            <div className='flex gap-4'>
                <button onClick={() => router.push("/jobs/candidate/AppliedJobs")} className='flex gap-2 rounded-[6px] px-4 py-2 border border-[#C7C7C780] bg-[#FFFFFF] text-[14px] font-semibold items-center leading-tight'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20.3333 6.16801H16.1667V5.33465C16.1667 4.41547 15.4192 3.66797 14.5 3.66797H9.5C8.58082 3.66797 7.83332 4.41543 7.83332 5.33465V6.16797H3.66668C2.74746 6.16801 2 6.91547 2 7.83465V10.3346C2 11.2539 2.74746 12.0013 3.66668 12.0013H10.3334V11.5846C10.3334 11.3543 10.5197 11.168 10.75 11.168H13.25C13.4804 11.168 13.6667 11.3543 13.6667 11.5846V12.0013H20.3334C21.2525 12.0013 22 11.2539 22 10.3346V7.83465C22 6.91547 21.2525 6.16801 20.3333 6.16801ZM14.5 6.16801H9.5V5.33465H14.5V6.16801Z" fill="#06A9EF" />
                        <path d="M21.7689 12.4503C21.6269 12.3799 21.4572 12.3962 21.3318 12.4913C21.0356 12.7156 20.6905 12.834 20.3333 12.834H13.6667V14.084C13.6667 14.3143 13.4803 14.5006 13.25 14.5006H10.75C10.5197 14.5006 10.3333 14.3143 10.3333 14.084V12.834H3.66668C3.30941 12.834 2.96438 12.7156 2.66813 12.4913C2.54238 12.3953 2.37312 12.379 2.23109 12.4503C2.08953 12.5207 2 12.6651 2 12.8234V18.6673C2 19.5865 2.74746 20.334 3.66668 20.334H20.3334C21.2525 20.334 22 19.5865 22 18.6673V12.8234C22 12.6651 21.9105 12.5207 21.7689 12.4503Z" fill="#06A9EF" />
                    </svg>
                    Applied Jobs ({appliedJobData?.length})

                </button>
                <button onClick={() => router.push("/jobs/candidate/SavedJobs")} className='flex gap-2 rounded-[6px] px-4 py-2 border border-[#C7C7C780] bg-[#FFFFFF] text-[14px] font-semibold items-center'>
