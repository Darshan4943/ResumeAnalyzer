      ...
      <View style={{ display: "flex", flexDirection: "row", breakAll: true }}>
              ...
              >
                <View style={{}}>
                  <Svg width={14} height={18} viewBox="0 0 13 17" fill="none">
                    <Path
                      d="M6.90887 0.289062C3.60787 0.289062 0.921875 2.97441 0.921875 6.27684C0.921875 10.3744 6.27887 16.3892 6.50787 16.6432C6.72187 16.8822 7.09588 16.8812 7.30988 16.6432C7.53788 16.3892 12.8949 10.3744 12.8949 6.27684C12.8959 2.97541 10.2099 0.289062 6.90887 0.289062ZM6.90887 9.28923C5.24787 9.28923 3.89688 7.93806 3.89688 6.27684C3.89688 4.61563 5.24787 3.26446 6.90887 3.26446C8.56987 3.26446 9.92087 4.61563 9.92087 6.27684C9.92087 7.93806 8.56987 9.28923 6.90887 9.28923Z"
                      fill={selectedColor}
                    />
                  </Svg>
                </View>
                        ...
                        >
                          ...
                          <View style={{ position: "relative" }}>
                            ...
                            >
                              ...
                              >
                                <Path
                                  d="M6.66418 12.4647C9.86578 12.4647 12.4612 9.86891 12.4612 6.66689C12.4612 3.46488 9.86578 0.869141 6.66418 0.869141C3.46259 0.869141 0.867188 3.46488 0.867188 6.66689C0.867188 9.86891 3.46259 12.4647 6.66418 12.4647Z"
                                  fill="white"
                                />
                              </Svg>
                            </View>
        ...
        <View style={{ position: "absolute", left: 24, top: 24 }}>
          ...
          <View style={{ top: "35%", left: "55%", elevation: 5 }}>
            ...
            >
              <Text style={{ fontSize: 22, fontFamily: `${selectedFont} 600` }}>
