...
function Template2({ data }) {
    return (
        <Page size="A4"  >
            <View style={{ display: 'flex', flexDirection: 'row', breakAll: true, minHeight: '841.7px' }}>
                <View style={{ paddingTop: '260px', width: '369px', paddingLeft: '16px', flexDirection: "column", justifyContent: "space-between" }}>
                    ...
                    <View style={{ position: "absolute", left: 0, right: 0, bottom: 0, width: '369px', marginTop: '8px', height: '42px', backgroundColor: '#F7902B' }}></View>
                </View>
