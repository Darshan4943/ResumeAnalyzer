...
function Template40({ data,selectedColor,selectedFont  }) {
        ...
        <Page size="A4" style={{ padding: 36 }}>
            <View style={{ height: "122px", width: "120%", backgroundColor:selectedColor , margin: -36, flexDirection: "row", gap: 24, paddingLeft: 42 }}>
                ...
                <View style={{ flexDirection: "column", marginTop: 24, gap: 4, marginTop: "56px" }}>
                    <Text style={{ color: "#FFFFFF", fontFamily: `${selectedFont} 400`, fontSize: "28px", }}>{data.firstName} {data.lastName}</Text>
                    <Text style={{ fontSize: "14px",fontFamily: `${selectedFont} 400`, color: "#FFFFFF" }}>{data.designation}</Text>
            ...
            <View style={{ flexDirection: "column", gap: 24, marginTop: 36 }}>
                <View style={{ display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-start", marginLeft: 172, marginTop: 24 }}>
                    ...
                    <Text style={{ color: "#47484C", fontFamily: `${selectedFont} 400`, fontSize: "16px" }}>About me</Text>

                    <Text style={{ color: "#47484C", fontSize: "14px",fontFamily: `${selectedFont} 400`, }}>{data.summery}</Text>
                ...
                <View style={{ flexDirection: "column", gap: 12, }}>
                    ...
                    <View style={{ flexDirection: "row", gap: 24, width: "100%", alignItems: "center" }}>
                        <View style={{ flexDirection: "row", gap: 12, width: "25%", alignItems: "center" }}>
                            ...
                            <Text style={{ color: "#47484C", fontSize: "14px",fontFamily: `${selectedFont} 400`,}}>{data.mobileNumber}</Text>
                        ...
                        <View style={{ flexDirection: "row", gap: 12, width: "35%", alignItems: "center" }}>
                            ...
                            <Text style={{ color: "#47484C", fontSize: "14px",  fontFamily: `${selectedFont} 400`,}}>{data.email}</Text>
                        ...
                        <View style={{ flexDirection: "row", gap: 12, width: "30%", alignItems: "center" }}>
                            ...
                            <Text style={{ color: "#47484C", fontSize: "14px",fontFamily: `${selectedFont} 400`,}}>{data.location}</Text>
                ...
                <View style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>
                    ...
                    <Text style={{ color: "#47484C", fontFamily: `${selectedFont} 400`, fontSize: "16px", marginLeft: 172, }}>EXPERIENCE</Text>
                        ...
                        {data?.experience?.map((detail, index) => (
                            ...
                            <View key={index} style={{ flexDirection: "row", gap: 16, alignItems: "start", justifyContent: "start", width: "100%" }}>
                                <View style={{ flexDirection: "column", gap: 4, justifyContent: "space-between", width: "26.5%" }}>
                                    ...
                                    <Text style={{ color: "#47484C", fontSize: "12px", fontFamily: `${selectedFont} 400`, }}>{detail.organization}</Text>

                                    <Text style={{ color: "#47484C", fontSize: "12px",fontFamily: `${selectedFont} 400`,}}>{detail.duration?.start?.year}-{" "}{detail.currentlyWorking ? "Present" : detail.duration?.end?.year}</Text>
                                ...
                                <View style={{ flexDirection: "column", gap: 4, width: "73.5%" }}>
                                    <Text style={{ color: "#47484C", fontSize: "12px", fontFamily: `${selectedFont} 400`,}}>{detail.designation} </Text>

                                    <Text style={{ color: "#47484C", fontSize: "12px",fontFamily: `${selectedFont} 400`,}}>{detail.description}</Text>
                ...
                <View style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>
                    ...
                    <Text style={{ color: "#47484C", fontFamily: `${selectedFont} 400`,fontSize: "16px", marginLeft: 172, }}>EDUCATION</Text>
                        ...
                        {data?.education?.map((detail, index) => (
                            ...
                            <View key={index} style={{ flexDirection: "row", gap: 16, alignItems: "start", justifyContent: "start", width: "100%" }}>
                                <View style={{ flexDirection: "column", gap: 4, justifyContent: "space-between", width: "26.5%" }}>
                                    ...
                                    <Text style={{ color: "#47484C", fontSize: "12px", fontFamily: `${selectedFont} 400`, }}>{detail.instituteName}</Text>

                                    <Text style={{ color: "#47484C", fontSize: "12px", fontFamily: `${selectedFont} 400`, }}>{detail.duration?.start?.year}-{detail.duration?.end?.year}</Text>
                                ...
                                <View style={{ flexDirection: "column", gap: 4, width: "73.5%" }}>
                                    <Text style={{ color: "#47484C", fontSize: "12px", fontFamily: `${selectedFont} 400`,}}>{detail.qualification} </Text>
                                    <Text style={{ color: "#47484C", fontSize: "12px", fontFamily: `${selectedFont} 400`,}}>{detail.specialization} </Text>
                        ...
                        {data?.hobbies?.length > 0 && (
                            <View style={{ flexDirection: "column", gap: "16px", }}>
                                ...
                                <View style={{}}>
                                    ...
                                    <Text style={{ color: "#47484C",fontFamily: `${selectedFont} 400`, }}>HOBBIES</Text>
                    ...
                    {data?.skills?.length > 0 && (
                        ...
                        <View style={{ display: "flex", flexDirection: "column", gap: 16, alignItems: "flex-start", width: "76.5%" }}>
                            <View style={{}}>
                                ...
                                <Text style={{ color: "#47484C" ,fontFamily: `${selectedFont} 400`,}}>SKILLS</Text>
                            ...
                            <View style={{ flexDirection: "row", gap: 8, justifyContent: "space-between", flexWrap: "wrap", width: "100%" }}>
                                {data?.skills?.map((detail, index) => (
                                    <View key={index} style={{ display: "flex", flexDirection: "row", alignItems: "center", flexWrap: "wrap", gap: "12", width: "45%" }}>
                                        <Text style={{ fontSize: 12, color: "#47484C", width: "45%",fontFamily: `${selectedFont} 400`, }}>
                                            {detail.skill}
                                        </Text>
