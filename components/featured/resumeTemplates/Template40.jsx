        ...
        <Page size="A4" style={{ padding: 36 }}>
            ...
            <View style={{ flexDirection: "column", gap: 24, marginTop: 36 }}>
                <View style={{ display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-start", marginLeft: 172, marginTop: 24 }}>
                    ...
                    <Text style={{ color: "#47484C", fontWeight: 500, fontSize: "16px" }}>About me</Text>

                    <Text style={{ color: "#47484C", fontSize: "14px", fontWeight: 400 }}>{data.summery}</Text>
                ...
                <View style={{ flexDirection: "column", gap: 12, }}>
                    ...
                    <View style={{ flexDirection: "row", gap: 24, width: "100%", alignItems: "center" }}>
                        <View style={{ flexDirection: "row", gap: 12, width: "25%", alignItems: "center" }}>
                            ...
                            <Text style={{ color: "#47484C", fontSize: "14px", fontWeight: 400 }}>{data.mobileNumber}</Text>
                        ...
                        <View style={{ flexDirection: "row", gap: 12, width: "35%", alignItems: "center" }}>
                            ...
                            <Text style={{ color: "#47484C", fontSize: "14px", fontWeight: 400 }}>{data.email}</Text>
                        ...
                        <View style={{ flexDirection: "row", gap: 12, width: "30%", alignItems: "center" }}>
                            ...
                            <Text style={{ color: "#47484C", fontSize: "14px", fontWeight: 400 }}>{data.location}</Text>
                ...
                <View style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>
                    ...
                    <Text style={{ color: "#47484C", fontWeight: 500, fontSize: "16px", marginLeft: 172, }}>EXPERIENCE</Text>
                        ...
                        {data?.experience?.map((detail, index) => (
                            ...
                            <View key={index} style={{ flexDirection: "row", gap: 16, alignItems: "start", justifyContent: "start", width: "100%" }}>
                                <View style={{ flexDirection: "column", gap: 4, justifyContent: "space-between", width: "26.5%" }}>
                                    ...
                                    <Text style={{ color: "#47484C", fontSize: "12px", fontWeight: 400, }}>{detail.organization}</Text>

                                    <Text style={{ color: "#47484C", fontSize: "12px", fontWeight: 400, }}>{detail.duration?.start?.year}-{" "}{detail.currentlyWorking ? "Present" : detail.duration?.end?.year}</Text>
                                ...
                                <View style={{ flexDirection: "column", gap: 4, width: "73.5%" }}>
                                    <Text style={{ color: "#47484C", fontSize: "12px", fontWeight: 400 }}>{detail.designation} </Text>

                                    <Text style={{ color: "#47484C", fontSize: "12px", fontWeight: 400, }}>{detail.description}</Text>
                ...
                <View style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>
                    ...
                    <Text style={{ color: "#47484C", fontWeight: 500, fontSize: "16px", marginLeft: 172, }}>EDUCATION</Text>
                        ...
                        {data?.education?.map((detail, index) => (
                            ...
                            <View key={index} style={{ flexDirection: "row", gap: 16, alignItems: "start", justifyContent: "start", width: "100%" }}>
                                <View style={{ flexDirection: "column", gap: 4, justifyContent: "space-between", width: "26.5%" }}>
                                    ...
                                    <Text style={{ color: "#47484C", fontSize: "12px", fontWeight: 400, }}>{detail.instituteName}</Text>

                                    <Text style={{ color: "#47484C", fontSize: "12px", fontWeight: 400, }}>{detail.duration?.start?.year}-{detail.duration?.end?.year}</Text>
                                ...
                                <View style={{ flexDirection: "column", gap: 4, width: "73.5%" }}>
                                    <Text style={{ color: "#47484C", fontSize: "12px", fontWeight: 400 }}>{detail.qualification} </Text>
                                    <Text style={{ color: "#47484C", fontSize: "12px", fontWeight: 400 }}>{detail.specialization} </Text>
                        ...
                        {data?.hobbies?.length > 0 && (
                            <View style={{ flexDirection: "column", gap: "16px", }}>
                                ...
                                <View style={{}}>
                                    ...
                                    <Text style={{ color: "#47484C" }}>HOBBIES</Text>
