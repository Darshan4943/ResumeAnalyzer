...
function Resume2() {
  return (
    <>
      <div className="flex gap-3 w-[595px] border border-[#06A9EF] rounded-[9px] break-all">
        <div className=" pt-[16px] w-[369px] pl-[16px]">
          <div className="flex items-start flex-col gap-[16px]">
            <div className="relative ml-[10px]">
              ...
              >
                <path
                  d="M134.664 215.492C193.07 201.965 229.454 143.645 215.928 85.2309C202.403 26.8168 144.09 -9.57122 85.684 3.95601C27.2775 17.4832 -9.10576 75.8032 4.41969 134.217C17.9452 192.631 76.2575 229.019 134.664 215.492Z"
                  fill="white"
                  stroke="#2C2A31"
                  stroke-width="2" 
                ...
                />
                <image
                  href="./images/services/Ellipse_24.png"
                  x="10"
                  y="10"
                  width="200"
                  height="200"
            ...
            <div className="flex flex-col w-[100%]">
              <div className="flex flex-col w-[100%]">
                ...
                <p className=" text-[#272128] font-[500] font-barlow pt-[6px] text-[12px] max-w-[80%]">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
                  pharetra dignissim leo quis congue. Ut sit amet sollicitudin
                  felis. Donec vitae ligula ac nisi pharetra venenatis. Vivamus
                  nec mattis elit, ut fermentum arcu. Pellentesque ornare nulla
                  et placerat vulputate. Class aptent taciti sociosqu ad litora
              ...
              <div className="flex flex-col w-[100%]">
                ...
                <p className=" text-[#272128] font-[500] font-barlow pt-[6px] text-[12px] max-w-[80%]">
                  Lorem ipsum
                  dzxvvvvvvvvvvvvvvvvvvvvvvvvvsdrdggggggggggggggzgzrgzzzzzzzzzzzz{" "}
                </p>
              ...
              <div className="w-[390px] rounded-bl-[9px] ml-[-16px]  h-[42px] bg-[#F7902B]"></div>
            </div>
          </div>
        </div>
        <div className=" bg-[#2C2A31] w-[226px] pl-[16px] pr-1 rounded-tr-[9px] rounded-br-[9px]">
          <div className="flex flex-col items-start mt-[173px] ">
            <p className="text-[18px] text-[#fff] font-[600]  font-barlow-condensed leading-normal">
              Portfolio{" "}
            </p>
            <div className="flex pt-[10px] gap-4 items-center">
              <img
            ...
            <div className="h-[1px] bg-[#fff] my-[33px] w-[100%]"></div>
            ...
            <div className="flex pt-[10px] gap-4 items-center">
              <img
                ...
                src="./images/services/location_yellow.png"
                alt=""
              />
              <div className="flex flex-col">
                <p className="text-[#fff] text-[10px] font-[600] leading-normal">
                ...
                <p className="text-[#fff] text-[10px] font-[300] leading-normal">
                  123, Street Oclahogcfffffffffffffffftrxtrrrgrg
                </p>
                <p className="text-[#fff] text-[10px] font-[300] leading-normal">
                  New York City, USA
                </p>
            ...
            <div className="flex pt-[10px] gap-4 items-center">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[#fff] text-[10px] font-[300] leading-normal">
                  yourname@domain.comrsvqwdvhqwgvhwqgvhvhdvhwwh
                </p>
              </div>
            </div>
            ...
            <div className="h-[1px] bg-[#fff] mt-[33px] mb-[10px] w-[100%]"></div>
            ...
            {[1, 2, 3, 4].map(() => (
              <div className="flex mt-[25px] ">
                ...
                <div className="flex flex-col ">
                  <p className="text-[11px] font-[300] text-[#fff] leading-tight ml-[5px] mt-[-3px]">
                    Lorem Ipsum
                  </p>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
