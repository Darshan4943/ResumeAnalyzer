              ...
              {data?.mobileNumber && (
                <View style={{ display: 'flex', flexDirection: 'row', gap: 5, alignItems: 'center' }}>
                  <Svg width="20" height="21" viewBox="0 0 20 21" fill="#FFF" xmlns="http://www.w3.org/2000/svg">
                    <Path fill-rule="evenodd" clip-rule="evenodd" d="M9.99931 19.3228C5.12562 19.3228 1.17578 15.373 1.17578 10.4993C1.17578 5.62562 5.12562 1.67578 9.99931 1.67578C14.873 1.67578 18.8228 5.62562 18.8228 10.4993C18.8243 15.373 14.873 19.3228 9.99931 19.3228Z" stroke="#5E5F5E" strokeWidth="0.5" stroke-miterlimit="10" />
