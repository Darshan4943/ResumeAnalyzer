                ...
                <View style={{ flexDirection: "row", gap: 4, width: "100%", alignItems: "center" }}>
                  ...
                  <View style={{ flexDirection: "column", gap: 3, width: "100%", paddingTop: 14 }}>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%" }}>
                      ...
                      <Text style={{ fontSize: 14, fontFamily: `${selectedFont} 400`, color: '#F2BE5C' }}>{detail.duration?.start?.year}-{" "}
                        {detail.currentlyWorking
                          ? "Present"
                          : detail.duration?.end?.year}</Text>
                    </View>
                    <View>
                      <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: '#F2BE5C' }}>{detail.location}</Text>
                    </View>
                  </View>
                </View>
                <View>
                  <Text style={{ fontSize: 10, fontFamily: `${selectedFont} 400`, color: '#F2BE5C' }}>{detail.description}</Text>
                </View>
                ...
                <View style={{ flexDirection: "row", gap: 4, width: "100%", alignItems: "center" }}>
                  ...
                  <View style={{ flexDirection: "column", gap: 3, width: "100%", paddingTop: 14 }}>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%" }}>
                      ...
                      <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: '#F2BE5C' }}> {detail.duration?.end?.year && (
                        <>
                    ...
                    <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: '#F2BE5C' }}>   {detail.instituteName}</Text>
                    <View>
              ...
              <View style={{ flexDirection: "column", gap: 8, width: "100%" }}>
                <View style={{ flexDirection: "row", gap: 4, width: "100%", alignItems: "center" }}>
                  ...
                  <View style={{ flexDirection: "column", gap: 3, width: "100%", paddingTop: 14 }}>
                    ...
                    <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: '#F2BE5C' }}> {detail.duration?.end?.month}-
                      {detail.duration?.end?.year}</Text>
                  </View>
                  <View>
                    <Text style={{ fontSize: 10, fontFamily: `${selectedFont} 400`, color: '#F2BE5C' }}>{detail.issuedBy}</Text>
                    <View>
