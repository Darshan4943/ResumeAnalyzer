...
function Template10({ data, selectedColor, selectedFont }) {
        ...
        <View style={{ width: "373px", gap: 24 }}>
          ...
          <View style={{ flexDirection: "column", gap: 8 }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
              <View style={{ flexDirection: "column", gap: 8 }}>
                <View>
                  <Text style={{ fontSize: 36, fontFamily: `${selectedFont} 400`, color: '#414042' }}>{data.firstName}</Text>
                  <Text style={{ fontSize: 36, fontFamily: `${selectedFont} 400`, color: '#414042' }}>{data.lastName}</Text>
                </View>
                <Text style={{ fontSize: 16, fontFamily: `${selectedFont} 400`, color: '#414042' }}>{data.designation} </Text>
              </View>
            ...
            <View style={{ flexDirection: "column", gap: 6 }}>
              <Text style={{ fontSize: 14, fontFamily: `${selectedFont} 500`, color: '#414042' }}>ABOUT</Text>
              <Text style={{ fontSize: 10, fontFamily: `${selectedFont} 400`, color: '#414042' }}>{data.summery} </Text>
          ...
          <View>
            <View style={{ flexDirection: "row", gap: 8, width: "100%" }}>
              <Svg width="33" height="32" viewBox="0 0 33 32" fill="white" xmlns="http://www.w3.org/2000/svg">
                <Path d="M30.3714 18.2336C31.6052 10.6309 26.4423 3.46746 18.8396 2.2336C11.2369 0.999729 4.07345 6.16269 2.83958 13.7654C1.60571 21.3681 6.76867 28.5315 14.3714 29.7654C21.9741 30.9992 29.1375 25.8363 30.3714 18.2336Z" stroke={selectedColor} stroke-width="0.666734" stroke-miterlimit="10" />
                <Path d="M24.4478 23.132H8.74364C7.83448 23.132 7.09766 22.3952 7.09766 21.4861V11.6128C7.09766 10.7036 7.83448 9.9668 8.74364 9.9668H24.4478C25.3569 9.9668 26.0938 10.7036 26.0938 11.6128V21.4861C26.0938 22.3952 25.3569 23.132 24.4478 23.132Z" stroke={selectedColor} stroke-width="0.666734" stroke-miterlimit="10" />
                <Path d="M20.7815 9.96518C20.6328 8.60644 19.4952 7.54492 18.0977 7.54492H14.9494C13.5519 7.54492 12.4142 8.60644 12.2656 9.96518H20.7815Z" stroke={selectedColor} stroke-width="0.666734" stroke-miterlimit="10" />
                <Path d="M24.8999 16.1566H8.29154C7.63215 16.1566 7.09766 15.6221 7.09766 14.9627V11.6757C7.09766 10.7304 7.86319 9.96484 8.80856 9.96484H24.3828C25.3282 9.96484 26.0937 10.7304 26.0937 11.6757V14.9627C26.0925 15.6221 25.558 16.1566 24.8999 16.1566Z" stroke={selectedColor} stroke-width="0.666734" stroke-miterlimit="10" />
                <Path d="M16.5242 17.3356C16.0621 17.3356 15.6875 16.961 15.6875 16.4989V15.8133C15.6875 15.3512 16.0621 14.9766 16.5242 14.9766C16.9863 14.9766 17.3609 15.3512 17.3609 15.8133V16.4989C17.3609 16.961 16.9863 17.3356 16.5242 17.3356Z" fill="white" stroke={selectedColor} stroke-width="0.666734" stroke-miterlimit="10" />
              </Svg>
                ...
                <View style={{ flexDirection: "row", gap: 4, width: "100%", alignItems: "center" }}>
                  ...
                  <View style={{ flexDirection: "column", gap: 3, width: "100%", paddingTop: 14 }}>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%" }}>
                      ...
                      <Text style={{ fontSize: 14, fontFamily: `${selectedFont} 400`, color: '#414042' }}> {detail.organization}- {detail.designation} </Text>
                      <Text style={{ fontSize: 14, fontFamily: `${selectedFont} 400`, color: selectedColor }}>{detail.duration?.start?.year}-{" "}
                        {detail.currentlyWorking
                          ? "Present"
                          : detail.duration?.end?.year}</Text>
                    </View>
                    <View>
                      <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: selectedColor }}>{detail.location}</Text>
                    </View>
                  </View>
                </View>
                <View>
                  <Text style={{ fontSize: 10, fontFamily: `${selectedFont} 400`, color: "#414042" }}>{detail.description}</Text>
                </View>
              ...
              <View style={{ flexDirection: "column", gap: 8, width: "100%" }} key={index}>
                <View style={{ flexDirection: "row", gap: 4, width: "100%", alignItems: "center" }}>
                  ...
                  <View style={{ flexDirection: "column", gap: 3, width: "100%", paddingTop: 14 }}>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%" }}>
                      <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: '#414042' }}>   {detail.qualification} - {detail.specialization}</Text>
                      <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: selectedColor }}> {detail.duration?.end?.year && (
                        <>
                    ...
                    <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: selectedColor }}>   {detail.instituteName}</Text>
                    <View>
