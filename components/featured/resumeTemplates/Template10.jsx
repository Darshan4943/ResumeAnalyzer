        ...
        <View style={{ width: "150px", marginTop: "86px" }}>
          <View style={{ flexDirection: "column", gap: 24 }}>
            <View style={{ flexDirection: "column", gap: 8 }}>
              <Text style={{ fontSize: 14, fontFamily: 'Inter 400', color: '#414042' }}>CONTACT</Text>
              ...
              <View style={{ flexDirection: "col", gap: 8, paddingRight: 4 }} >
                <View style={{ flexDirection: "row", gap: 8, alignItems: "center" }}>
                  ...
                  <Text style={{ fontSize: 14, fontFamily: 'Inter 400', color: '#414042' }}>{data.location}</Text>
                </View>
                ...
                <View style={{ flexDirection: "row", gap: 8, alignItems: "center" }}>
                  ...
                  <Text style={{ fontSize: 14, fontFamily: 'Inter 400', color: '#414042' }}>{data.mobileNumber}</Text>
                </View>
                ...
                <View style={{ flexDirection: "row", gap: 8, alignItems: "center" }}>
                  ...
                  <Text style={{ fontSize: 14, fontFamily: 'Inter 400', color: '#414042' }}>{data.email}</Text>
                </View>
            ...
            <View style={{ flexDirection: "column", gap: 12 }}>
              <Text style={{ fontSize: 14, fontFamily: 'Inter 400', color: '#414042' }}>SKILLS</Text>
              {data?.skills?.map((detail, index) => (
                <View style={{ flexDirection: "row", gap: 16 }}>
                  ...
                  <Text style={{ fontSize: 10, fontFamily: 'Inter 400', color: '#414042' }}>{detail.skill}</Text>
                </View>
              ))}
            ...
            {data?.languages?.length > 0 && (
              <>
                <Text style={{ fontSize: 14, fontFamily: 'Inter 400', color: '#414042' }}>LANGUAGES</Text>
        ...
        <View style={{ width: "373px", gap: 24 }}>
          ...
          <View style={{ flexDirection: "column", gap: 8 }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
              <View style={{ flexDirection: "column", gap: 8 }}>
                <View>
                  <Text style={{ fontSize: 36, fontFamily: 'Inter 400', color: '#414042' }}>{data.firstName}</Text>
                  <Text style={{ fontSize: 36, fontFamily: 'Inter 400', color: '#414042' }}>{data.lastName}</Text>
                </View>
                <Text style={{ fontSize: 16, fontFamily: 'Inter 400', color: '#414042' }}>{data.designation} </Text>
              </View>
            ...
            <View style={{ flexDirection: "column", gap: 6 }}>
              <Text style={{ fontSize: 14, fontFamily: 'Inter 500', color: '#414042' }}>ABOUT</Text>
              <Text style={{ fontSize: 10, fontFamily: 'Inter 400', color: '#414042' }}>{data.summery} </Text>
                ...
                <View style={{ flexDirection: "row", gap: 4, width: "100%", alignItems: "center" }}>
                  ...
                  <View style={{ flexDirection: "column", gap: 3, width: "100%", paddingTop: 14 }}>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%" }}>
                      ...
                      <Text style={{ fontSize: 14, fontFamily: 'Inter 400', color: '#414042' }}> {detail.organization}- {detail.designation} </Text>
                      <Text style={{ fontSize: 14, fontFamily: 'Inter 400', color: '#F2BE5C' }}>{detail.duration?.start?.year}-{" "}
                        {detail.currentlyWorking
                          ? "Present"
                          : detail.duration?.end?.year}</Text>
                    </View>
                    <View>
                      <Text style={{ fontSize: 12, fontFamily: 'Inter 400', color: '#F2BE5C' }}>{detail.location}</Text>
                    </View>
                  </View>
                </View>
                <View>
                  <Text style={{ fontSize: 10, fontFamily: 'Inter 400', color: '#F2BE5C' }}>{detail.description}</Text>
                </View>
              ...
              <View style={{ flexDirection: "column", gap: 8, width: "100%" }}>
                <View style={{ flexDirection: "row", gap: 4, width: "100%", alignItems: "center" }}>
                  ...
                  <View style={{ flexDirection: "column", gap: 3, width: "100%", paddingTop: 14 }}>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%" }}>
                      <Text style={{ fontSize: 12, fontFamily: 'Inter 400', color: '#414042' }}>   {detail.qualification} - {detail.specialization}</Text>
                      <Text style={{ fontSize: 12, fontFamily: 'Inter 400', color: '#F2BE5C' }}> {detail.duration?.end?.year && (
                        <>
                    ...
                    <Text style={{ fontSize: 12, fontFamily: 'Inter 400', color: '#F2BE5C' }}>   {detail.instituteName}</Text>
                    <View>
          ...
          <View style={{ flexDirection: "column", gap: 10 }} >
            <View style={{ flexDirection: "row", gap: 8, width: "100%" }}>
              <Image style={{ width: "27px", height: "27px" }} src="/images/services/experience_white.png" alt="" />
              <View style={{ display: "flex", flexDirection: "column", gap: 4, width: "100%" }}>
                <Text style={{ color: "#282829", fontFamily: "Inter 400", fontSize: "16px" }}>COURSE</Text>
                <View style={{ height: "1px", marginTop: "4px", width: "100%", backgroundColor: "#B2B2B2" }}></View>
              </View>
            </View>
            ...
            {data?.course?.map((detail, index) => (
              <View style={{ flexDirection: "column", gap: 8, width: "100%" }}>
                <View style={{ flexDirection: "row", gap: 4, width: "100%", alignItems: "center" }}>
                  ...
                  <View style={{ flexDirection: "column", gap: 3, width: "100%", paddingTop: 14 }}>
                    <Text style={{ fontSize: 12, fontFamily: 'Inter 400', color: '#414042' }}>{detail.courseName} </Text>
                    <Text style={{ fontSize: 12, fontFamily: 'Inter 400', color: '#F2BE5C' }}> {detail.duration?.end?.month}-
                      {detail.duration?.end?.year}</Text>
                  </View>
                  <View>
                    <Text style={{ fontSize: 10, fontFamily: 'Inter 400', color: '#F2BE5C' }}>{detail.issuedBy}</Text>
                    <View>
