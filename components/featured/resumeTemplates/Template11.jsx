      ...
      <View style={{ minHeight: 841, flexDirection: 'row' }}>
        <View style={{ width: 245, backgroundColor: '#E6E7E8', flexDirection: 'column', paddingTop: 42, paddingLeft: 24, gap: 26, alignItems: 'flex-start' }}>
          ...
          <View style={{ flexDirection: 'column' }}>
            <Text style={{ fontSize: 40, fontWeight: '700', }}>{data.firstName}</Text>
            <Text style={{ fontSize: 40, fontWeight: '700', }}>{data.lastName}</Text>
            <Text style={{ fontSize: 16,  fontWeight: '700', }}>{data.designation}</Text>
          </View>
        ...
        <View style={{ width: 350, alignItems: 'flex-start', paddingTop: 32, paddingLeft: 24, paddingBottom: 38 }}>
          ...
          <View style={{ flexDirection: 'column', alignItems: 'flex-start', gap: 22 }}>
            ...
            <View style={{ width: "95%" }}>
              <View style={{}}>
                <Text style={{ color: '#000000', fontSize: 18, fontWeight: '700', }}>About Me</Text>
              </View>
              <View style={{ paddingTop: 10 }}>
                <View style={{ flexDirection: 'row', gap: 2 }}>
                  <Text style={{ color: '#6D6E71', fontSize: 12, fontWeight: '500', }}>{data.summery}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={{ flexDirection: 'column', gap: 16 }}>
              <View style={{}}>
                <Text style={{ color: '#000000', fontSize: 18, fontWeight: '700', }}>Contact</Text>
              </View>
              {data.mobileNumber &&
                ...
                <View style={{ flexDirection: 'row', gap: 30 }}>
                  <View style={{ flexDirection: 'row',gap:16 }}>
                    <View style={{ flexDirection: 'column', gap: 5, width: 124 }}>
                      ...
                      <Text style={{ color: '#1C75BC', fontSize: 13, fontWeight: 700,  }}>
                        {detail.organization}
                      </Text>

                      <Text style={{ color: '#000000', fontSize: 13, fontWeight: 500,  }}>
                        {detail.location}
                      </Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'column', width: 246, gap: 2 }}>
                      ...
                      <Text style={{ color: '#000000', fontSize: 10, fontWeight: 500,  }}>
                        {detail.description}
                      </Text>
