                            ...
                            <View style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                                {data?.internship?.map((detail, index) => (
                                    <View
                                        ...
                                        `} </Text>
                                            <Text style={{ fontSize: 12, color: "#414042", fontFamily: `${selectedFont} 500`, width: 379 }}>{detail.title}</Text>
                                        </View>
                                        <View style={{ display: "flex", flexDirection: "row", gap: 12 }}>
                                            <Text style={{ fontSize: 12, color: "#414042", fontFamily: `${selectedFont} 500`, width: 132 }}>{detail.organization}</Text>
                                            <Text style={{ fontSize: 10, color: "#939598", fontFamily: `${selectedFont} 400`, width: 379 }}>{detail.description} </Text>
                        ...
                        <>
                            {data?.section?.map((item, index) => (
                                ...
                                >
                                    <View style={{ display: "flex", flexDirection: "row", gap: 8, justifyContent: "center", alignItems: "center" }}>
                                    <Svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<Path d="M12 23C18.0751 23 23 18.0751 23 12C23 5.92486 18.0751 1 12 1C5.92487 1 1 5.92486 1 12C1.00001 18.0751 5.92488 23 12 23Z" fill={selectedColor}/>
<Path d="M7.9323 17.4001C7.77232 17.4001 7.6389 17.3462 7.53202 17.2384C7.42515 17.1305 7.37171 16.997 7.37171 16.8377V12.5177H6.56171C6.40241 12.5177 6.26882 12.4635 6.16093 12.3553C6.05316 12.2471 5.99927 12.113 5.99927 11.9532C5.99927 11.7932 6.05316 11.6598 6.16093 11.5529C6.26882 11.446 6.40241 11.3926 6.56171 11.3926H9.30677C9.46618 11.3926 9.59977 11.4467 9.70755 11.5549C9.81532 11.663 9.86921 11.7971 9.86921 11.9571C9.86921 12.117 9.81532 12.2505 9.70755 12.3573C9.59977 12.4642 9.46618 12.5177 9.30677 12.5177H8.49677V16.8377C8.49677 16.997 8.44266 17.1305 8.33443 17.2384C8.22632 17.3462 8.09227 17.4001 7.9323 17.4001ZM7.9323 10.2675C7.77232 10.2675 7.6389 10.2137 7.53202 10.1059C7.42515 9.9981 7.37171 9.86451 7.37171 9.7051V7.16254C7.37171 7.00324 7.42582 6.86965 7.53405 6.76176C7.64227 6.65399 7.77632 6.6001 7.93618 6.6001C8.09615 6.6001 8.22958 6.65399 8.33645 6.76176C8.44333 6.86965 8.49677 7.00324 8.49677 7.16254V9.7051C8.49677 9.86451 8.44266 9.9981 8.33443 10.1059C8.22632 10.2137 8.09227 10.2675 7.9323 10.2675ZM10.7018 9.80635C10.5424 9.80635 10.4088 9.75224 10.301 9.64401C10.1932 9.5359 10.1392 9.40185 10.1392 9.24188C10.1392 9.0819 10.1932 8.94848 10.301 8.8416C10.4088 8.73473 10.5424 8.68129 10.7018 8.68129H11.5118V7.16254C11.5118 7.00324 11.5659 6.86965 11.674 6.76176C11.7822 6.65399 11.9163 6.6001 12.0763 6.6001C12.2362 6.6001 12.3695 6.65399 12.4764 6.76176C12.5833 6.86965 12.6367 7.00324 12.6367 7.16254V8.68129H13.4467C13.6061 8.68129 13.7397 8.7354 13.8475 8.84363C13.9554 8.95185 14.0093 9.0859 14.0093 9.24576C14.0093 9.40574 13.9554 9.53916 13.8475 9.64604C13.7397 9.75291 13.6061 9.80635 13.4467 9.80635H10.7018ZM12.0722 17.4001C11.9124 17.4001 11.779 17.3462 11.6721 17.2384C11.5653 17.1305 11.5118 16.997 11.5118 16.8377V11.4938C11.5118 11.3344 11.5659 11.2008 11.674 11.0931C11.7822 10.9853 11.9163 10.9314 12.0763 10.9314C12.2362 10.9314 12.3695 10.9853 12.4764 11.0931C12.5833 11.2008 12.6367 11.3344 12.6367 11.4938V16.8377C12.6367 16.997 12.5827 17.1305 12.4745 17.2384C12.3663 17.3462 12.2322 17.4001 12.0722 17.4001ZM16.2124 17.4001C16.0524 17.4001 15.919 17.3462 15.8121 17.2384C15.7052 17.1305 15.6518 16.997 15.6518 16.8377V15.2963H14.8418C14.6824 15.2963 14.5488 15.2422 14.441 15.1341C14.3332 15.0259 14.2793 14.8918 14.2793 14.7318C14.2793 14.572 14.3332 14.4386 14.441 14.3317C14.5488 14.2248 14.6824 14.1714 14.8418 14.1714H17.5868C17.7461 14.1714 17.8797 14.2255 17.9876 14.3336C18.0954 14.4418 18.1493 14.5759 18.1493 14.7359C18.1493 14.8957 18.0954 15.0291 17.9876 15.136C17.8797 15.2429 17.7461 15.2963 17.5868 15.2963H16.7768V16.8377C16.7768 16.997 16.7227 17.1305 16.6145 17.2384C16.5063 17.3462 16.3722 17.4001 16.2124 17.4001ZM16.2124 13.0463C16.0524 13.0463 15.919 12.9925 15.8121 12.8847C15.7052 12.7768 15.6518 12.6432 15.6518 12.4839V7.16254C15.6518 7.00324 15.7059 6.86965 15.8141 6.76176C15.9222 6.65399 16.0563 6.6001 16.2162 6.6001C16.3762 6.6001 16.5096 6.65399 16.6165 6.76176C16.7234 6.86965 16.7768 7.00324 16.7768 7.16254V12.4839C16.7768 12.6432 16.7227 12.7768 16.6145 12.8847C16.5063 12.9925 16.3722 13.0463 16.2124 13.0463Z" fill="white"/>
</Svg>
