    ...
    >
      <View style={{ marginTop: "-12px" }}>
        ...
        >
                      ...
                      <Image
                        src={
                          preview
                            ...
                            : Object.keys(data?.profilePhoto || {}).includes(
                                "filename"
                              )
          ...
          <View
            style={{ width: "100%", height: "1px", backgroundColor: "#808285" }}
          ></View>
          <View
            style={{
              width: "100%",
          ...
          >
            ...
            >
              ...
              >
                <Path
                  d="M11.25 7.12535C11.25 7.35552 11.1853 7.569 11.0817 7.75675L7.76646 4.04697L11.0456 1.1772C11.1728 1.37956 11.25 1.61737 11.25 1.87466V7.12535ZM5.99965 4.72078L10.5623 0.728001C10.3753 0.625087 10.1639 0.5625 9.93654 0.5625H2.06206C1.834 0.5625 1.62332 0.625087 1.43697 0.728001L5.99965 4.72078ZM7.27208 4.47949L6.2159 5.40432C6.15401 5.45786 6.07683 5.48498 5.99965 5.48498C5.92247 5.48498 5.84529 5.45787 5.78341 5.40363L4.72722 4.4788L1.37022 8.23585C1.57117 8.36171 1.80758 8.4375 2.06276 8.4375H9.93793C10.1931 8.4375 10.4288 8.36171 10.6298 8.23585L7.27208 4.47949ZM0.954423 1.17789C0.82718 1.38024 0.75 1.61806 0.75 1.87535V7.12535C0.75 7.35552 0.813969 7.569 0.918267 7.75675L4.23285 4.04697L0.954423 1.17789Z"
                  fill="#808285"
                />
              </Svg>
              <Text
            ...
            {data?.location && (
              ...
              >
                ...
                >
                  <Path
                    d="M4.0008 0.5C1.79451 0.5 0 2.28059 0 4.46899C0 5.35055 0.567193 6.78776 1.73443 8.86328C2.55958 10.3307 3.37192 11.5548 3.40557 11.6057L4 12.5L4.59443 11.6057C4.62888 11.5548 5.44042 10.3307 6.26557 8.86328C7.4328 6.78856 8 5.35135 8 4.46979C8.0016 2.2806 6.20709 0.5 4.0008 0.5ZM4.0008 6.50079C2.8552 6.50079 1.9275 5.57949 1.9275 4.44277C1.9275 3.30604 2.856 2.38474 4.0008 2.38474C5.1456 2.38474 6.0749 3.30604 6.0749 4.44277C6.0749 5.5787 5.1464 6.50079 4.0008 6.50079Z"
                    fill="#808285"
                  />
                </Svg>
                <Text
          ...
          {data?.showSummary === true && (
            <View style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              >
                ...
                >
                  <Path
                    d="M11.991 23C18.0661 23 22.9965 18.0751 23.0033 12C23.0101 5.92487 18.0908 1 12.0156 1C5.9405 1 1.01011 5.92487 1.00331 12C0.996512 18.0751 5.91588 23 11.991 23Z"
                    fill={selectedColor}
                  />
                  <Path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M12.0341 11.3877C13.7878 11.3877 15.2076 9.96657 15.2076 8.21415C15.2076 6.46173 13.7878 5.04004 12.0341 5.04004C10.2811 5.04004 8.85938 6.46173 8.85938 8.21415C8.86 9.96657 10.2811 11.3877 12.0341 11.3877Z"
                    fill="white"
                  />
                  <Path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M12.0333 11.9663C8.56829 11.9663 5.75781 14.7749 5.75781 18.2399H18.3051C18.3051 14.7749 15.4984 11.9663 12.0333 11.9663Z"
                    fill="white"
                  />
                </Svg>
                <Text
          ...
          {data?.experience?.length > 0 && data?.showExperience === true && (
            ...
            >
              ...
              >
                ...
                <View
                  style={{ backgroundColor: "#6D6E71", width: 393, height: 1 }}
                ></View>
              </View>
              <View
                style={{ display: "flex", flexDirection: "column", gap: 16 }}
          ...
          {data?.education?.length > 0 && data?.showEducation === true && (
            ...
            >
              ...
              >
                ...
                >
                  <Path
                    d="M11.9958 23C18.0687 23 22.9935 18.0751 22.9958 12C22.9981 5.92489 18.0768 1 12.004 1C5.93109 1 1.00623 5.92489 1.00397 12C1.00171 18.0751 5.92291 23 11.9958 23Z"
                    fill={selectedColor}
                  />
                  <Path
                    d="M13.024 15.1207C12.7387 15.2962 12.3728 15.3929 11.9941 15.3929C11.6155 15.3929 11.2496 15.2962 10.9643 15.1207L6.30209 12.2541C6.30209 12.2541 5.8811 11.9958 5.8811 12.5815V15.4441C5.8811 16.9519 8.61844 18.577 11.9941 18.577C15.3698 18.577 18.1072 16.9519 18.1072 15.4441V12.4198C18.1072 11.9494 17.8082 12.1791 17.8082 12.1791L13.024 15.1207Z"
                    fill="white"
                  />
                  <Path
                    d="M19.7478 9.97177C20.1058 9.75187 20.1058 9.39097 19.7478 9.17107L12.6453 5.61024C12.2872 5.39034 11.701 5.39034 11.343 5.61024L4.24142 9.17107C3.88339 9.39097 3.88339 9.75187 4.24142 9.97177L11.343 14.3382C11.701 14.5581 12.2872 14.5581 12.6453 14.3382"
                    fill="white"
                  />
                  <Path
                    d="M19.4559 16.4444V11.6214C19.4559 11.6214 19.4588 11.3926 19.3241 11.4686C19.2159 11.5287 18.9503 11.6776 18.8559 11.7595C18.7477 11.8532 18.7723 12.0652 18.7723 12.0652V16.4444C18.7723 16.5065 18.7192 16.5361 18.6936 16.5509C18.4477 16.6959 18.2834 16.9631 18.2834 17.2688C18.2834 17.7293 18.6552 18.1021 19.1146 18.1021C19.5739 18.1021 19.9457 17.7293 19.9457 17.2688C19.9457 16.9611 19.7795 16.6939 19.5326 16.549C19.507 16.5352 19.4559 16.5065 19.4559 16.4444Z"
                    fill="white"
                  />
                </Svg>
                <View
          ...
          {data?.course?.length > 0 &&
            ...
            !pageLayout && (
              ...
              >
                ...
                >
                  <View
                    style={{ gap: 8, display: "flex", flexDirection: "row" }}
                  >
                    <Svg
                      width="24"
                      height="24"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    />
                    <Path
                      d="M6.87842 15.114L9.44863 12.5438L10.4968 13.5919L7.92655 16.1621L6.87842 15.114Z"
                      fill="white"
                    />
                    <Path
                      d="M8.44507 16.6846L11.0153 14.1144L12.0634 15.1625L9.49322 17.7327L8.44507 16.6846Z"
                      fill="white"
                    />
                    <Path
                      d="M6.01099 18.5999L8.90457 18.1865L6.42432 15.7063L6.01099 18.5999Z"
                      fill="white"
                    />
                    <Path
                      d="M12.5557 9.43701L14.4713 7.52136L15.5194 8.56949L13.6038 10.4851L12.5557 9.43701Z"
                      fill="white"
                    />
                    <Path
                      d="M14.1248 11.0071L16.0404 9.09141L17.0886 10.1395L15.1729 12.0552L14.1248 11.0071Z"
                      fill="white"
                    />
                    <Path
                      d="M18.0675 9.16012C18.4173 8.8104 18.6099 8.34541 18.6099 7.8508C18.6099 7.3562 18.4173 6.89121 18.0675 6.54149C17.3456 5.8195 16.1709 5.8195 15.4489 6.54149L14.9922 6.99821L17.6108 9.61685L18.0675 9.16012Z"
                      fill="white"
                    />
                    <Path
                      d="M11.2066 9.13145C11.375 8.27783 11.1096 7.38938 10.4882 6.768C9.99294 6.27274 9.33445 6 8.634 6C8.34049 6 8.05144 6.04848 7.77491 6.14412L7.21741 6.33692L8.81145 7.93096L7.94212 8.80029L6.34806 7.20625L6.15525 7.76376C5.99676 8.22203 5.96824 8.71499 6.07276 9.18934C6.18026 9.67712 6.4245 10.1224 6.77914 10.477C7.27443 10.9723 7.93296 11.2451 8.63349 11.2451C8.80473 11.2451 8.97521 11.2284 9.14258 11.1954L13.4148 15.4676C13.2464 16.3212 13.5118 17.2097 14.1332 17.8311C14.6285 18.3263 15.287 18.5991 15.9874 18.5991C16.2809 18.5991 16.57 18.5506 16.8465 18.4549L17.404 18.2621L15.8099 16.6681L16.6792 15.7988L18.2733 17.3928L18.4661 16.8353C18.6246 16.377 18.6531 15.8841 18.5486 15.4097C18.4411 14.9219 18.1969 14.4766 17.8422 14.122C17.347 13.6268 16.6884 13.354 15.9879 13.354C15.8166 13.354 15.6462 13.3707 15.4788 13.4036L11.2066 9.13145Z"
                      fill="white"
                    />
                  </Svg>
                  <View
