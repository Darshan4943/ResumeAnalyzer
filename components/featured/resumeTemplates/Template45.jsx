            ...
            <View style={{ display: "flex", gap: 28, flexDirection: "column" ,minHeight:793.8 }}>
                    ...
                    <View style={{ display: "flex", width: "338px", flexDirection: "column", gap: "60px" }}>
                        <View style={{ flexDirection: "column", gap: "8px" }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{ fontWeight: 400, fontSize: 12, color: "#282829" }}>ABOUT ME</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                            </View>
                            <Text style={{ fontWeight: 400, fontSize: 10, width: "100%", color: "#6D6E71" }}>
                ...
                <View style={{ width: "100%", flexDirection: "row", minHeight: 60, gap: "10px", position: "absolute", top: 141 }}>
                    <View style={{ flexDirection: "column", gap: "10", width: "292" }}>
                        <View style={{ flexDirection: "row" }}>
                            <Text style={{ fontWeight: 400, fontSize: 10, color: "#ED1B34" }}>Address :</Text>
                ...
                <View style={{ gap: "24", flexDirection: "row", width: "100%", }}>
                    <View style={{ gap: "36", flexDirection: "column", width: 171 }}>
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{ fontWeight: 400, fontSize: 12, color: "#282829" }}>PERSONAL</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                            ...
                            <View style={{ gap: "6px", flexDirection: "column", width: "100%", }}>
                                <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                    <Text style={{ fontWeight: 500, fontSize: 10, color: "#282829" }}>Birthday             :</Text>
                                    <Text style={{ fontWeight: 500, fontSize: 10, color: "#6D6E71" }}>12th January 1991</Text>
                                </View>
                                <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                    <Text style={{ fontWeight: 500, fontSize: 10, color: "#282829" }}>Relationship      :</Text>
                                    <Text style={{ fontWeight: 500, fontSize: 10, color: "#6D6E71" }}>Single</Text>
                                </View>
                                <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                    <Text style={{ fontWeight: 500, fontSize: 10, color: "#282829" }}>Nationality        :</Text>
                                    <Text style={{ fontWeight: 500, fontSize: 10, color: "#6D6E71" }}>South African</Text>
                                </View>
                                <View style={{ flexDirection: "row", }}>
                                    <Text style={{ fontWeight: 500, fontSize: 10, color: "#282829" }}>Languages         :</Text>
                                    {data.languages?.map((detail, index) => {
                                        <View>
                                            <Text style={{ fontWeight: 500, fontSize: 10, color: "#6D6E71" }}> English </Text>
                                        </View>
                                    })}
                                </View>
                            </View>
                        ...
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{ fontWeight: 400, fontSize: 12, color: "#282829" }}>SKILLS</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                                    ...
                                    return (
                                        <View style={{ paddingRight: 4, flexDirection: "column", width: "100%", }} key={index}>
                                            <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
                                                <Text style={{ color: "#282829", fontSize: 12, width: 80, fontWeight: "light" }}>
                                                    {detail.skill}
                                                </Text>
                                                <View style={{ width: "52.21%", height: 3.78, alignSelf: "flex-end", marginBottom: 1, backgroundColor: "#909395" }}>
                                                    <View
                                                        style={{ height: "100%", backgroundColor: "#ED1B34", width: `${ratingPercentage}%` }}
                                                    ></View>
                                                </View>
                                            </View>
                                        </View>
                        ...
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{ fontWeight: 400, fontSize: 12, color: "#282829" }}>SOFTWARE</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                        ...
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{ fontWeight: 400, fontSize: 12, color: "#282829" }}>INTERESTS</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                            ...
                            <View style={{ gap: "4px", flexDirection: "column", width: "100%", }}>
                                {data.hobbies?.map((detail, index) => (
                                    <Text key={index} style={{ color: "#282829", fontSize: 12 }}>
                                        {detail.title}
                                    </Text>
                                ))}
                            </View>
                    ...
                    <View style={{ gap: "40", flexDirection: "column", width: 346 }}>
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{ fontWeight: 400, fontSize: 12, color: "#282829" }}>EXPERIENCE</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                                    ...
                                    data.experience?.map((detail, index) => (
                                        <View style={{ flexDirection: "row", gap: "12px", width: "100%" }}>
                                            <View style={{ gap: 6, flexDirection: "column", width: 132 }}>
                                                <Text style={{ fontWeight: 500, fontSize: 12, color: "#282829" }}>{detail.designation}</Text>
                                                <Text style={{ fontWeight: 400, fontSize: 10, color: "#6D6E71" }}>{detail.duration?.start?.year}-{" "} <br />
                                            ...
                                            <View style={{ gap: 6, flexDirection: "column", width: "100%" }}>
                                                <Text style={{ fontWeight: 500, fontSize: 12, color: "#282829" }}>{detail.organization}</Text>
                                                <Text style={{ fontWeight: 400, fontSize: 12, color: "#6D6E71" }}>{detail.description}</Text>
                                            </View>
                        ...
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{ fontWeight: 400, fontSize: 12, color: "#282829" }}>EDUCATION</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                            ...
                            <View style={{ gap: "20px", flexDirection: "column", width: "100%", }}>
                                {
                                    data.education?.map((detail, index) => (
                                        <View style={{ flexDirection: "row", gap: "12px", width: "100%" }}>
                                            <View style={{ gap: 6, flexDirection: "column", width: 132 }}>
                                                <Text style={{ fontWeight: 500, fontSize: 12, color: "#282829" }}>{detail.instituteName}</Text>
                                                <Text style={{ fontWeight: 400, fontSize: 10, color: "#6D6E71" }}>{detail.duration?.start?.year}-{" "} <br />
                                                    {detail.currentlyWorking
                                                        ? "Present"
                                                        : detail.duration?.end?.year}
                                            ...
                                            <View style={{ gap: 6, flexDirection: "column", width: "100%" }}>
                                                <Text style={{ fontWeight: 500, fontSize: 12, color: "#282829" }}>{detail.qualification}</Text>
                                                <Text style={{ fontWeight: 400, fontSize: 12, color: "#6D6E71" }}>{detail.specialization}</Text>
                                            </View>
                ...
                <View style={{ position: "absolute", bottom: 0,margin:-24 }}>
                    <Svg width="595" height="24" viewBox="0 0 595 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <Path d="M119 0H0V24H119V0Z" fill="#ED1B34" />
