                    ...
                    <View style={{ display: "flex", width: "338px", flexDirection: "column", gap: "60px" }}>
                        <View style={{ flexDirection: "column", gap: "8px" }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{  fontFamily:'Lato 400', fontSize: 12, color: "#282829" }}>ABOUT ME</Text>
                            ...
                            <Text style={{ fontFamily:'Lato 400', fontSize: 10, width: "100%", color: "#6D6E71" }}>
                ...
                <View style={{ width: "100%", flexDirection: "row", minHeight: 60, gap: "10px", position: "absolute", top: 141 }}>
                    <View style={{ flexDirection: "column", gap: "10", width: "292" }}>
                        <View style={{ flexDirection: "row" }}>
                            <Text style={{ fontFamily:'Lato 400', fontSize: 10, color: "#ED1B34" }}>Address :</Text>
                            <Text style={{ fontFamily:'Lato 400', fontSize: 10, color: "#282829" }}>{data.location ? <>{data.location}</> : <>Your Address</>}</Text>
                        </View>
                        <View style={{ flexDirection: "row", gap: 8, width: "100%" }}>
                            <View style={{ flexDirection: "column", gap: 8, width: "100%" }}>
                                <View style={{ flexDirection: "row", gap: 6, width: "100%", alignItems: "center" }}>
                                    ...
                                    <Text style={{ fontFamily:'Lato 400', fontSize: 10, color: "#282829", width: "100%" }}>{data.sociaLinks ? <>{data.sociaLinks}</> : <>Your Websites</>}</Text>
                                </View>
                                <View style={{ flexDirection: "row", gap: 6, width: "100%", alignItems: "center" }}>
                                    <Svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <Text style={{ fontFamily:'Lato 400', fontSize: 10, color: "#282829", width: "100%" }}>{data.email ? <>{data.email}</> : <>Your Email</>}</Text>
                                </View>
                            </View>
                            <View style={{ flexDirection: "row", gap: 6, width: "100%", }}>
                                ...
                                <Text style={{ fontFamily:'Lato 400', fontSize: 10, color: "#282829", width: "100%" }}>{data.mobileNumber ? (<>{data.mobileNumber}</>) : (<>Your Phone</>)}</Text>
                            </View>
                        </View>
                    </View>
                    <View style={{ width: 303, backgroundColor: "#ED1B34BF", marginRight: -24 }}>
                        <View style={{ paddingVertical: 5, paddingRight: 24, textAlign: "right" }}>
                            <Text style={{ fontFamily:'Lato 400', fontSize: 26, color: "#FFFFFF" }}>{data.firstName ? <>{data.firstName}</> : <>First Name</>}{" "}{data.lastName ? <>{data.lastName}</> : <>Last Name</>}</Text>
                            <Text style={{ fontFamily:'Lato 400', fontSize: 12, color: "#FFFFFF" }}>{data.designation ? <>{data.designation}</> : <>Designation</>}</Text>
                        </View>
                    </View>
                </View>
                <View style={{ gap: "24", flexDirection: "row", width: "100%", }}>
                    <View style={{ gap: "36", flexDirection: "column", width: 171 }}>
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{ fontFamily:'Lato 400', fontSize: 12, color: "#282829" }}>PERSONAL</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                        ...
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{ fontFamily:'Lato 400', fontSize: 12, color: "#282829" }}>SKILLS</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                                    ...
                                    return (
                                        <View style={{ paddingRight: 4, flexDirection: "column", width: "100%", }} key={index}>
                                            <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
                                                <Text style={{ fontFamily:'Lato 400',color: "#282829", fontSize: 12, width: 80, fontWeight: "light" }}>
                                                    {detail.skill}
                                                </Text>
                        ...
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{ fontFamily:'Lato 400', fontSize: 12, color: "#282829" }}>SOFTWARE</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                        ...
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{ fontFamily:'Lato 400', fontSize: 12, color: "#282829" }}>INTERESTS</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                            ...
                            <View style={{ gap: "4px", flexDirection: "column", width: "100%", }}>
                                {data.hobbies?.map((detail, index) => (
                                    <Text key={index} style={{ fontFamily:'Lato 400',color: "#282829", fontSize: 12 }}>
                                        {detail.title}
                                    </Text>
                                ))}
                            </View>
                    ...
                    <View style={{ gap: "40", flexDirection: "column", width: 346 }}>
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{fontFamily:'Lato 400',fontSize: 12, color: "#282829" }}>EXPERIENCE</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
                        ...
                        <View style={{ gap: "8px", flexDirection: "column", width: "100%", }}>
                            <View style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <Text style={{fontFamily:'Lato 400', fontSize: 12, color: "#282829" }}>EDUCATION</Text>
                                <View style={{ flexDirection: "row", display: "flex", alignItems: "center" }}>
                                    <View style={{ height: 2, width: 16, backgroundColor: "#ED1B34" }}></View>
                                    <View style={{ height: 1, width: "100%", backgroundColor: "#939598" }}></View>
                                </View>
