...
function Template38({ data,selectedColor,selectedFont  }) {
            ...
            <View style={{ flexDirection: 'row' }}>
                ...
                <View style={{ width: "195px" }}>
                    <View style={{ flexDirection: "column", minHeight: "792.7px", height: "100%", gap: "18px", }}>
                        ...
                        <View style={{ display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-start", paddingTop: "26px" }}>
                            ...
                            <Text style={{ color: selectedColor,fontFamily: `${selectedFont} 400`, fontSize: "12px" }}>About me</Text>
                        ...
                        <View style={{ height: "1px", width: "95%", backgroundColor: selectedColor }}></View>
                        ...
                        <View style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>
                            ...
                            <Text style={{ color: selectedColor, fontFamily: `${selectedFont} 400`, fontSize: "16px" }}>EDUCATION</Text>
                                    ...
                                    <>
                                        <View key={index} style={{ display: "flex", flexDirection: "row", gap: 16, alignItems: "start" }}>
                                            <View style={{ display: "flex", flexDirection: "column", gap: 8, justifyContent: "space-between", }}>
                                                <Text style={{ color: "#414042", fontSize: "12px", fontFamily: `${selectedFont} 700`, }}>{detail.duration?.start?.year}-{detail.duration?.end?.year}</Text>
                                                <Text style={{ color: "#787879", fontSize: "12px", fontFamily: `${selectedFont} 700`,}}>{detail.qualification} - {detail.specialization}</Text>
                                                <Text style={{ color: "#414042", fontSize: "12px", fontFamily: `${selectedFont} 400`,}}>{detail.instituteName}</Text>
                        ...
                        <View style={{ display: "flex", flexDirection: "column", gap: "8" }}>
                            <Text style={{ color: selectedColor, fontSize: "14px", fontWeight: 400, }}>CONTACT</Text>
                ...
                <View style={{ width: "351px", padding: " 16px", display: "flex", flexDirection: "column", gap: "36px" }}>
                    <View style={{ flexDirection: "column", marginTop: 24, gap: 4 }}>
                        <Text style={{ color: selectedColor, fontFamily: `${selectedFont} 400`, fontSize: "24px", }}>{data.firstName} {data.lastName}</Text>
                        <Text style={{ fontSize: "12px", fontFamily: `${selectedFont} 400`,color: "#58595B" }}>{data.designation}</Text>
                    </View>
                    <View style={{ height: "10px", width: "120%", backgroundColor: selectedColor }}></View>

                    <View style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>



                        <Text style={{ color: selectedColor,fontFamily: `${selectedFont} 400`, fontSize: "16px" }}>EXPERIENCE</Text>
                            ...
                            {data?.experience?.map((detail, index) => (
                                <>
                                    ...
                                    <View style={{ display: "flex", flexDirection: "column", gap: 4, justifyContent: "space-between", }}>
                                        <Text style={{ color: "#58595B", fontSize: "12px", fontFamily: `${selectedFont} 700`, }}>{detail.duration?.start?.year}-{" "}{detail.currentlyWorking ? "Present" : detail.duration?.end?.year}</Text>
                                        <Text style={{ color: "#58595B", fontSize: "12px", fontFamily: `${selectedFont} 700`,}}>{detail.designation}</Text>
                                        <Text style={{ color: "#58595B", fontSize: "12px", fontFamily: `${selectedFont} 400`, }}>{detail.organization}</Text>
                                        <Text style={{ color: "#58595B", fontSize: "12px", fontFamily: `${selectedFont} 400`, }}>{detail.description}</Text>
                    ...
                    {data?.skills?.length > 0 && (
                            <View style={{flexDirection: "column", gap: "16px", }}>
                                ...
                                <Text style={{ color: selectedColor,fontSize:12,fontFamily: `${selectedFont} 400`, }}> PERSONAL SKILLS</Text>
                        ...
                        {data?.skills?.length > 0 && (
                            <View style={{flexDirection: "column", gap: "16px", }}>
                                ...
                                <Text style={{ fontFamily: `${selectedFont} 400`,color: selectedColor,fontSize:12 }}> SOFTWARE SKILLS</Text>
