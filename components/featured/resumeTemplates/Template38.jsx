            ...
            <View style={{ flexDirection: 'row' }}>
                ...
                <View style={{ width: "195px" }}>
                    <View style={{ flexDirection: "column", minHeight: "792.7px", height: "100%", gap: "18px", }}>
                        ...
                        <View style={{ display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-start", paddingTop: "26px" }}>
                            ...
                            <Text style={{ color: "#C49A6C",fontFamily: `${selectedFont} 400`, fontSize: "12px" }}>About me</Text>
                        ...
                        <View style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>
                            ...
                            <Text style={{ color: "#C49A6C", fontFamily: `${selectedFont} 400`, fontSize: "16px" }}>EDUCATION</Text>
                ...
                <View style={{ width: "351px", padding: " 16px", display: "flex", flexDirection: "column", gap: "36px" }}>
                    <View style={{ flexDirection: "column", marginTop: 24, gap: 4 }}>
                        <Text style={{ color: "#C49A6C", fontFamily: `${selectedFont} 400`, fontSize: "24px", }}>{data.firstName} {data.lastName}</Text>
                    ...
                    <View style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>
                        ...
                        <Text style={{ color: "#C49A6C",fontFamily: `${selectedFont} 400`, fontSize: "16px" }}>EXPERIENCE</Text>
                    ...
                    {data?.skills?.length > 0 && (
                            <View style={{flexDirection: "column", gap: "16px", }}>
                                ...
                                <Text style={{ color: "#C49A6C",fontSize:12,fontFamily: `${selectedFont} 400`, }}> PERSONAL SKILLS</Text>
                        ...
                        {data?.skills?.length > 0 && (
                            <View style={{flexDirection: "column", gap: "16px", }}>
                                ...
                                <Text style={{ fontFamily: `${selectedFont} 400`,color: "#C49A6C",fontSize:12 }}> SOFTWARE SKILLS</Text>
                    ...
                    {data?.hobbies?.length > 0 && (
                            <View style={{ flexDirection: "column", gap: "16px", }}>
                                ...
                                <View style={{ }}>
                                    ...
                                    <Text style={{fontFamily: `${selectedFont} 400`, color: "#C49A6C" }}>HOBBIES</Text>
