            ...
            <View style={{ flexDirection: 'row' }}>
                ...
                <View style={{ width: "195px" }}>
                    <View style={{ flexDirection: "column", minHeight: "792.7px", height: "100%", gap: "18px", }}>
                        ...
                        <View style={{ display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-start", paddingTop: "26px" }}>
                            ...
                            <Text style={{ color: "#C49A6C",fontFamily:'Lato 400', fontSize: "12px" }}>About me</Text>
                        ...
                        <View style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>
                            ...
                            <Text style={{ color: "#C49A6C", fontFamily:'Lato 400', fontSize: "16px" }}>EDUCATION</Text>
                                    ...
                                    <>
                                        <View key={index} style={{ display: "flex", flexDirection: "row", gap: 16, alignItems: "start" }}>
                                            <View style={{ display: "flex", flexDirection: "column", gap: 8, justifyContent: "space-between", }}>
                                                <Text style={{ color: "#414042", fontSize: "12px", fontFamily:'Lato 700', }}>{detail.duration?.start?.year}-{detail.duration?.end?.year}</Text>
                                                <Text style={{ color: "#787879", fontSize: "12px", fontFamily:'Lato 700',}}>{detail.qualification} - {detail.specialization}</Text>
                                                <Text style={{ color: "#414042", fontSize: "12px", fontFamily:'Lato 400',}}>{detail.instituteName}</Text>
                ...
                <View style={{ width: "351px", padding: " 16px", display: "flex", flexDirection: "column", gap: "36px" }}>
                    <View style={{ flexDirection: "column", marginTop: 24, gap: 4 }}>
                        <Text style={{ color: "#C49A6C", fontFamily:'Lato 400', fontSize: "24px", }}>{data.firstName} {data.lastName}</Text>
                        <Text style={{ fontSize: "12px", fontFamily:'Lato 400',color: "#58595B" }}>{data.designation}</Text>
                    </View>
                    ...
                    <View style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>
                        ...
                        <Text style={{ color: "#C49A6C",fontFamily:'Lato 400', fontSize: "16px" }}>EXPERIENCE</Text>
                            ...
                            {data?.experience?.map((detail, index) => (
                                <>
                                    ...
                                    <View style={{ display: "flex", flexDirection: "column", gap: 4, justifyContent: "space-between", }}>
                                        <Text style={{ color: "#58595B", fontSize: "12px", fontFamily:'Lato 700', }}>{detail.duration?.start?.year}-{" "}{detail.currentlyWorking ? "Present" : detail.duration?.end?.year}</Text>
                                        <Text style={{ color: "#58595B", fontSize: "12px", fontFamily:'Lato 700',}}>{detail.designation}</Text>
                                        <Text style={{ color: "#58595B", fontSize: "12px", fontFamily:'Lato 400', }}>{detail.organization}</Text>
                                        <Text style={{ color: "#58595B", fontSize: "12px", fontFamily:'Lato 400', }}>{detail.description}</Text>
                    ...
                    {data?.skills?.length > 0 && (
                            <View style={{flexDirection: "column", gap: "16px", }}>
                                ...
                                <Text style={{ color: "#C49A6C",fontSize:12,fontFamily:'Lato 400', }}> PERSONAL SKILLS</Text>
                        ...
                        {data?.skills?.length > 0 && (
                            <View style={{flexDirection: "column", gap: "16px", }}>
                                ...
                                <Text style={{ fontFamily:'Lato 400',color: "#C49A6C",fontSize:12 }}> SOFTWARE SKILLS</Text>
                    ...
                    {data?.hobbies?.length > 0 && (
                            <View style={{ flexDirection: "column", gap: "16px", }}>
                                ...
                                <View style={{ }}>
                                    ...
                                    <Text style={{fontFamily:'Lato 400', color: "#C49A6C" }}>HOBBIES</Text>
