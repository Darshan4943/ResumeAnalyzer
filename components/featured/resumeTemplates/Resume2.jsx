...
function Resume2({ data }) {
    ...
    const dataSeter = () => {
      ...
      `;
        ...
        //         if (height > experienceDivHeightremaining) {
        //             experienceContainer.current.removeChild(parentDiv);
        //             dataForSecondPage.experience.push(detail);
        //         } else {
            ...
            <div className="h-[842px] pt-[10px] pr-[26px] pl-[21px] w-[800px]  flex bg-[#fff] absolute left-[1000px]">
                <div className=" pt-[16px] w-[490px] h-full  pl-[16px]">
                    <div className="flex items-start flex-col gap-[16px]">
                        ...
                        <div className="flex flex-col w-[100%]">
                            <div ref={summaryContainer} className="flex flex-col gap-3 w-[100%]">
                            ...
                            <div className="flex flex-col gap-3 w-[100%] mt-8">
                                ...
                                <div className="w-[85%] bg-[#F7902B] h-[3px]" ref={experienceContainer}></div>
                ...
                <div className=" bg-[#2C2A31] w-[310px] pl-[16px] pb-4 ">
                    <div className="flex flex-col gap-12 items-start mt-[200px] ">
                        ...
                        <div ref={contactContainer} className="flex flex-col gap-3">
