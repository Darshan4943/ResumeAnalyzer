            ...
            <View style={{ minHeight: 792, display: "flex", flexDirection: "column", gap: 16 }}>
                <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", }}>
                    ...
                    <View style={{ display: "flex", flexDirection: "column", gap: 2, alignItems: "flex-end" }}>
                        <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#4D4D4D" }}>johndoe.com</Text>
                        <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#4D4D4D" }}>hello@johndoe.com</Text>
                        <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#4D4D4D" }}>(310) 555 - 9572</Text>
                    </View>
                </View>
                <View style={{ width: "100%", height: 1, backgroundColor: "#DEDEDE" }}></View>
                <View style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 500`, color: "#D4D4D4", }}>SKILLS</Text>
                    <View style={{ display: "flex", flexWrap: "wrap" }}>
                        {data?.skills?.map((detail, index) => (
                            <View key={index} style={{ flex: "25%", display: "flex", justifyContent: "space-between", fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#D4D4D4", }}>
                                {detail}
                            </View>
                        ))}
                    </View>
                ...
                <View style={{ width: "100%", height: 1, backgroundColor: "#DEDEDE" }}></View>
                <View style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 500`, color: "#4D4D4D" }}>EXPERIENCE</Text>
                        ...
                        {data?.experience?.map((detail, index) => (
                            <View key={index} style={{ gap: 6, display: "flex", flexDirection: "column" }}>
                                ...
                                <View style={{ display: "flex", justifyContent: "space-between" }}>
                                    <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#4D4D4D" }}>January 2018 — Present</Text>
                                    <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#989898" }}>Palo Alto, CA</Text>
                                </View>
                                <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#4D4D4D" }}>
                ...
                <View style={{ width: "100%", height: 1, backgroundColor: "#DEDEDE" }}></View>
                <View style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 500`, color: "#4D4D4D" }}>EDUCATION</Text>
                ...
                <View style={{ width: "100%", height: 1, backgroundColor: "#DEDEDE" }}></View>
                <View style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 500`, color: "#4D4D4D" }}>CERTIFICATION</Text>
                    <View style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <View style={{ display: "flex", flexDirection: "row", gap: 16 }}>
                    <View style={{ display: "flex", flexDirection: "column", width: "50%", gap: 12 }}>
                        <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 500`, color: "#4D4D4D" }}> HOBBIES</Text>
                        <View style={{ display: "flex", gap: 4 }}>
                            {data?.hobbies?.map((detail, index) => (
                                <Text key={index} style={{ fontSize: 12, fontFamily: `${selectedFont} 500`, color: "#4D4D4D" }}>
                                    {detail.hobbies}
                                </Text>
                            ))}
                        </View>
                    ...
                    <View style={{ display: "flex", flexDirection: "column", width: "50%", gap: 12 }}>
                        <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#4D4D4D" }}>LANGUAGES</Text>
                        <View style={{ display: "flex", gap: 4 }}>
                            {data?.languages?.map((detail, index) => (
                                <Text key={index} style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#4D4D4D" }}>
                                    {detail.languages}
                                </Text>
                            ))}
                        </View>
