      ...
      <View style={{ minHeight: "769px", width: "100%", display: "flex", flexDirection: "row", justifyContent: "space-between", }}>
        <View style={{ width: 294, gap: 16 }} >
          <View style={{ flexDirection: "column", backgroundColor: "#B3977F", paddingVertical: 12, paddingLeft: 22 }}>
            <Text style={{  fontFamily:'Inter 400', fontSize: 36, color: "#414042" }}>{data.firstName ? <>{data.firstName}</> : <>First Name</>} </Text>
            <Text style={{ fontFamily:'Inter 400', fontSize: 36, color: "#414042" }}>{data.lastName ? <>{data.lastName}</> : <>Last Name</>}</Text>
            <Text style={{  fontFamily:'Inter 400',fontSize: 12, color: "#414042" }}>{data.designation ? <>{data.designation}</> : <>Designation</>}</Text>
          </View>
          <View style={{ flexDirection: "column", gap: 12 }}>
            <Text style={{  fontFamily:'Inter 400', fontSize: 12, color: "#B3977F" }}>PROFILE</Text>
            <View style={{ width: "100%", height: 1, backgroundColor: "#B3977F" }}></View>
            <Text style={{  fontFamily:'Lato 400', fontSize: 9, color: "#B3977F" }}>{data.summery ? (<>{data.summery}</>) :( <>About</>)}</Text>
          </View>
          <View style={{ flexDirection: "column", gap: 12 }}>
            <Text style={{  fontFamily:'Inter 400', fontSize: 12, color: "#B3977F" }}>EXPERIENCE</Text>
            <View style={{ width: "100%", height: 1, backgroundColor: "#B3977F" }}></View>
            <View style={{ flexDirection: "column", gap: 8 }}>
              <View style={{ flexDirection: "column", gap: 16 }}>
                {data?.experience?.map((detail, index) => (
                  <View style={{ flexDirection: "column", gap: 8 }}>
                    <View>
                      <Text style={{  fontFamily:'Lato 700', fontSize: 10, color: "#58595B" }}>{detail.duration?.start?.year}-{detail.currentlyWorking ? "Present" : detail.duration?.end?.year}</Text>
                      <Text style={{  fontFamily:'Lato 700', fontSize: 10, color: "#58595B" }}>{detail.designation ? (<>{detail.designation}</>) : (<>Designation</>)}</Text>
                      <Text style={{  fontFamily:'Lato 400', fontSize: 10, color: "#58595B" }}>{detail.organization ? (<>{detail.organization}</>) : (<>organization</>)} / {detail.location ? (<>{detail.location}</>) : (<>location</>)}</Text>
                    </View>
                    <View>
                      <Text style={{  fontFamily:'Lato 400', fontSize: 10, color: "#58595B" }}>{detail.description ? (<>{detail.description}</>) : (<>Description</>)}</Text>
                    </View>
                  </View>
                ))}
              </View>
          ...
          <View style={{ width: "100%", gap: 4 }}>
            <Text style={{ fontSize: 12,  fontFamily:'Inter 400',}}>SKILLS</Text>
        ...
        <View style={{ width: 193, flexDirection: "column", gap: 16, }}>
          <View style={{ flexDirection: "column", gap: 8 }}>
            <Text style={{  fontFamily:'Inter 400', fontSize: 12, color: "#B3977F" }}>CONTACT</Text>
          ...
          <View style={{ flexDirection: "column", gap: 8 }}>
            <View style={{ flexDirection: "row", gap: 8 }}>
              ...
              <Text style={{  fontFamily:'Lato 400', fontSize: 10, color: "#58595B" }}>{data.mobileNumber ? (<>{data.mobileNumber}</>) : (<>Your Phone</>)}</Text>
            </View>
            <View style={{ width: 193, height: 1, backgroundColor: "#B3977F" }}></View>
            <View style={{ flexDirection: "row", gap: 8 }}>
              <Svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Text style={{ fontFamily:'Lato 400', fontSize: 10, color: "#58595B" }}>{data.email ? <>{data.email}</> : <>Your Email</>}</Text>
            </View>
            <View style={{ width: 193, height: 1, backgroundColor: "#B3977F" }}></View>
            <View style={{ flexDirection: "row", gap: 8 }}>
              <Svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Text style={{ fontFamily:'Lato 400', fontSize: 10, color: "#58595B" }}>{data.sociaLinks ? <>{data.sociaLinks}</> : <>Your Websites</>}</Text>
            </View>
            <View style={{ width: 193, height: 1, backgroundColor: "#B3977F" }}></View>
            <View style={{ flexDirection: "row", gap: 8 }}>
              <Svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Text style={{ fontFamily:'Lato 400', fontSize: 10, color: "#58595B" }}>{data.location ? <>{data.location}</> : <>Your Address</>}</Text>
            </View>
            <View style={{ width: 193, height: 1, backgroundColor: "#B3977F" }}></View>
          </View>
          ...
          <View style={{ flexDirection: "column", gap: 16, width: "100%", }}>
            <View style={{ flexDirection: "column", gap: 8 }}>
              <Text style={{  fontFamily:'Inter 400', fontSize: 12, color: "#B3977F" }}>EDUCATION</Text>
              <View style={{ width: "100%", height: 1, backgroundColor: "#B3977F" }}></View>
            </View>
            <View style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              {data?.education?.map((detail, index) => (
                <View style={{ flexDirection: "column", gap: 8 }}>
                  <Text style={{  fontFamily:'Lato 700', fontSize: 10, color: "#58595B" }}>{detail.duration?.start?.year}-{detail.duration?.end?.year}</Text>
                  <Text style={{  fontFamily:'Lato 700', fontSize: 10, color: "#58595B" }}>{detail.qualification}</Text>
                  <Text style={{  fontFamily:'Lato 400', fontSize: 10, color: "#58595B" }}>{detail.instituteName} - {detail.location}</Text>
                </View>
              ))}
            </View>
          </View>
          <View style={{ flexDirection: "column", gap: 8 }}>
            <Text style={{  fontFamily:'Inter 400', fontSize: 12, color: "#B3977F" }}>HOBBIES</Text>
            <View style={{ width: "100%", height: 1, backgroundColor: "#B3977F" }}></View>
          </View>
          ...
          <View style={{ flexDirection: "column", width: "100%", alignItems: "flex-start", gap: 8 }}>
            <Text style={{ fontSize: 12,  fontFamily:'Inter 400', color: "#B3977F" }}>LANGAUGES</Text>
            <View style={{ width: "100%", height: 1, backgroundColor: "#B3977F" }}></View>
                    ...
                    return (
                      <View style={{ width: "100%", flexDirection: "column" }} key={index}>
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                          <Text style={{ color: "#58595B", fontSize: 10, width: 80, fontFamily:'Lato 400', }}>
                            {detail.languages}
                          </Text>
