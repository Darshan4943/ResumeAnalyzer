      ...
      <View style={{ minHeight: "769px", width: "100%", display: "flex", flexDirection: "row", justifyContent: "space-between", }}>
        <View style={{ width: 294, gap: 16 }} >
          <View style={{ flexDirection: "column", backgroundColor: "#B3977F", paddingVertical: 12, paddingLeft: 22 }}>
            <Text style={{  fontFamily: `${selectedFont} 400`, fontSize: 36, color: "#414042" }}>{data.firstName ? <>{data.firstName}</> : <>First Name</>} </Text>
            <Text style={{ fontFamily: `${selectedFont} 400`, fontSize: 36, color: "#414042" }}>{data.lastName ? <>{data.lastName}</> : <>Last Name</>}</Text>
            <Text style={{  fontFamily: `${selectedFont} 400`,fontSize: 12, color: "#414042" }}>{data.designation ? <>{data.designation}</> : <>Designation</>}</Text>
          </View>
          <View style={{ flexDirection: "column", gap: 12 }}>
            <Text style={{  fontFamily: `${selectedFont} 400`, fontSize: 12, color: "#B3977F" }}>PROFILE</Text>
            <View style={{ width: "100%", height: 1, backgroundColor: "#B3977F" }}></View>
            <Text style={{  fontFamily: `${selectedFont} 400`, fontSize: 9, color: "#B3977F" }}>{data.summery ? (<>{data.summery}</>) :( <>About</>)}</Text>
          </View>
          <View style={{ flexDirection: "column", gap: 12 }}>
            <Text style={{  fontFamily: `${selectedFont} 400`, fontSize: 12, color: "#B3977F" }}>EXPERIENCE</Text>
            <View style={{ width: "100%", height: 1, backgroundColor: "#B3977F" }}></View>
        ...
        <View style={{ width: 193, flexDirection: "column", gap: 16, }}>
          <View style={{ flexDirection: "column", gap: 8 }}>
            <Text style={{  fontFamily: `${selectedFont} 400`, fontSize: 12, color: "#B3977F" }}>CONTACT</Text>
          ...
          <View style={{ flexDirection: "column", gap: 16, width: "100%", }}>
            <View style={{ flexDirection: "column", gap: 8 }}>
              <Text style={{  fontFamily: `${selectedFont} 400`, fontSize: 12, color: "#B3977F" }}>EDUCATION</Text>
              <View style={{ width: "100%", height: 1, backgroundColor: "#B3977F" }}></View>
            </View>
          ...
          <View style={{ flexDirection: "column", gap: 8 }}>
            <Text style={{  fontFamily: `${selectedFont} 400`, fontSize: 12, color: "#B3977F" }}>HOBBIES</Text>
            <View style={{ width: "100%", height: 1, backgroundColor: "#B3977F" }}></View>
          </View>
          ...
          <View style={{ flexDirection: "column", width: "100%", alignItems: "flex-start", gap: 8 }}>
            <Text style={{ fontSize: 12,  fontFamily: `${selectedFont} 400`, color: "#B3977F" }}>LANGAUGES</Text>
            <View style={{ width: "100%", height: 1, backgroundColor: "#B3977F" }}></View>
