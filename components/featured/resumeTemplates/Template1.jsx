  ...
  return (
    <Page size="A4" style={{ padding: 24 }}>
      <View style={{ flexDirection: 'column' }}>
        <View style={{ flexDirection: 'row', paddingBottom: "24px", justifyContent: "space-between" }}>
          <View style={{ flexDirection: 'col', gap: 4 }}>
            <View>
              <Text style={{ color: '#414042', fontSize: 43, fontFamily: "Inter 400" }}>
                {data.firstName}
              </Text>
              <Text style={{ color: '#414042', fontSize: 43, fontFamily: 'Inter 400' }}>
                {data.lastName}
            ...
            <Text style={{ color: '#414042', fontFamily: 'Inter 400' }}>
              {data.designation}
            </Text>
          </View>
        ...
        <View style={{ flexDirection: 'row' }}>
                ...
                <View style={{ flexDirection: "column", gap: 20 }}>
                  {data.education.map((detail, index) => (
                    <View key={index} style={{ flexDirection: 'column', gap: "12px" }}>
                      <View >
                        <Text style={{ color: '#414042', fontSize: 12, fontFamily: 'Lato 700', lineHeight: 1.2 }}>
                      ...
                      <View style={{ flexDirection: "column", gap: 2 }}>
                        <View style={{ width: 16, height: 1, backgroundColor: '#414042' }} />

                        <View style={{}}>
                          <Text style={{ color: '#414042', fontSize: 8.962, fontFamily: 'Lato 400', lineHeight: 1 }}>
              ...
              <View style={{ flexDirection: 'column', gap: 12 }}>
                ...
                <View style={{ flexDirection: 'column', gap: 12 }}>
                  {data.skills.map((detail, index) => (
                    <View key={index}>
                      <View>
                        <Text style={{ color: '#414042', fontSize: '12px', fontFamily: 'Inter 400', }}>
                          {detail.skill}
                        </Text>
                      </View>
          ...
          <View style={{ width: "65%", flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', paddingTop: "24px", gap: "36px", paddingLeft: 24 }}>
            ...
            <View style={{ flexDirection: 'column', width: "100%", color: '#414042', gap: 12 }}>
              ...
              <Text wrap={true} style={{ color: '#6D6E71', fontSize: '12px', lineHeight: "2px", fontFamily: 'Lato 400', }}>
                {data.summery}
              </Text>
            </View>
              ...
              {data.experience.map((detail, index) => (
                <View key={index} style={{ flexDirection: 'column', gap: 4, }} >
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: "space-between", width: "100%" }}>
                    <Text style={{ color: '#414042', fontSize: 12, fontFamily: 'Lato 400', lineHeight: 1.2 }}>
                      {detail.organization}
                    </Text>
                    <View style={{}}>
                      <Text style={{ color: '#414142', fontSize: 10, fontFamily: 'Lato 400', lineHeight: 1 }}>
                        {detail.duration?.end?.year &&
                          `${detail.duration?.start?.year}-${detail.duration?.end?.year}`
                        }
                      </Text>
                  ...
                  <View style={{ width: "100%" }}>
                    <Text style={{ color: '#A7A9AC', fontSize: 12, fontFamily: 'Inter 400' }}>
                      {detail.description}
                    </Text>
            ...
            <View style={{ flexDirection: 'column', }}>
              <View style={{ flexDirection: 'column', gap: 12 }}>
                <Text style={{ color: '#414042',fontFamily:"Inter 400", fontSize: '16px' }}>
                  HOBBIES
                </Text>
                <Svg width={141} height={4} viewBox="0 0 141 4" >
                  <Path d="M140.396 1.72095H0.209961V2.72095H140.396V1.72095Z" fill="#A7A9AC" />
                ...
                <View style={{ flexDirection: 'col', gap: "12px" }}>
                  {data.hobbies.map((detail, index) => (
                    <View key={index}>
                      <View>
                        <Text style={{ color: '#414042',fontFamily:"Lato 400", fontSize: '12px' }}>
                          {detail.title}
                        </Text>
                      </View>
                    </View>
