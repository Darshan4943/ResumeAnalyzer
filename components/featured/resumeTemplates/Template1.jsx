      ...
      <View style={{ flexDirection: 'column' }}>
        <View style={{ flexDirection: 'row', paddingBottom: "24px", justifyContent: "space-between" }}>
          <View style={{ flexDirection: 'col', gap: 4 }}>
            <View>
              <Text style={{ color: '#414042', fontSize: 43, fontFamily: `${selectedFont} 400` }}>
                {data.firstName}
              </Text>
              <Text style={{ color: '#414042', fontSize: 43, fontFamily: `${selectedFont} 400` }}>
                {data.lastName}
            ...
            <Text style={{ color: '#414042', fontFamily: `${selectedFont} 400` }}>
              {data.designation}
            </Text>
          </View>
        ...
        <View style={{ flexDirection: 'row' }}>
                  ...
                  {data.education.map((detail, index) => (
                    <View key={index} style={{ flexDirection: 'column', gap: "12px" }}>
                      ...
                      <View style={{ flexDirection: "column", gap: 2 }}>
                        ...
                        <View style={{}}>
                          <Text style={{ color: '#414042', fontSize: 8.962, fontFamily: `${selectedFont} 400`, lineHeight: 1 }}>
          ...
          <View style={{ width: "65%", flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', paddingTop: "24px", gap: "36px", paddingLeft: 24 }}>
            ...
            <View style={{ flexDirection: 'column', width: "100%", color: '#414042', gap: 12 }}>
              ...
              <Text wrap={true} style={{ color: '#6D6E71', fontSize: '12px', lineHeight: "2px", fontFamily: `${selectedFont} 400`, }}>
                {data.summery}
              </Text>
            </View>
              ...
              {data.experience.map((detail, index) => (
                <View key={index} style={{ flexDirection: 'column', gap: 4, }} >
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: "space-between", width: "100%" }}>
                    <Text style={{ color: '#414042', fontSize: 12, fontFamily: `${selectedFont} 400`, lineHeight: 1.2 }}>
                      {detail.organization}
                    </Text>
                    <View style={{}}>
                      <Text style={{ color: '#414142', fontSize: 10, fontFamily: `${selectedFont} 400`, lineHeight: 1 }}>
                        {detail.duration?.end?.year &&
                          `${detail.duration?.start?.year}-${detail.duration?.end?.year}`
                        }
                      </Text>
                  ...
                  <View style={{ width: "100%" }}>
                    <Text style={{ color: '#A7A9AC', fontSize: 12, fontFamily: `${selectedFont} 400` }}>
                      {detail.description}
                    </Text>
