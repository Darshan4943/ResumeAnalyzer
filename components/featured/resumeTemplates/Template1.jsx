        ...
        <View style={{ flexDirection: 'column' }}>
          <View style={{ flexDirection: 'row', paddingBottom:"24px", justifyContent: "space-between" }}>
            <View style={{ flexDirection: 'col', gap: 2 }}>
              ...
              <Text style={{ color: '#414042', fontWeight: '400' }}>
                {data.designation}
              </Text>
            </View>
          ...
          <View style={{ flexDirection: 'row' }}>
            <View style={{ flexDirection: 'column', width: "35%", gap: "24px" }}>
              <View style={{ flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', paddingTop: "24px", gap: "8px" }}>
                <Text style={{ color: '#414042', fontSize: '16px' }}>
                  CONTACT
                </Text>
                <Svg width={141} height={4} viewBox="0 0 141 4" style={{ marginBottom: 10 }}>
                ...
                <View style={{ flexDirection: 'column', gap: "12px", alignItems: 'flex-start' }}>
                  <View style={{ height: 24, flexDirection: 'row', alignItems: 'center', gap: "8px" }}>
                    ...
                    <Text style={{ color: '#414042', fontSize: '12px' }}>
                      {data.mobileNumber}
                    </Text>
                  </View>
                  <View style={{ height: 24, flexDirection: 'row', alignItems: 'center', gap: "8px" }}>
              ...
              <View style={{ flexDirection: 'column', }}>
                <View style={{ flexDirection: 'column', gap: "20px" }}>
                  ...
                  {data.education.map((detail, index) => (
                    <View key={index}>
                      <View>
                        <Text style={{ color: '#414042', fontSize: 12, fontWeight: '700', lineHeight: 1.2 }}>
                      ...
                      <View style={{ paddingTop: 11.49 }}>
                        <View style={{ width: 16, height: 1, backgroundColor: '#414042' }} />
                      </View>
                      <View style={{ paddingTop: 1.81 }}>
                        <Text style={{ color: '#414042', fontSize: 8.962, fontWeight: '500', lineHeight: 1 }}>
              ...
              <View style={{ flexDirection: 'column', }}>
                <View style={{ flexDirection: 'column', gap: "20px" }}>
                  ...
                  <View style={{ flexDirection: 'col', gap: "8px" }}>
            ...
            <View style={{ width: "65%", flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', paddingTop: "24px", gap: "24px", paddingLeft: 24 }}>

              <View style={{ flexDirection: 'column', width: "100%", color: '#414042', fontSize: '12px', gap: 8 }}>
                <Text style={{ color: '#414042', fontSize: '16px' }}>
                  ABOUT ME
                </Text>
                <Text wrap={true} style={{ color: '#414042', fontSize: '12px', }}>
                  {data.summery}
                </Text>
              </View>
                ...
                {data.experience.map((detail, index) => (
                  <View key={index} style={{ flexDirection: 'column', gap: 8, }} >
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: "space-between", width: "100%" }}>
                      ...
                      <View style={{}}>
                        <Text style={{ color: '#414042', fontSize: 10, fontWeight: '500', lineHeight: 1 }}>
                          {detail.duration?.end?.year &&
                            `${detail.duration?.start?.year}-${detail.duration?.end?.year}`
                          }
                        </Text>
                    ...
                    <View style={{ width: "100%" }}>
                      <Text style={{ color: '#414042', fontSize: 12, fontWeight: '500' }}>
                        {detail.description}
                      </Text>
