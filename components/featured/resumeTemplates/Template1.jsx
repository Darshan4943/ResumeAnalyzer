...
function Template1({ data }) {
  ...
  useEffect(() => {
    const dataForSecondPage = { education: [] };
    ...
    if (educationContainer.current) {
      [...data?.education, ...data?.education, ...data?.education]?.forEach(
        (detail, index) => {
    ...
    console.log(remainingHeightLeft);
  }, [data]);

  // console.log(data)
  return (
    <>
      <div className=" h-[842px] pt-[10px] pr-[26px] pl-[21px] w-[800px] flex flex-col bg-[#fff]">
        <div
        ...
        <div className="flex">
          <div className="flex flex-col pl-[21px] w-[295px]  ">
            ...
            <div className="flex flex-col items-start justify-start pt-[24px] gap-[16px] h-[504px]">
              <div>
                {" "}
                <p className="text-[#414042] font-inter font-[400px] text-[22px] ">
                  Education
