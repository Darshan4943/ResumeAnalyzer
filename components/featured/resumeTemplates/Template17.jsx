    ...
    <Page size="A4" style={{paddingVertical: 24}}>
      ...
      <View style={{backgroundColor:"#D1D2D3" ,height:"24px",width:"100%",}}></View>
        ...
        <View style={{ width: 595, flexDirection: 'row', gap: 20, paddingLeft: 20 }}>
...

                {
                  data.experience?.map((detail, index) => (
                    <>
                      ...
                      <Text style={{ fontSize: 10, fontWeight: "700", color: '#2C363D' }}>   {detail.organization} -    {detail.designation}</Text>
                      <Text style={{ fontSize: 10, fontWeight: "600", color: '#2C363D' }}>
                        {" "}
          ...
          <View style={{ width: 150, flexDirection: 'column', gap: 12 }}>
            <View style={{ maxWidth: 150, flexDirection: 'column', gap: 8 }}>
              <Text style={{ fontSize: 14, fontWeight: 500, color: '#282627' }}>ABOUT ME</Text>
              <Text style={{ fontSize: 14, fontWeight: 400, color: '#6D6E71' }}>{data.summery}</Text>
