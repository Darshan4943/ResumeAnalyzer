...
function Template33({ data,selectedColor,selectedFont  }) {
            ...
            <View style={{ flexDirection: 'row' }}>
                    ...
                    <View style={{ flexDirection: "column", minHeight: "841.7px", height: "100%", backgroundColor: "#414042", gap: "18px", }}>
                        ...
                        <View style={{ display: "flex", flexDirection: "column", gap: "8" }}>
                            <View style={{ padding: "8px 24px", backgroundColor: "#4E4C51", marginTop: "4px", alignItems: "center", justifyContent: "center", flexDirection: "row", width: "230px" }}>
                                ...
                                <Text style={{ color: "white", fontFamily: `${selectedFont} 500`, }}>CONTACT</Text>
                            ...
                            {data?.mobileNumber && (
                                <View style={{ flexDirection: "row", gap: "12px", justifyContent: "start", alignItems: "center", marginLeft: "24px", paddingRight: " 4px", paddingTop: "5px" }}>
                                    ...
                                    <Text style={{ fontSize: "10px", paddingTop: "2px", flexDirection: "row", fontFamily: `${selectedFont} 300`, color: "#fff", }}>{data.mobileNumber}</Text>
                                </View>
                            )}
                            {data?.email && (
                                <View style={{ flexDirection: "row", breakAll: true, gap: "12px", justifyContent: "start", alignItems: "center", marginLeft: "24px", paddingRight: " 4px" }}>
                                    ...
                                    <Text style={{ fontSize: "10px", width: '80%', paddingTop: "2px", flexDirection: "row",fontFamily: `${selectedFont} 300`, color: "#fff", }}>{data.email}</Text>
                                </View>
                            )}
                        ...
                        <View style={{ flexDirection:"row", fontSize: "11px", paddingTop: "2px", fontWeight: 400, color: "#fff", }}>{data.sociaLinks}</View>
                            ...
                            {data?.location && (
                                <View style={{ flexDirection: "row", breakAll: true, justifyContent: "start", gap: "12px", alignItems: "center", marginLeft: "24px", paddingRight: " 4px" }}>
                                    ...
                                    <Text style={{ fontSize: "10px", flexDirection: "row", fontFamily: `${selectedFont} 300`, color: "#fff", }}>{data.location}</Text>
                                </View>
                            )}
                        </View>
                        ...
                        {data?.skills?.length > 0 && (
                            <>
                                <View style={{ padding: "8px 24px", backgroundColor: "#4E4C51", marginTop: "4px", alignItems: "center", justifyContent: "center", flexDirection: "row", width: "230px" }}>
                                    ...
                                    <Text style={{fontFamily: `${selectedFont} 500`, color: "white" }}>SKILLS</Text>
                        ...
                        {data?.languages?.length > 0 && (
                            <>
                                <View style={{ padding: "8px 24px", backgroundColor: "#4E4C51", marginTop: "4px", alignItems: "center", justifyContent: "center", flexDirection: "row", width: "230px" }}>
                                    ...
                                    <Text style={{ fontFamily: `${selectedFont} 500`,color: "white" }}>LANGUAGES</Text>
                ...
                <View style={{ width: "365px", display: "flex", flexDirection: "column", gap: "36px" }}>
                    <View style={{ display: "flex", backgroundColor: "#4E4C51", padding: 42, marginTop: 36 }}>
                        <Text style={{ color: "#fff", fontFamily: `${selectedFont} 600`, fontSize: "26px", }}>{data.firstName} {data.lastName}</Text>

                        <Text style={{ fontSize: "18px", fontFamily: `${selectedFont} 300`, color: "#EDEDED" }}>{data.designation}</Text>
                    </View>
                    <View style={{ paddingHorizontal: 36, flexDirection: "column", gap: 36, }}>
                        <View style={{ display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-start" }}>
                            <View style={{ display: "flex", flexDirection: "row", gap: 8, alignItems: "center", width: "100%" }}>
                                ...
                                <Text style={{ color: "#282829", fontFamily: `${selectedFont} 500`, fontSize: "18px" }}>About me</Text>
                            ...
                            <View style={{}}>
                                <Text style={{ color: "#636166", fontSize: "12px", fontFamily: `${selectedFont} 300`, }}>{data.summery}</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>
                            <View style={{ display: "flex", flexDirection: "row", gap: 8, alignItems: "center", width: "100%" }}>
                                ...
                                <Text style={{ color: "#282829", fontFamily: `${selectedFont} 500`, fontSize: "18px" }}>EDUCATION</Text>
                                ...
                                {data?.education?.map((detail, index) => (
                                    ...
                                    <View key={index} style={{ flexDirection: "row", alignItems: "start", gap: 8 }}>
                                        ...
                                        <View style={{ display: "flex", flexDirection: "column", gap: 8, }}>
                                            ...
                                            <Text style={{ color: "#414042", fontSize: "12px",  fontFamily: `${selectedFont} 500`, }}>{detail.instituteName}</Text>


                                            <Text style={{ color: "#414042", fontSize: "12px",  fontFamily: `${selectedFont} 500`, }}>{detail.duration?.start?.year}-{detail.duration?.end?.year}</Text>



                                            <Text style={{ color: "#787879", fontSize: "12px",  fontFamily: `${selectedFont} 500`,}}>{detail.qualification} - {detail.specialization}</Text>
                        ...
                        <View style={{ display: "flex", flexDirection: "row", gap: 8, width: "100%" }}>
                            ...
                            <View style={{ display: "flex", flexDirection: "column", gap: 16, width: "100%" }}>
                                <View style={{ display: "flex", flexDirection: "row", gap: 8, alignItems: "center", width: "100%" }}>
                                    ...
                                    <Text style={{ color: "#282829",  fontFamily: `${selectedFont} 500`, fontSize: "18px" }}>EXPERIENCE</Text>
                                    ...
                                    {data?.experience?.map((detail, index) => (
                                        ...
                                        <View key={index} style={{ flexDirection: "row", alignItems: "start", gap: 8 }}>
                                            ...
                                            <View style={{ display: "flex", flexDirection: "column", gap: 8, }}>
                                                ...
                                                <Text style={{ color: "#414042", fontSize: "12px", fontFamily: `${selectedFont} 500`, }}>{detail.organization}</Text>


                                                <Text style={{ color: "#414042", fontSize: "12px",  fontFamily: `${selectedFont} 500`,}}>{detail.duration?.start?.year}-{" "}{detail.currentlyWorking ? "Present" : detail.duration?.end?.year}</Text>



                                                <Text style={{ color: "#787879", fontSize: "12px",  fontFamily: `${selectedFont} 300`,}}>{detail.description}</Text>
