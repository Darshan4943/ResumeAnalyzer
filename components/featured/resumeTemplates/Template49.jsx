  ...
  return (
    <Page size="A4" style={{ padding: 24 }}>
      <View style={{ minHeight: 793.8 }}>
        ...
        <View style={{ display: "flex", flexDirection: "row", gap: 16, paddingVertical: 8, justifyContent: "space-between", marginTop: 24, borderBottom: "1px dashed #414042" }}>
        ...
        <View style={{ paddingTop: 16, gap: 24, display: "flex", flexDirection: "row" }}>
                ...
                {data?.experience?.map((detail, index) => (
                  <View style={{ display: "flex", flexDirection: "row", gap: 16 }}>
                    <Svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <Path d="M2.99999 6C1.34517 6 0 4.65382 0 3C0 1.34618 1.34517 0 2.99999 0C4.65482 0 6 1.34518 6 3C6 4.65482 4.65381 6 2.99999 6ZM2.99999 0.502679C1.62265 0.502679 0.502681 1.62266 0.502681 3C0.502681 4.37734 1.62265 5.49732 2.99999 5.49732C4.37734 5.49732 5.49732 4.37734 5.49732 3C5.49732 1.62266 4.37734 0.502679 2.99999 0.502679Z" fill="#58595B" />
                    </Svg>

                    {index !== data.education.length - 1 && (
                      <View style={{ width: "1px", backgroundColor: "#58595B", height: "100%", marginLeft: -20, marginTop: 6 }}>
                      </View>
                    )}
                    <View style={{ display: "flex", flexDirection: "column", gap: 4 }}>
