  ...
  return (
    <Page size="A4">
        <View style={{width:595}}>
          ...
          <View style={{width:595,height:150,backgroundColor:"#F1F2F2",paddingHorizontal:68,paddingVertical:18,display:"flex",flexDirection:"row",justifyContent:"space-between"}}>
           ...
           <Text style={{ fontWeight: 600, fontSize: 32, color: "#27AAE1" }}>JAMES</Text>
           <Text style={{ fontWeight: 400, fontSize: 32, color: "#414042" }}>SMITH</Text>
           <Text style={{ fontWeight: 400, fontSize: 14, color: "#58595B" }}>Digital Marketing Expert</Text>
           </View>
          </View>

          <View style={{display:"flex",flexDirection:"row",gap:17,paddingVertical:8,paddingHorizontal:24}}>
...
<Path d="M13.995 11.4698C14.0205 11.6654 13.961 11.8345 13.8175 11.9781L12.1282 13.6561C12.0517 13.7411 11.9526 13.8129 11.8298 13.8725C11.7071 13.932 11.5862 13.9698 11.4682 13.9868C11.4597 13.9868 11.4342 13.9887 11.3917 13.9934C11.3492 13.9981 11.2945 14 11.2265 14C11.0659 14 10.8053 13.9726 10.4456 13.9169C10.0849 13.8621 9.64486 13.726 9.12458 13.5096C8.6043 13.2933 8.0132 12.9692 7.35223 12.5374C6.69126 12.1057 5.98873 11.5114 5.24278 10.7584C4.64979 10.1735 4.15878 9.6142 3.76881 9.08038C3.37978 8.54657 3.06629 8.05337 2.82834 7.59987C2.59133 7.14636 2.41382 6.73537 2.29484 6.3669C2.17681 5.99842 2.0956 5.68097 2.05311 5.41358C2.01062 5.1462 1.99363 4.9374 2.00212 4.78434C2.01062 4.63223 2.0144 4.5472 2.0144 4.53019C2.0314 4.41115 2.06917 4.29115 2.12865 4.16738C2.18814 4.04456 2.2599 3.94536 2.34489 3.86883L4.03414 2.17761C4.15218 2.05951 4.28815 2 4.44111 2C4.55159 2 4.64885 2.03117 4.73289 2.09447C4.81787 2.15777 4.88963 2.2362 4.94912 2.32974L6.30883 4.91C6.38532 5.0451 6.40609 5.19345 6.3721 5.35501C6.33811 5.51563 6.26634 5.65167 6.15587 5.76127L5.53361 6.38391C5.51661 6.40092 5.5015 6.42831 5.48923 6.46705C5.47601 6.50484 5.47034 6.53696 5.47034 6.56247C5.50434 6.7401 5.57988 6.94324 5.69885 7.17188C5.80083 7.37501 5.95758 7.62349 6.16909 7.91638C6.3806 8.20833 6.68181 8.54563 7.07084 8.92638C7.45137 9.31659 7.7913 9.61893 8.08685 9.83529C8.38335 10.0507 8.63074 10.2104 8.82997 10.3124C9.02921 10.4135 9.18123 10.4759 9.28699 10.4967L9.44562 10.5288C9.46262 10.5288 9.49 10.5222 9.52872 10.5099C9.56649 10.4976 9.59387 10.4825 9.61181 10.4655L10.336 9.72853C10.489 9.59342 10.6665 9.52539 10.8695 9.52539C11.0131 9.52539 11.1283 9.5509 11.2123 9.60192H11.2255L13.6777 11.0513C13.8553 11.1599 13.961 11.2997 13.995 11.4698Z" fill="#414042"/>
           ...
           <Text style={{ fontSize: 10, fontWeight: 500, color: "#414042" }}>000 111 222 333</Text>
           </View>
           <View style={{display:"flex",flexDirection:"row",gap:6,justifyContent:"center",alignItems:"center"}}>
           <Svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<Path d="M14 11.0004C14 11.2634 13.9261 11.5074 13.8077 11.722L10.0188 7.48225L13.7664 4.20252C13.9118 4.43378 14 4.70557 14 4.99961V11.0004ZM7.9996 8.25232L13.2141 3.68914C13.0003 3.57153 12.7588 3.5 12.4989 3.5H3.4995C3.23886 3.5 2.99808 3.57153 2.78511 3.68914L7.9996 8.25232ZM9.45381 7.97655L8.24674 9.03351C8.17601 9.0947 8.08781 9.12569 7.9996 9.12569C7.9114 9.12569 7.82319 9.09471 7.75247 9.03272L6.54539 7.97577L2.70883 12.2695C2.93848 12.4134 3.20866 12.5 3.5003 12.5H12.5005C12.7921 12.5 13.0615 12.4134 13.2912 12.2695L9.45381 7.97655ZM2.23363 4.20331C2.08821 4.43457 2 4.70636 2 5.0004V11.0004C2 11.2634 2.07311 11.5074 2.1923 11.722L5.9804 7.48225L2.23363 4.20331Z" fill="#414042"/>
           ...
           <Text style={{ fontSize: 10, fontWeight: 500, color: "#414042" }}>jamessmith@mail.com</Text>
           </View >
           <View style={{display:"flex",flexDirection:"row",gap:6,justifyContent:"center",alignItems:"center"}}>
           <Svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<Path d="M7.9996 2C4.70101 2 2 4.70182 2 7.99961C2 11.2982 4.70101 14 7.9996 14C11.2982 14 14 11.2982 14 7.99961C14 4.70182 11.2982 2 7.9996 2ZM12.1397 5.60136H10.3986C10.2199 4.8226 9.91868 4.15986 9.55791 3.44229C10.6394 3.86027 11.601 4.58103 12.1397 5.60136ZM7.9996 3.2015C8.48036 3.91907 8.89914 4.70181 9.13992 5.60056H6.86007C7.10006 4.76061 7.51884 3.91907 7.9996 3.2015ZM3.37951 9.20192C3.25952 8.84115 3.20071 8.41996 3.20071 8.00039C3.20071 7.58161 3.25952 7.15965 3.37951 6.79888H5.41858C5.35978 7.22084 5.35978 7.58081 5.35978 8.00039C5.35978 8.41996 5.41858 8.77996 5.41858 9.20192H3.37951ZM3.85948 10.3994H5.60056C5.77856 11.1782 6.08052 11.8409 6.44129 12.5585C5.35978 12.1405 4.39905 11.4198 3.85948 10.3994ZM5.60056 5.60136H3.85948C4.46023 4.58103 5.35978 3.86027 6.44129 3.44229C6.08052 4.15986 5.77856 4.82181 5.60056 5.60136ZM7.9996 12.7993C7.51884 12.0809 7.10006 11.299 6.85928 10.4002H9.13913C8.89915 11.2402 8.48036 12.0809 7.9996 12.7993ZM9.37991 9.20192H6.62009C6.5589 8.77996 6.5001 8.41996 6.5001 8.00039C6.5001 7.58161 6.5589 7.22084 6.62009 6.79888H9.44189C9.5007 7.22084 9.5587 7.58081 9.5587 8.00039C9.55791 8.41917 9.4411 8.77996 9.37991 9.20192ZM9.55791 12.5593C9.91868 11.8997 10.2199 11.179 10.3986 10.4002H12.1397C11.601 11.4198 10.6394 12.1405 9.55791 12.5593ZM10.6394 9.20192C10.7006 8.77996 10.7006 8.41996 10.7006 8.00039C10.7006 7.58161 10.6394 7.22084 10.6394 6.79888H12.6777C12.7977 7.15965 12.8589 7.58081 12.8589 8.00039C12.8589 8.41996 12.7977 8.84115 12.6777 9.20192H10.6394Z" fill="#414042"/>
</Svg>

           <Text style={{ fontSize: 10, fontWeight: 500, color: "#414042" }}>www.jamessmith.com </Text>
           </View>
           <View style={{display:"flex",flexDirection:"row",gap:6,justifyContent:"center",alignItems:"center"}}>
            <Svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<Path d="M8.00008 1.14258C5.4786 1.14258 3.42773 3.17754 3.42773 5.67857C3.42773 6.68606 4.07596 8.32859 5.40994 10.7006C6.35297 12.3777 7.28136 13.7767 7.31981 13.8348L7.99916 14.8569L8.67851 13.8348C8.71788 13.7767 9.64535 12.3777 10.5884 10.7006C11.9224 8.3295 12.5706 6.68698 12.5706 5.67948C12.5724 3.17755 10.5215 1.14258 8.00008 1.14258ZM8.00008 8.00062C6.69082 8.00062 5.63059 6.94771 5.63059 5.6486C5.63059 4.34948 6.69173 3.29657 8.00008 3.29657C9.30842 3.29657 10.3705 4.34948 10.3705 5.6486C10.3705 6.9468 9.30934 8.00062 8.00008 8.00062Z" fill="#414042"/>
           ...
           <Text style={{ fontSize: 10, fontWeight: 500, color: "#414042" }}>123 Your Address here</Text>
           </View>
          </View>

          <View style={{width:546,paddingTop:16,paddingHorizontal:24,gap:24,display:"flex",flexDirection:"row"}}>
            ...
            <View style={{width:176,backgroundColor:"#00AEEF",height:1}}></View>
             ...
             <View>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>MyNameIsLauraAndersonloremempusidfringillamolestieornarediaminolestirosnollicitudinest,.molestium lorem olestie pretium apaza all the molestium lorem olestie pretium apaza all therosen. ringilla lorem ipsum .</Text>
            </View>
            </View> 

            <View style={{display:"flex",flexDirection:"column",gap:12}}>
             <View style={{display:"flex",flexDirection:"column",gap:4}}>
            <Text style={{ fontSize: 14, fontWeight: 400, color: "#383839" }}>Skills</Text>
            <View style={{width:176,backgroundColor:"#00AEEF",height:1}}></View>
            </View>

             <View style={{display:"flex",flexDirection:"column",gap:8}}>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>Graphic Design</Text>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>Web Design</Text>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>UI/UX Design</Text>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>Motion Graphics</Text>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>Illustrations</Text>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>Visual Effects</Text>
            </View>
            ...
            <View style={{width:176,backgroundColor:"#00AEEF",height:1}}></View>
             ...
             <View style={{display:"flex",flexDirection:"column",gap:8}}>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>Spanish</Text>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>English (International)</Text>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>French (Native)</Text>
            ...
            <View style={{width:176,backgroundColor:"#00AEEF",height:1}}></View>
             ...
             <View style={{display:"flex",flexDirection:"column",gap:8}}>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>Hiking</Text>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>Sketching</Text>
            <Text style={{ fontSize: 10, fontWeight: 400, color: "#58595B" }}>Gaming</Text>
...
<Path d="M10.4921 20.125C15.8079 20.125 20.1219 15.8157 20.1279 10.5C20.1338 5.18426 15.8294 0.875 10.5137 0.875C5.19794 0.875 0.883848 5.18426 0.877898 10.5C0.871948 15.8157 5.17639 20.125 10.4921 20.125Z" fill="#383839"/>
</Svg>
            ...
            <View style={{display:"flex",flexDirection:"column",gap:4}}>
              <View><Text style={{ fontWeight: 400, fontSize: 12, color: "#414142" }}>Senior Graphic Designer</Text></View>
              <View style={{display:"flex",flexDirection:"row",gap:2}}>
                <Text style={{ fontWeight: 400, fontSize: 10, color: "#414142",width:156 }}>Company Name | Location</Text>
                <Text style={{ fontWeight: 400, fontSize: 10, color: "#414142" }}>FEB 2020-PRESENT</Text>
                </View>
                <View><Text style={{ fontWeight: 400, fontSize: 10, color: "#58595B" }}>Sedut perspiciatis undemartana omnis bisiste natus error sit samandan tiumyu dolor emque laudatium, totamaman remaperi, eaque ipsa quae ab inventoreveritasi quasi.</Text>
</View>
...
<Path d="M17.0239 14.3908V10.1707C17.0239 10.1707 17.0265 9.97051 16.9086 10.0369C16.8139 10.0896 16.5816 10.2199 16.4989 10.2915C16.4043 10.3735 16.4258 10.559 16.4258 10.559V14.3908C16.4258 14.4452 16.3793 14.4711 16.3569 14.484C16.1418 14.6109 15.998 14.8447 15.998 15.1122C15.998 15.5151 16.3234 15.8413 16.7253 15.8413C17.1272 15.8413 17.4525 15.5151 17.4525 15.1122C17.4525 14.843 17.3071 14.6091 17.0911 14.4823C17.0687 14.4702 17.0239 14.4452 17.0239 14.3908Z" fill="white"/>
            ...
            <View>
            <View>
            <Text style={{ fontWeight: 400, fontSize: 12, color: "#414142" }}>Degree Name 1</Text>
            </View>
            <View style={{display:"flex",flexDirection:"row" ,justifyContent:"space-between"}}>
            <Text style={{ fontWeight: 400, fontSize: 10, color: "#414142" }}>Institute Name | Location</Text>
            <Text style={{ fontWeight: 400, fontSize: 10, color: "#414142" }}>Profile</Text>
            </View>
            </View>
