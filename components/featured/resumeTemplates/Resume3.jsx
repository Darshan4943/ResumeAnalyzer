...
function Resume3({ data, selectedColor, selectedFont, preview }) {
  ...
  const isEmpty = Object.values(secondPageData).every(
  ...
  const dataSeter = () => {
    ...
    if (experienceContainer.current) {
      [...data?.experience]?.forEach((detail, index) => {
        const parentDiv = document.createElement("div");
        parentDiv.innerHTML = `
        ...
        <div className={`w-[247px] bg-${selectedColor} `}>
          ...
          <div className=" pt-7 flex flex-col">
                  ...
                  {data.mobileNumber && (
                    <div className="gap-[7.83px] flex  ">
                      ...
                      <div className="text-white  text-[8.5px]  ">
                        <p className="object-contain pb-[12px]">
                          {data.mobileNumber}
                        </p>
                      </div>
                    </div>
            ...
            <div
              ...
              className="flex flex-col gap-5 pt-[24px] -ml-1 "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="260"
              ...
              <div className="flex flex-col gap-5 pl-[20px]"></div>
            </div>
            <div ref={skillContainer} className="">
              {data?.skills?.length > 0 && (
                <div className="pt-[30px]">
                  ...
                  <div className="flex flex-col px-[15.92px] pt-[20px] gap-[9.81px] "></div>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="w-[553px] pr-[20px] pb-[20px] ">
          <div ref={summaryContainer}>
            ...
            <div className="pl-[20px] pt-[40.78px]  h-auto flex flex-col gap-[5.64px] ">
              ...
              <p className="text-[#646464] f text-xs font-normal break-all"></p>
            </div>
          </div>
          ...
          <div className=" flex flex-col gap-8 pt-[24px] -ml-1 ">
            ...
            <div
              className="flex flex-col gap-5 pl-[20px]"
      ...
      <div className="flex  flex-col gap-[24px]">
        <div className=" flex  h-[842px] break-all  w-[800px] bg-[#fff] ">
                ...
                <div className="flex gap-[5.53px] flex-col    ">
                  {data.mobileNumber && (
                    <div className="gap-[7.83px] flex  ">
                      ...
                      <div className="text-white  text-[8.5px]  ">
                        <p
                          className="object-contain pb-[12px]"
                  ...
                  {data.email && (
                    <div className="gap-[7.83px] flex  ">
                      ...
                      <div className="text-white  text-[8.5px]   ">
                        <p
                          className="object-contain pb-[8px]"
                          style={{ fontFamily: selectedFont }}
                        >
                          {data.email}{" "}
                        </p>
                  ...
                  <div className="flex flex-col gap-5 pl-[20px]">
                    {firstPageData?.education?.map((detail, index) => (
                      ...
                      >
                        <div className="">
                          <p
                            className="  text-[9.996px] font-bold  "
                            style={{ fontFamily: selectedFont }}
                          >
                            {detail.qualification}
                          </p>
                          <p
                            className=" text-[9.996px] font-medium  "
                            style={{ fontFamily: selectedFont }}
                          >
                            {detail.instituteName}
                          </p>
                        ...
                        <div className=" flex flex-col gap-1">
                          ...
                          <p
                            className="  text-[8.962px] font-normal"
                            style={{ fontFamily: selectedFont }}
                          >
                            {detail.duration?.start?.year !== "Year" &&
                  ...
                  <div className="pt-[30px]">
                    ...
                    <div className="flex flex-col px-[15.92px] pt-[20px] gap-[9.81px] ">
                      {firstPageData?.skills.map((detail, index) => (
                        <p
                          key={index}
                          className="text-white  text-[8.96px] font-normal"
                          style={{ fontFamily: selectedFont }}
                        >
                          {detail.skill}
                        </p>
          ...
          <div className="w-[553px] pr-[20px] pb-[20px] ">
            <div className=" pl-[20px] pt-[30px] gap-4 w-full h-auto flex flex-col  ">
              <span
                className="text-[#414042]  text-[43.514px] font-normal  leading-[43px] "
                style={{ fontFamily: selectedFont }}
              >
                {data.firstName}
                <br />
              ...
              <p
                className="text-[#414042]  text-[14.015px] font-normal mb-0 "
                style={{ fontFamily: selectedFont }}
              >
                {data.designation}
              </p>
            ...
            <div className="pl-[20px] pt-[40.78px]  h-auto flex flex-col gap-[5.64px] ">
              <p
                className="text-[#414042] text-base font-medium"
                style={{ fontFamily: selectedFont }}
              >
                About Me
              </p>
              ...
              <p
                className="text-[#646464] text-xs font-normal break-all"
                style={{ fontFamily: selectedFont }}
              >
                {data.summery}
              </p>
              ...
              <div className=" flex flex-col gap-8 pt-[24px] -ml-1 ">
                ...
                {firstPageData?.experience.map((detail, index) => (
                  <div key={index} className="flex flex-col gap-3">
                    <div className="flex flex-col ga-2">
                      <p
                        className="text-[#414142] pl-[18px]  text-[11.989px] font-bold"
                        style={{ fontFamily: selectedFont }}
                      >
                        {detail.organization}
                      </p>
                      <p
                        className="text-[#414142]  pl-[18px]  text-[9.996px] font-semibold"
                        style={{ fontFamily: selectedFont }}
                      >
                        {detail.designation}
                      </p>
                      <p
                        className="text-[#414142]  pl-[18px]  text-[8.969px] font-normal"
                        style={{ fontFamily: selectedFont }}
                      >
                        {detail.duration?.start?.year !== "Year" &&
                          `${detail.duration?.start?.year}-${" "}${
                    ...
                    <p
                      className="text-[#646464] pl-[18px]  text-xs font-normal"
                      style={{ fontFamily: selectedFont }}
                    >
                      {detail.description}
                    </p>
