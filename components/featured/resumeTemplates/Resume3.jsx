...
function Resume3({ data, selectedColor, selectedFont, preview }) {
    ...
    const dataSeter = () => {
        ...
        const educationDivHeight = remainingHeightLeft - 37;
    ...
    `;
            ...
            const educationContainerHeight =
                educationContainer.current.clientHeight + 37;

            remainingHeightLeft = remainingHeightLeft - educationContainerHeight;

        }
        const experienceDivHeight = remainingHeightRight - 37;
    ...
    `;
        ...
        const skillDivHeight = remainingHeightLeft - 37;
        ...
        if (skillContainer.current) {
            ...
            [...data?.skills]?.forEach((detail, index) => {
                const parentDiv = document.createElement("div");
                parentDiv.className = "text-white  text-[8.96px] font-normal";
            ...
            const skillContainerHeight = skillContainer.current.clientHeight + 37;
    ...
    return (
        <>
            ...
            <div className=" flex  h-[842px] break-all  w-[800px] bg-[#fff] absolute left-[1000px] ">
                ...
                <div className={`w-[247px] bg-${selectedColor} `}>
                    ...
                    <div className=" pt-7 flex flex-col">
                        ...
                        <div ref={educationContainer} className="flex flex-col gap-5 pt-[24px] -ml-1 ">
                        ...
                        <div ref={skillContainer} className="">
                ...
                <div className="w-[553px] pr-[20px] pb-[20px] ">
                    ...
                    <div className=" flex flex-col gap-8 pt-[24px] -ml-1 ">
                        ...
                        <div className="flex flex-col gap-5 pl-[20px]" ref={experienceContainer}>
            ...
            <div className="flex  flex-col gap-[24px]">
                <div className=" flex  h-[842px] break-all  w-[800px] bg-[#fff] ">

                    <div className={`w-[247px]`} style={{ backgroundColor: selectedColor }}>
                        ...
                        <div className=" pt-7 flex flex-col">
                            <div className="flex  h-[27px] items-center ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="175" viewBox="0 0 125 27" fill="none">
                                    <path d="M112.176 26.999H0.000488281V-0.000976562H112.176C119.258 -0.000976562 125 6.04269 125 13.499C125 20.9554 119.258 26.999 112.176 26.999Z" fill="white" />
                                    <text x="10%" y="55%" dominant-baseline="middle" text-anchor="start" fill="#414042" font-size="15" fontWeight={500}>CONTACT </text>
                                </svg>
                            </div>
                                ...
                                <div className="flex gap-[5.53px] flex-col    ">
                                    {data.mobileNumber &&
                                        <div className="gap-[7.83px] flex  ">
                                            ...
                                            <div className="text-white  text-[8.5px]  ">
                                                <p className="object-contain pb-[12px]" style={{ fontFamily: selectedFont }}>{data.mobileNumber}</p>
                                            </div>
                                    ...
                                    {data.email &&
                                        <div className="gap-[7.83px] flex  ">
                                            ...
                                            <div className="text-white  text-[8.5px]   ">
                                                <p className="object-contain pb-[8px]" style={{ fontFamily: selectedFont }}>{data.email} </p>
                                            </div>
                                        </div>
                                    }
                                    <div className="flex flex-col">
                                        {data.sociaLinks.map((detail, index) => (
                                            <div key={index} className="gap-[7.83px] flex ">
                                                ...
                                                <div className="text-white  text-[8.5px]  ">
                                                    <p className="object-contain" style={{ fontFamily: selectedFont }}>{detail.link}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                            ...
                            {firstPageData?.education?.length > 0 && (
                                <div className="flex flex-col gap-5 pt-[24px]  ">
                                    ...
                                    <div className="flex  h-[27px]  items-center ">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="175" viewBox="0 0 125 27" fill="none">
                                            <path d="M112.176 26.999H0.000488281V-0.000976562H112.176C119.258 -0.000976562 125 6.04269 125 13.499C125 20.9554 119.258 26.999 112.176 26.999Z" fill="white" />
                                            <text x="10%" y="55%" dominant-baseline="middle" text-anchor="start" fill="#414042" font-size="15" f fontWeight={500}>EDUCATION </text>
                                        </svg>
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-5 pl-[20px]">
                                        {firstPageData?.education?.map((detail, index) => (
                                            <div key={index} className="flex flex-col gap-2 text-white" >
                                                <div className="">
                                                    <p className="  text-[9.996px] font-bold  " style={{ fontFamily: selectedFont }}>
                                                        {detail.qualification}
                                                    </p>
                                                    <p className=" text-[9.996px] font-medium  " style={{ fontFamily: selectedFont }}>
                                                        {detail.instituteName}
                                                    </p>
                                                </div>
                                                <div className=" flex flex-col gap-1">
                                                    ...
                                                    <p className="  text-[8.962px] font-normal" style={{ fontFamily: selectedFont }}>
                                ...
                                {firstPageData?.skills?.length > 0 && (
                                    <div className="pt-[30px]">
                                        <div className="flex ml-[-1px] h-[27px]  items-center ">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="175" viewBox="0 0 125 27" fill="none">
                                                <path d="M112.176 26.999H0.000488281V-0.000976562H112.176C119.258 -0.000976562 125 6.04269 125 13.499C125 20.9554 119.258 26.999 112.176 26.999Z" fill="white" />
                                                <text x="10%" y="55%" dominant-baseline="middle" text-anchor="start" fill="#414042" font-size="15" fontWeight={500}>SKILLS </text>
                                            </svg>
                                        </div>
                                        <div className="flex flex-col px-[15.92px] pt-[20px] gap-[9.81px] ">
                                            {firstPageData?.skills.map((detail, index) => (
                                                <p key={index} className="text-white  text-[8.96px] font-normal" style={{ fontFamily: selectedFont }}>
                                                    {detail.skill}
                                                </p>
                                            ))}
                                        </div>
                    ...
                    <div className="w-[553px] pr-[20px] pb-[20px] ">
                        <div className=" pl-[20px] pt-[30px] gap-4 w-full h-auto flex flex-col  ">
                            <span className="text-[#414042]  text-[43.514px] font-normal  leading-[43px] " style={{ fontFamily: selectedFont }}>
                                {data.firstName}
                                <br />
                                {data.lastName}
                            </span>

                            <p className="text-[#414042]  text-[14.015px] font-normal mb-0 " style={{ fontFamily: selectedFont }}>
                                {data.designation}
                            </p>
                        </div>
                        <div className="pl-[20px] pt-[40.78px]  h-auto flex flex-col gap-[5.64px] ">
                            <p className="text-[#414042] text-base font-medium" style={{ fontFamily: selectedFont }}>About Me</p>

                            <p className="text-[#646464] text-xs font-normal break-all" style={{ fontFamily: selectedFont }}>
                                {data.summery}
                            </p>
                        </div>

                        {firstPageData?.experience?.length > 0 && (
                            <div className=" flex flex-col gap-8 pt-[24px] -ml-1 ">

                                <svg xmlns="http://www.w3.org/2000/svg" width="260" viewBox="0 0 160 27" fill="none" >
                                    <path d="M146.641 27H0V0H146.641C154.018 0 160 6.04367 160 13.5C160 20.9564 154.018 27 146.641 27Z" fill={selectedColor} />
                                    <text x="6%" y="55%" dominant-baseline="middle" text-anchor="start" fill="white" font-size="15" fontWeight={500}>EXPERIENCE </text>
                                ...
                                {firstPageData?.experience.map((detail, index) => (
                                    <div key={index} className="flex flex-col gap-3">
                                        <div className="flex flex-col ga-2">
                                            <p className="text-[#414142] pl-[18px]  text-[11.989px] font-bold" style={{ fontFamily: selectedFont }}>
                                                {detail.organization}
                                            </p>
                                            <p className="text-[#414142]  pl-[18px]  text-[9.996px] font-semibold" style={{ fontFamily: selectedFont }}>
                                                {detail.designation}
                                            </p>
                                            <p className="text-[#414142]  pl-[18px]  text-[8.969px] font-normal" style={{ fontFamily: selectedFont }}>
                                        ...
                                        <p className="text-[#646464] pl-[18px]  text-xs font-normal" style={{ fontFamily: selectedFont }}>
                                            {detail.description}
                                        </p>
                                    </div>
                                ))}
                        ...
                        <div className="w-[553px] pr-[20px] pb-[20px] ">
                            ...
                            {secondPageData?.experience?.length > 0 && (
                                <div className=" flex flex-col gap-8 pt-[24px] -ml-1 ">
                                    ...
                                    {secondPageData?.experience.map((detail, index) => (
                                        <div key={index} className="flex flex-col gap-3">
                                            <div className="flex flex-col ga-2">
                                                <p className="text-[#414142] pl-[18px]  text-[11.989px] font-bold" style={{ fontFamily: selectedFont }}>
                                                    {detail.organization}
