    ...
    `;
        ...
        if (experienceContainer.current) {
            [
                ...
                parentDiv.innerHTML = `
        <div className="flex flex-col">
        <p className="text-[#414042] font-lato text-[12px] font-bold">  ${detail.organization
                    }</p>

        <div className="flex justify-between">
          <p className="text-[#414042] font-lato text-[11px] font-bold">   ${detail.designation
                    } </p>
        ...
        <p className="text-[#414042]  font-inter text-[11px] font-normal leading-normal">${detail.description
                    }</p>
      </div>
    ...
    return (
        <>
            ...
            <div className=" flex  h-[842px] break-all  w-[800px] bg-[#fff] absolute left-[1000px] ">
                ...
                <div ref={topContainer} className="w-[247px] bg-[#414042]  ">
                    ...
                    <div ref={contactContainer} className=" pt-7 flex flex-col">
                        ...
                        <div className="">
                            ...
                            {data?.skills?.length > 0 && (
                                <div className="pt-[30px]">
                                    ...
                                    <div className="flex flex-col px-[15.92px] pt-[20px] gap-[9.81px] " ref={skillContainer}>
                ...
                <div className="w-[553px] pr-[20px] pb-[20px] ">
                    ...
                    <div className="pl-[20px] pt-[40.78px]  h-auto flex flex-col gap-[5.64px] ">
                        ...
                        <p className="text-[#646464] f text-xs font-normal break-all" ref={summaryContainer}>
                    ...
                    <div className="flex flex-col gap-5 pt-[24px] -ml-1 ">
                        ...
                        <div className="flex flex-col gap-5 pl-[20px]" ref={educationContainer}>
            ...
            <div className="flex flex-col gap-[24px]">
                <div className=" flex  h-[842px] break-all  w-[800px] bg-[#fff] ">
                    ...
                    <div className="w-[247px] bg-[#414042]  ">
                        <div className="pt-[21px] pr-[22px] pl-[28px]">
                                    ...
                                    <div className="pt-[30px]">
                                        ...
                                        <div className="flex flex-col px-[15.92px] pt-[20px] gap-[9.81px] ">
                                            {data.skills.map((detail, index) => (
                                                <p key={index} className="text-white  text-[8.96px] font-normal">
                                                    {detail.skill}
                                                </p>
                                            ))}
                                        </div>
