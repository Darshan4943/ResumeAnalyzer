      ...
      <View style={{ flexDirection: "row", gap: "4.63px", }}>
            ...
            <View style={{ flexDirection: "column", gap: 28 }}>
              ...
              <View style={{ flexDirection: "column", gap: 24, marginLeft: 48 }}>
                ...
                <View style={{ flexDirection: "column", gap: 8 }}>
                  <Text style={{ fontSize: 12, fontWeight: 400 }}>{data.email}</Text>
                  <View style={{ flexDirection: "column", gap: 6 }}>
                    <Text style={{ fontSize: 12, fontWeight: 400 }}>{data.firstName} {data.lastName}</Text>
                    <Text style={{ fontSize: 12, fontWeight: 400 }}>{data.location}</Text>
                  ...
                  <View style={{ flexDirection: "column", gap: 6 }}>
                    {data.skills.map((detail, index) => (
                      <View style={{ flexDirection: "row", gap: "8", alignItems: "center" }}>
                        ...
                        <Text style={{ fontSize: 12, fontWeight: 400 }}>{detail.skill}</Text>
                      </View>
                    ))}
                ...
                <View style={{ flexDirection: "column", gap: 8 }}>
                  <Text style={{ fontSize: 12, fontWeight: 400 }}>LANGUAGES</Text>
                  <View style={{ flexDirection: "column", gap: 6 }}>
                    {data.languages.map((detail, index) => (
                      <View style={{ flexDirection: "row", gap: "8", alignItems: "center" }}>
                        ...
                        <Text style={{ fontSize: 12, fontWeight: 400 }}>{detail.languages}</Text>
                      </View>
                    ))}
                ...
                <View style={{ flexDirection: "column", gap: 8 }}>
                  <Text style={{ fontSize: 12, fontWeight: 400 }}>HOBBIES</Text>
                  <View style={{ flexDirection: "column", gap: 6 }}>
                    {data.hobbies.map((detail, index) => (
                      <View style={{ flexDirection: "row", gap: "8", alignItems: "center" }}>
                        ...
                        <Text style={{ fontSize: 12, fontWeight: 400 }}>{detail.title}</Text>
                      </View>
                    ))}
        ...
        <View style={{ width: 305 }}>
          ...
          <View style={{ flexDirection: "column", paddingTop: 50 }}>
            <Text style={{ fontSize: 24, fontWeight: 400, color: "#45484C" }}>{data.firstName} {data.lastName}</Text>
            <Text style={{ fontSize: 12, fontWeight: 400, color: "#45484C" }}>{data.designation}</Text>
          </View>
          ...
          <View style={{ flexDirection: "column", gap: 24, width: 205, paddingTop: 92, paddingLeft: 34 }}>
            ...
            <View style={{ fdisplay: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <View style={{ display: "flex", flexDirection: "row", gap: 24, width: 305, alignItems: "center" }}>
                <Text style={{ fontSize: 12, fontWeight: 400, color: "#45484C" }}>EXPERIENCE</Text>
                <View style={{ backgroundColor: "#9C9B9B", height: 1, width: 208 }}></View>
              </View>
              {data?.experience?.map((detail, index) => (
                <View style={{ display: "flex", flexDirection: "row", gap: 36 }}>
                  <View>
                    <Text style={{ fontSize: 10, fontWeight: 400, color: "#45484C" }}>{detail.duration?.start?.year}-{detail.currentlyWorking ? "Present" : detail.duration?.end?.year}</Text>
                  </View>
                  <View style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    <View style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                      <Text style={{ fontSize: 10, fontWeight: 500, color: "#45484C" }}>{detail.designation}</Text>
                      <Text style={{ fontSize: 10, fontWeight: 400, color: "#45484C" }}>{detail.organization}</Text>
                    </View>
                    <Text style={{ fontSize: 10, fontWeight: 400, color: "#45484C" }}>{detail.description}</Text>
                  </View>
                </View>
            ...
            <View style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              <View style={{ display: "flex", flexDirection: "row", gap: 24, width: 305, alignItems: "center" }}>
                <Text style={{ fontSize: 12, fontWeight: 400, color: "#45484C" }}>EDUCATION</Text>
                <View style={{ backgroundColor: "#9C9B9B", height: 1, width: 208 }}></View>
              </View>
              {data?.education?.map((detail, index) => (
              <View style={{ display: "flex", flexDirection: "row", gap: 36 }}>
                <View>
                  <Text style={{ fontSize: 10, fontWeight: 400, color: "#45484C" }}>{detail.duration?.start?.year}-{detail.duration?.end?.year}</Text>
                </View>
                <View style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  <Text style={{ fontSize: 10, fontWeight: 500, color: "#45484C" }}>{detail.qualification} - {detail.specialization}</Text>
                  <View>
                    <Text style={{ fontSize: 10, fontWeight: 400, color: "#45484C" }}>{detail.instituteName}</Text>
