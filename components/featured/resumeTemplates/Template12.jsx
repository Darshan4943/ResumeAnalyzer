          ...
          <View style={{ backgroundColor: "#0C2438", width: '595', position: 'relative', height: 176 }}>
            <View style={{ backgroundColor: selectedColor, position: 'absolute', width: 495, bottom: 0, height: 75 }}>
              <View style={{ flexDirection: "column", paddingLeft: 40, gap: 4, paddingTop: 5 }}>
                ...
                <Text style={{ fontSize: "16", color: '#fff', fontFamily: `${selectedFont} 400` }}>
                  {data.designation}
                </Text>
              </View>
            </View>
          ...
          <View style={{ flexDirection: "column", gap: 10, width: 595, padding: 20, paddingTop: 30 }}>
            ...
            <View style={{ width: "90.62%", flexDirection: "row", gap: 8 }}>
              <View style={{ flexDirection: "column", alignItems: "flex-start", justifyContent: "flex-start", gap: 2, width: "18.72%", maxWidth: 130 }}>
                ...
                <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#8B8C8C" }}>{data.mobileNumber}</Text>
              </View>
              <View style={{ backgroundColor: "#B5BCC5", width: 1, height: 30 }}></View>
              <View style={{ maxWidth: 200, width: "auto", gap: 2, flexDirection: "column" }}>
                <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 700`, color: "#495970" }}>EMAIL</Text>
                <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#8B8C8C" }}>{data.email}</Text>
              </View>
              <View style={{ backgroundColor: "#B5BCC5", width: 1, height: 30 }}></View>
              <View style={{ maxWidth: 225, width: "auto", gap: 2, flexDirection: "column" }}>
                <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 700`, color: "#495970", }}>ADDRESS</Text>
                <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#8B8C8C", }}>{data.location}</Text>
              </View>
            </View>
          </View>
                ...
                <View key={index} style={{ flexDirection: "column", gap: 8, width: '50%' }}>
                  <View style={{ flexDirection: "row", gap: 6 }}>
                    ...
                    <View style={{ flexDirection: "column", gap: 2, width: "100%" }}>
                      <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#495970" }}>
                  ...
                  <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: "#676A6D", width: "100%" }}>
              ...
              {data?.experience?.map((detail, index) => (
                <View style={{ flexDirection: "column", gap: 6, width: "370" }} key={index}>
                  ...
                  <View style={{ flexDirection: "row", gap: 1 }}>
                    <Text style={{ fontSize: 10, fontFamily: `${selectedFont} 400`, color: "#495970", maxWidth: 180, }}>
                      {" "}
                      {detail.organization}
                    </Text>
