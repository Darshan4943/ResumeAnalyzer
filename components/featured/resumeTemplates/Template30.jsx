    ...
    return (
        <Page size="A4" style={{ padding: 24 }}>
            <View style={{ flexDirection: "column", gap: 24 }}>
                <View style={{ backgroundColor: "#F1F2F2", borderRadius: "50%", padding: 24, flexDirection: "row", gap: 36, justifyContent: "space-between", alignItems: "center" }}>
                    {data.profilePhoto ? (
                    ...
                    <View style={{ padding: 24, flexDirection: "column", gap: 16 }}>
                        <View style={{ flexDirection: "column", alignItems: "start" }}>
                            <Text style={{ fontFamily: `${selectedFont} 700`, fontSize: "24px", }}>{data.firstName} {data.lastName}</Text>
                            <Text style={{ fontFamily: `${selectedFont} 300`, fontSize: "14px", }}>{data.designation}</Text>
                        </View>
                        {data.firstName &&
                            <View style={{ flexDirection: "row", alignItems: "start", gap: 24 }}>
                                <View style={{ flexDirection: "column", justifyContent: "space-between", gap: 12 }}>
                                    <View style={{ flexDirection: "row", gap: 12 }} >
                                        ...
                                        <Text style={{ fontFamily: `${selectedFont} 400`, fontSize: "12px", color: "#414042" }}>{data.mobileNumber}</Text>
                                    ...
                                    <View style={{ flexDirection: "row", gap: 12 }} >
                                        ...
                                        <Text style={{ fontFamily: `${selectedFont} 400`, fontSize: "12px", color: "#414042" }}>{data.email}</Text>
                                ...
                                <View style={{ flexDirection: "column", justifyContent: "space-between" }}>
                                    ...
                                    <View style={{ flexDirection: "row", gap: 12 }} >
                                        ...
                                        <Text style={{ fontFamily: `${selectedFont} 400`, fontSize: "12px", color: "#414042" }}>{data.location}</Text>
                ...
                <View style={{ flexDirection: "row", gap: 24 }}>
                    <View style={{ flexDirection: "column", gap: 24, width: 160 }}>
                        <View style={{ flexDirection: "column", gap: 16, }}>
                            <View style={{ width: "100%", flexDirection: "column", justifyContent: "center", alignItems: "center", backgroundColor: selectedColor, padding: "8px 24px", borderRadius: "50%" }}>
                                <Text style={{ color: "#FFF",fontFamily: `${selectedFont} 500` }} >
                                    ABOUT ME
                                </Text>
                            </View>
                            <Text style={{ color: "#58595B", fontSize: "12" ,fontFamily: `${selectedFont} 400`}}>
                                {data.summery}
                            </Text>
                        </View>
                            ...
                            <View style={{ flexDirection: "column", gap: 16, }}>
                                ...
                                <View style={{ flexDirection: "column", gap: 12, }}>
                                    {data?.skills?.map((detail, index) => (
                                        <Text style={{ color: "#58595B", fontSize: "14" ,fontFamily: `${selectedFont} 400`}}>
                                            {detail.skill}
                                        </Text>
                                    ))}
                                </View>
                    ...
                    <View style={{ flexDirection: "column", gap: 24, width: 330 }}>

                        {data?.experience?.length > 0 && (
                            <View style={{ flexDirection: "column", gap: 16, }}>
                                <View style={{flexDirection: "row", alignItems:"center"}}>
                                    <View style={{ width: "50%", flexDirection: "column", justifyContent: "center", alignItems: "center", backgroundColor: selectedColor, padding: "8px 24px", borderRadius: "50%" }}>
                                        <Text style={{ color: "#FFF",fontFamily: `${selectedFont} 500` }} >
                                            EXPERIENCE
                                        </Text>

                                    </View>
                                    <View style={{ backgroundColor: "#D1D3D4", height: "1px",width: "50%" }}>
                                    </View>
                                </View>
                                        ...
                                        <View key={index} style={{ display: "flex", alignItems: "start", gap: 4 }}>
                                            <View style={{ display: "flex", flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "space-between" }}>
                                                <View style={{ display: "flex", flexDirection: "row", gap: 8, alignItems: "center" }} >
                                                    <Text style={{ color: "#414042", fontSize: "12px", fontFamily: `${selectedFont} 500` }}>{detail.designation} </Text>
                                ...
                                <View style={{ display: "flex", flexDirection: "column", gap: 16 }} >
                                    {data?.education?.map((detail, index) => (
                                        ...
                                        <View key={index} style={{ display: "flex", alignItems: "start", gap: 4 }}>
                                            <View style={{ display: "flex", flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "space-between" }}>
                                                <View style={{ display: "flex", flexDirection: "row", gap: 8, alignItems: "center" }} >
                                                    <Text style={{ color: "#414042", fontSize: "12px", fontFamily: `${selectedFont} 500` }}>{detail.qualification} - {detail.specialization}</Text>
