                            ...
                            <View style={{ flexDirection: "row", alignItems: "start", gap: 24 }}>
                                <View style={{ flexDirection: "column", justifyContent: "space-between", gap: 12 }}>
                                    <View style={{ flexDirection: "row", gap: 12 }} >
                                        ...
                                        <Text style={{ fontFamily: `${selectedFont} 300`, fontSize: "12px", color: "#414042" }}>{data.mobileNumber}</Text>
                                    ...
                                    <View style={{ flexDirection: "row", gap: 12 }} >
                                        ...
                                        <Text style={{ fontFamily: `${selectedFont} 300`, fontSize: "12px", color: "#414042" }}>{data.email}</Text>
                                ...
                                <View style={{ flexDirection: "column", justifyContent: "space-between" }}>
                                    ...
                                    <View style={{ flexDirection: "row", gap: 12 }} >
                                        ...
                                        <Text style={{ fontFamily: `${selectedFont} 300`, fontSize: "12px", color: "#414042" }}>{data.location}</Text>
