...
const Template41 = ({ data,selectedColor,selectedFont  }) => {
    return (
        <Page size="A4">
            <View style={{ width: "100%", display: "flex", flexDirection: "row", minHeight: 841,  }}>
                <View style={{ width: 218, display: "flex", flexDirection: "column", backgroundColor: "#EDEDEE", paddingTop: 32, paddingLeft: 32, paddingRight: 24, gap: 26, paddingBottom: 32, backgroundColor: "#EDEDEE" }}>
                    <View style={{ flexDirection: "column", gap: 14 }} >
                        ...
                        <View style={{ flexDirection: "column", gap: 8 }}>
                            <View style={{ flexDirection: "column" }}>
                                <Text style={{ fontSize: 26, fontFamily: `${selectedFont} 400`, color: "#000000" }}>{data.firstName ? <>{data.firstName}</> : <>First Name</>}</Text>
                                <Text style={{ fontSize: 26, fontFamily: `${selectedFont} 400`, color: "#000000" }}>{data.lastName ? <>{data.lastName}</> : <>Last Name</>}</Text>
                            </View>
                            <View style={{ width: 162, height: 1, backgroundColor: "#000000" }}></View>
                            <Text style={{ fontSize: 11, fontFamily: `${selectedFont} 400`,color: "#000000" }}>{data.designation ? <>{data.designation}</> : <>Designation</>}</Text>
                        </View>
                    </View>
                    <View style={{ width: "100%", flexDirection: "column", gap: 8 }}>
                        <View>
                            <Text style={{ fontSize: 14,  fontFamily: `${selectedFont} 400`, color: "#000000" }}>CONTACT</Text>
                        </View>
                        <View style={{ flexDirection: "column", gap: 6 }}>
                            <View style={{ flexDirection: "row", gap: 4, padding: 4, backgroundColor: "#FFFFFF", display: "flex", alignItems: "center" }}>
                                ...
                                <Text style={{ fontSize: 9, fontWeight: 400, color: "#000000", backgroundColor: "#FFFFFF" }}>{data.mobileNumber ? (<>{data.mobileNumber}</>) : (<>Your Phone</>)}</Text>
                            </View>
                            <View style={{ flexDirection: "row", gap: 4, padding: 4, backgroundColor: "#FFFFFF", display: "flex", alignItems: "center" }}>
                                ...
                                <Text style={{ fontSize: 9, fontWeight: 400, color: "#000000", backgroundColor: "#FFFFFF" }}>{data.sociaLinks ? <>{data.sociaLinks}</> : <>Your Websites</>}</Text>
                            </View>
                            <View style={{ flexDirection: "row", gap: 4, padding: 4, backgroundColor: "#FFFFFF", display: "flex", alignItems: "center" }}>
                                ...
                                <Text style={{ fontSize: 9, fontWeight: 400, color: "#000000", backgroundColor: "#FFFFFF" }}>{data.email ? <>{data.email}</> : <>Your Email</>}</Text>
                            </View>
                            <View style={{ flexDirection: "row", gap: 4, padding: 4, backgroundColor: "#FFFFFF", display: "flex", alignItems: "center" }}>
                                ...
                                <Text style={{ fontSize: 9, fontFamily: `${selectedFont} 400`,color: "#000000", backgroundColor: "#FFFFFF" }}>{data.location ? <>{data.location}</> : <>Your Address</>}</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={{ flexDirection: "column", gap: 8 }}>
                        <View><Text style={{ fontSize: 14,  fontFamily: `${selectedFont} 400`, color: "#000000" }}>INTERESTS</Text></View>
                        <View style={{ flexDirection: "column", gap: 8 }}>
                            {data?.hobbies?.map((item, index) => (
                                <View style={{ flexDirection: "row", gap: 8, alignItems: "center" }}>
                                    <Svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <Path d="M1.94663 3.64648C2.88365 3.64648 3.64325 2.88615 3.64325 1.94824C3.64325 1.01033 2.88365 0.25 1.94663 0.25C1.00961 0.25 0.25 1.01033 0.25 1.94824C0.25 2.88615 1.00961 3.64648 1.94663 3.64648Z" fill="black" />
                                    </Svg>
                                    <Text style={{ fontSize: 10,  fontFamily: `${selectedFont} 400`, color: "#000000" }}>{item?.title}</Text>
                                </View>
                            ))}
                        </View>
                    </View>
                    <View style={{ flexDirection: "column", gap: 8 }}>
                        <Text style={{ fontSize: "14px",  fontFamily: `${selectedFont} 400`, color: "#000000" }}>LANGUAGES</Text>
                        <View style={{ flexDirection: "column", gap: 8 }}>
                ...
                <View style={{ width: 377, display: "flex", flexDirection: "column", gap: 28, paddingTop: 32, paddingLeft: 20, paddingRight: 32, paddingBottom: 32, }}>
                    <View style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                        <Text style={{ fontSize: 14,  fontFamily: `${selectedFont} 400`, color: "#000000" }}>ABOUT ME</Text>
                        <Text style={{ fontSize: 10,  fontFamily: `${selectedFont} 400`, color: "#000000" }}>{data.summery ? <>{data.summery}</> : <>About</>}</Text>
                    </View>
                    <View style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                        <View style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                            <View>
                                <Text style={{ fontSize: 14,  fontFamily: `${selectedFont} 400`,color: "#000000" }}>WORK EXPERIENCE</Text>
                            </View>
                            {data?.experience?.map((detail, index) => (
                                <View style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                                    <Text style={{ fontSize: 14, fontFamily: `${selectedFont} 400`, color: "#000000" }}>{detail.designation ? (<>{detail.designation}</>) : (<>Designation</>)}</Text>
                                    <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                        <Text style={{ fontSize: 12,  fontFamily: `${selectedFont} 400`, color: "#000000" }}>{detail.organization ? (<>{detail.organization}</>) : (<>organization</>)} </Text>
                                        <Text style={{ fontSize: 12,  fontFamily: `${selectedFont} 400`, color: "#000000" }}>{detail.duration?.start?.year}-{detail.currentlyWorking ? "Present" : detail.duration?.end?.year}</Text>
                                    </View>
                                    <View style={{ flexDirection: "column", gap: 8 }}>
                                        <Text style={{ fontSize: 10,  fontFamily: `${selectedFont} 400`,color: "#000000" }}>{detail.description ? (<>{detail.description}</>) : (<>Description</>)}</Text>
                                    </View>
                                </View>
                            ))}
                        </View>
                    ...
                    <View style={{ flexDirection: "column", gap: 8, width: "100%" }}>
                        <View>
                            <Text style={{ fontSize: 14,  fontFamily: `${selectedFont} 400`, color: "#000000" }}>EDUCATION</Text>
                        </View>
                        <View style={{ display: "flex", flexDirection: "row",flexWrap:"wrap", gap: 10,  }}>
                            {data?.education?.map((detail, index) => (
                                <View style={{ width: "45%",  borderRight: index % 2 === 0 ? "1px solid #000000" : "none",paddingLeft: index%2!==0 ? "16" : "none"}}>
                                    <Text style={{ fontSize: 12,  fontFamily: `${selectedFont} 400`, color: "#000000" }}>{detail.qualification}</Text>
                                    <Text style={{ fontSize: 10,  fontFamily: `${selectedFont} 400`, color: "#000000" }}>{detail.instituteName}</Text>
                                    <Text style={{ fontSize: 10,  fontFamily: `${selectedFont} 400`, color: "#000000" }}>{detail.duration?.start?.year}-{detail.duration?.end?.year}</Text>
                                </View>
                            ))}
                        </View>
                        <View>
