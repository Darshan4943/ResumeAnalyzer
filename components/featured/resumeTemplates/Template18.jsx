...
const Template18 = ({ data ,selectedColor,selectedFont }) => {
  return (
        ...
        <View style={{ flexDirection: 'row', alignItems: 'start', justifyContent: 'start', width: 595, gap: 25, paddingLeft: 20 }}>
          ...
          <View style={{ width: 400, flexDirection: 'column', gap: 16 }}>
            <View style={{ width: 400, flexDirection: 'column', gap: 8 }}>
              <Text style={{ fontSize: 38, fontFamily: `${selectedFont} 500`, maxWidth: 400, color: '#010101' }}>{data.firstName} {data.lastName}</Text>
              <Text style={{ fontSize: 16, fontFamily: `${selectedFont} 500`, maxWidth: 400, color: '#5E5E5E' }}>{data.designation}</Text>

            </View>
            <View style={{ width: 400 }}>
              <Text style={{ fontSize: 10,fontFamily: `${selectedFont} 400`, color: "#6D6E71", maxWidth: 400 }}>{data.summery}</Text>
                    ...
                    return (
                      <View style={{ width: "100%", flexDirection: "column" }} key={index}>
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                          <Text style={{ color: "#424143", fontSize: 12, width: 60, fontFamily: `${selectedFont} 400`}}>
                            {detail.languages}
                          </Text>
                ...
                return (
                  <View style={{ paddingRight: 4, flexDirection: "column" }} key={index}>
                    <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
                      <Text style={{ color: "#424143", fontSize: 12, width: 80, fontFamily: `${selectedFont} 400`}}>
                        {detail.skill}
                      </Text>
        ...
        <View style={{ width: 595, flexDirection: 'row', gap: 20, paddingLeft: 20 }}>
          <View style={{ width: 150, flexDirection: 'column', gap: 12 }}>
            <View style={{ maxWidth: 150, gap: 6 }}>
              <Text style={{ fontSize: 14, fontFamily: `${selectedFont} 500`,color:'#282627' }}>CONTACT</Text>
            ...
            <View style={{ gap: 10, flexDirection: 'column' }}>
              <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 500` }}>
                EDUCATION
              </Text>
              {
                  ...
                  <>
                    <View style={{ flexDirection: 'column', gap: 4, maxWidth: 150 }}>
                      <View style={{ flexDirection: 'row', gap: 6, alignItems: 'center' }}>
                        ...
                        <Text style={{ fontSize: 12,fontFamily: `${selectedFont} 700`,color:"#5E5F5E" }}> {detail.duration?.start?.year}-
                          {detail.duration?.end?.year}</Text>
                      </View>
                      <View style={{ gap: 8, flexDirection: 'column', justifyContent: 'start', alignItems: 'start' }}>
                        <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 600`, color: '#282627', maxWidth: 150 }}> {detail.qualification}</Text>
                        <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: '#5E5F5E', maxWidth: 150 }}> {detail.instituteName}</Text>
                        <Text style={{ fontSize: 12, fontFamily: `${selectedFont} 400`, color: '#5E5F5E', maxWidth: 150 }}>{detail.specialization}</Text>
                      </View>
                    </View>
            ...
            <View style={{ flexDirection: 'column', maxWidth: 150, paddingTop: 10 }}>
              <Text style={{  fontSize: 12,fontFamily: `${selectedFont} 500`, color: '#282627' }}>HOBBIES</Text>
