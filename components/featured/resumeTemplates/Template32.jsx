            ...
            <View style={{ flexDirection: 'row', gap: "1.5rem" }}>
                    ...
                    <View style={{ flexDirection: "column", minHeight: "841.7px", height: "100%", backgroundColor: "#F2F2F2", gap: "18px", }}>
                        <View style={{ alignItems: "center", marginTop: "35px", flexDirection: "column", }}>
                            ...
                            <View style={{ flexDirection: "row", marginTop: 24, gap: 4 }}>
                                <Text style={{ color: "#414042",fontFamily:'Inter 400', fontSize: "24px", }}>{data.firstName}</Text>
                                <Text style={{ color: "#0072BC", fontFamily:'Inter 400', fontSize: "24px", }}>{data.lastName}</Text>
                            </View>
                            <Text style={{ fontSize: "12px", fontFamily:'Inter 400', color: "#414042" }}>{data.designation}</Text>
                        </View>
                        <View style={{ display: "flex", flexDirection: "column", gap: "8" }}>
                            ...
                            {data?.mobileNumber && (
                                <View style={{ flexDirection: "row", gap: "12px", justifyContent: "start", alignItems: "center", marginLeft: "24px", paddingRight: " 4px", paddingTop: "5px" }}>
                                    ...
                                    <Text style={{ fontSize: "10px", paddingTop: "2px", flexDirection: "row", fontFamily:'Inter 400', color: "#414042", }}>{data.mobileNumber}</Text>
                                </View>
                            )}
                            {data?.email && (
                                <View style={{ flexDirection: "row", breakAll: true, gap: "12px", justifyContent: "start", alignItems: "center", marginLeft: "24px", paddingRight: " 4px" }}>
                                    ...
                                    <Text style={{ fontSize: "10px", width: '80%', paddingTop: "2px", flexDirection: "row", fontFamily:'Inter 400', color: "#414042", }}>{data.email}</Text>
                                </View>
                            )}
                        ...
                        <View style={{ flexDirection:"row", fontSize: "11px", paddingTop: "2px", fontWeight: 400, color: "#fff", }}>{data.sociaLinks}</View>
                            ...
                            {data?.location && (
                                <View style={{ flexDirection: "row", breakAll: true, justifyContent: "start", gap: "12px", alignItems: "center", marginLeft: "24px", paddingRight: " 4px" }}>
                                    ...
                                    <Text style={{ fontSize: "10px", flexDirection: "row", fontFamily:'Inter 400', color: "#414042", }}>{data.location}</Text>
                                </View>
                            )}
                        </View>
                        ...
                        {data?.skills?.length > 0 && (
                            <>
                                <View style={{ paddingHorizontal: "24px" }}>
                                    ...
                                    <Text style={{ color: "#0072BC",fontFamily:'Inter 400' }}>SKILLS</Text>
                        ...
                        {data?.hobbies?.length > 0 && (
                            <View style={{ flexDirection: "column", gap: "16px", }}>
                                ...
                                <View style={{ paddingHorizontal: "24px" }}>
                                    ...
                                    <Text style={{fontFamily:'Inter 400', color: "#0072BC" }}>HOBBIES</Text>
                                ...
                                <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", gap: "16px", marginLeft: "24px" }}>
                                    {data?.hobbies?.map((item, index) => (
                                        <View key={index} style={{ color: "#414042", fontSize: "12px", width: "calc(40% - 8px)" }}>
                                            <Text style={{fontFamily:'Inter 400',}}>
                                                {item?.title}
                                            </Text>
                                        </View>
                                    ))}
                ...
                <View style={{ width: "388px", padding: " 16px", display: "flex", flexDirection: "column", gap: "36px" }}>
                    <View style={{ display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-start", paddingTop: "26px" }}>
                        ...
                        <View style={{}}>
                            <Text style={{ color: "#414042", fontSize: "14px", paddingLeft: 8,fontFamily:'Inter 400', }}>{data.summery}</Text>
                        </View>
                    </View>
                                    ...
                                    <>
                                        <View key={index} style={{ display: "flex",flexDirection: "row", gap:16, alignItems: "start" }}>
                                            <View style={{ display: "flex", flexDirection: "column", gap: 8,justifyContent: "space-between",width:"30%" }}>
                                                ...
                                                <Text style={{ color: "#414042", fontSize: "11px", fontFamily:'Lato 700', }}>{detail.instituteName}</Text>


                                                <Text style={{ color: "#414042", fontSize: "9px", fontFamily:'Lato 400', }}>{" "}{detail.duration?.start?.year}-{detail.duration?.end?.year}</Text>
                                            </View>
                                            <View style={{ display: "flex", flexDirection: "column", gap: 4 ,width:"70%"}}>

                                                <Text style={{ color: "#787879", fontSize: "9px", fontFamily:'Lato 700', }}>{detail.qualification} - {detail.specialization}</Text>
                                            </View>
                                    ...
                                    <>
                                        <View key={index} style={{ display: "flex",flexDirection: "row", gap:16, }}>
                                            <View style={{ display: "flex", flexDirection: "column", gap: 8,justifyContent: "space-between",width:"30%" }}>
                                                ...
                                                <Text style={{ color: "#414042", fontSize: "11px", fontFamily:'Lato 700', }}>{detail.designation}</Text>


                                                <Text style={{ color: "#414042", fontSize: "9px",  fontFamily:'Lato 400', }}>{detail.duration?.start?.year}-{" "}{detail.currentlyWorking ? "Present" : detail.duration?.end?.year}</Text>
                                            </View>
                                            <View style={{ display: "flex", flexDirection: "column", gap: 4 ,width:"70%"}}>

                                                <Text style={{ color: "#787879", fontSize: "9px",  fontFamily:'Lato 700', }}>{detail.organization} </Text>
                                                <Text style={{ color: "#787879", fontSize: "9px",  fontFamily:'Lato 400', }}>{detail.description} </Text>
                                            </View>
