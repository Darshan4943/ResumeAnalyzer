        ...
        <Page size="A4" style={{ padding: "24px" }}>
            <View style={{ minHeight: 792, display: "flex", flexDirection: "column", gap: 24 }}>
                <View style={{ display: "flex", width: "100%", flexDirection: "row", gap: 24, alignItems: "center" }}>
                    <View style={{ width: "184px", }}>
                        {data.profilePhoto ? (
                            ...
                            <Image src="/images/services/profile.png" alt="" style={{ width: "184px", height: "150px", }} />
                        )}
                    </View>
                    <View style={{ display: "flex", width: "339px", flexDirection: "column", gap: 8 }}>
                        <Text style={{ fontWeight: 700, fontSize: 40, color: "#231F20" }}>{data.firstName ? <>{data.firstName}</> : <>First Name</>}{" "}{data.lastName ? <>{data.lastName}</> : <>Last Name</>}</Text>
                        <Text style={{ fontWeight: 500, fontSize: 18, color: "#8E8E8E" }}>{data.designation ? <>{data.designation}</> : <>Designation</>}</Text>
                    </View>
                </View>
                    ...
                    <View style={{ width: "184px", flexDirection: "column", gap: 20 }}>
                        <View style={{ flexDirection: "column", gap: 10, width: "100%" }}>
                            <View style={{ flexDirection: "row", display: "flex", alignItems: "center", gap: 16, width: "100%" }}>
                                ...
                                <Text style={{ color: "#231F20", fontSize: "16px", fontWeight: "600" }}>CONTACT</Text>
                                <View style={{ height: 3, backgroundColor: "#A7A9AC", width: "40px" }}></View>
                            </View>
                            <View style={{ flexDirection: "column", display: "flex", gap: 8, width: "100%" }}>
                                <View style={{ flexDirection: "row", display: "flex", gap: 16, paddingLeft: 20, alignItems: "center" }}>
                                    ...
                                    <Text style={{ fontWeight: 500, fontSize: 12, color: "#7A7A7A" }}>{data.mobileNumber ? (<>{data.mobileNumber}</>) : (<>Your Phone</>)}</Text>
                                </View>
                                ...
                                <View style={{ flexDirection: "row", display: "flex", gap: 16, paddingLeft: 20, alignItems: "center" }}>
                                    ...
                                    <Text style={{ fontWeight: 500, fontSize: 12, color: "#7A7A7A" }}>{data.email ? <>{data.email}</> : <>Your Email</>}</Text>
                                </View>
                                <View style={{ height: 1, width: "100%", backgroundColor: "#D1D3D4" }}></View>
                                <View style={{ flexDirection: "row", display: "flex", gap: 16, paddingLeft: 20, alignItems: "center" }}>
                                    <Svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <Text style={{ fontWeight: 500, fontSize: 12, color: "#7A7A7A" }}>{data.location ? <>{data.location}</> : <>Your Address</>}</Text>
                                </View>
                            </View>
                        </View>
                        <View style={{ flexDirection: "column", width: "100%" }} >
                            <View style={{ borderTop: "4px solid #414042", borderLeft: "8px solid #414042", borderRight: "8px solid #414042", position: "relative", padding: "16px", gap: "16px" }}>
                                ...
                                {data?.education?.map((detail, index) => (
                                    <View style={{ width: "100%", display: "flex", flexDirection: "column", gap: "6px", alignItems: "center" }}>
                                        <Text style={{ fontWeight: 700, fontSize: 12, color: "#383838" }}>{detail.duration?.start?.year}-{detail.duration?.end?.year}</Text>
                                        <Text style={{ fontSize: 12, fontWeight: 500, color: '#7A7A7A' }}>{detail.qualification}</Text>
                                        <Text style={{ fontSize: 12, fontWeight: 400, color: '#383838' }}>{detail.specialization}</Text>
                                        <Text style={{ fontSize: 12, fontWeight: 600, color: '#383838' }}>{detail.instituteName}</Text>
                                    </View>
                                ))}
                            </View>
                            <View style={{ width: "100%", flexDirection: "row", display: "flex", alignItems: "center", gap: 16, width: "100%", backgroundColor: "#414042", paddingVertical: "6px" }}>
                                ...
                                <Text style={{ color: "#FFFFFF", fontSize: "16px", fontWeight: "600" }}>SKILLS</Text>
                                <View style={{ height: 3, backgroundColor: "#FFFFFF", width: "30%" }}></View>
                            </View>
                        ...
                        <View style={{ flexDirection: "column", gap: 4, width: "100%" }}>
                            <View style={{ width: "100%", flexDirection: "row", display: "flex", alignItems: "center", gap: 16, width: "100%", paddingVertical: "6px" }}>
                                ...
                                <Text style={{ color: "#231F20", fontSize: "16px", fontWeight: "600" }}>HOBBIES</Text>
                                <View style={{ height: 3, backgroundColor: "#A7A9AC", width: "23%" }}></View>
                            </View>
                            <View style={{ flexDirection: "column", width: "100%", display: "flex", justifyContent: "center", alignItems: "center" }}>
                                {data?.hobbies?.map((item, index) => (
                                    <>
                                        <Text style={{ paddingVertical: "6px", color: "#383838", fontWeight: "600", fontSize: "12px", display: "flex", justifyContent: "center", }}>{item?.title}</Text>
                    ...
                    <View style={{ display: "flex", width: "339px", flexDirection: "column", gap: 24, }}>
                        <View style={{ display: "flex", width: "100%", flexDirection: "row", gap: 16, }}>
                            ...
                            <View style={{ display: "flex", width: "100%", flexDirection: "column", gap: 12 }}>
                                <Text style={{ fontSize: "14px", fontWeight: "700", color: "#414042", }}>ABOUT ME</Text>
                                <View style={{ height: 1, width: "100%", backgroundColor: "#D1D3D4" }}></View>
                                <Text style={{ fontSize: "12px", fontWeight: "400", color: "#6D6E71", }}>
                        ...
                        <View style={{ display: "flex", width: "100%", flexDirection: "row", gap: 16, }}>
                            ...
                            <View style={{ display: "flex", width: "100%", flexDirection: "column", gap: 12 }}>
                                <Text style={{ fontSize: "14px", fontWeight: "700", color: "#414042", }}>EXPERIENCE</Text>
                                <View style={{ height: 1, width: "100%", backgroundColor: "#D1D3D4" }}></View>
                                        ...
                                        {data?.experience?.map((detail, index) => (
                                            <View style={{ display: "flex", width: "100%", flexDirection: "row", gap: 15 }}>
                                                ...
                                                <View style={{ width: "100%", display: "flex", flexDirection: "column", gap: "8px", paddingBottom: `${index !== data.experience.length - 1 ? "20px" : "none"}` }}>
                                                    <Text style={{ fontWeight: 600, fontSize: 14, color: "#6D6E71" }}>{detail.designation ? (<>{detail.designation}</>) : (<>Designation</>)}/{detail.organization ? (<>{detail.organization}</>) : (<>organization</>)}</Text>
                                                    <Text style={{ fontWeight: 600, fontSize: 12, color: "#939598" }}> {detail.duration?.start?.year}-{detail.currentlyWorking ? "Present" : detail.duration?.end?.year}</Text>
                                                    <Text style={{ fontWeight: 400, fontSize: 12, color: "#6D6E71" }}>{detail.description ? (<>{detail.description}</>) : (<>Description</>)}</Text>
                                                </View>
                                            </View>
                                        ))}
                                    </View>
                ...
                <View style={{ position:"absolute", bottom:0, backgroundColor: "#414042", width: "100%", paddingVertical: "8px", flexDirection: "row", alignItems:"center", justifyContent:"center" }}>
                    <Text style={{ textAlign: "center", fontWeight: 400, fontSize: 12, color: "#A7A9AC", }}>For more information you can check my online portfolio at</Text>
                    {" "}
                    <Text style={{ fontWeight: 500, fontSize: 12, color: "#FFFFFF", }}>{data.socialLinks}</Text>
                </View>
            </View>
        </Page>
    )
