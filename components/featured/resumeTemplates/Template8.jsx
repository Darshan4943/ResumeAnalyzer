...
<View style={{display:'flex',flexDirection:'column',gap:18}}>  
   ...
   <Image src="/images/profile/john_doe.png" />
    ...
    <View style={{borderTopColor:'#000000' , borderTop:1,borderBottom:1, borderBottomColor:'#000000'}}>
                <Text style={{padding:'5px 0px 5px 10px',fontSize:14,fontWeight:400}}>CONTACT</Text>
            </View>

           
    <View style={{flexDirection:'row',display:'flex',alignItems:'center'}}>
        <View style={{width:70, alignItems:'center', justifyContent:'center' ,height:'100%',borderBottom:1, borderBottomColor:'#000000',borderRight:1,borderRightColor:'#000000'}}>
        <Svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <Path d="M19.5154 16.1094L17.8824 17.7425C17.27 18.33 16.4784 18.661 15.637 18.661C15.1777 18.661 14.7184 18.5589 14.3102 18.3548C11.7835 17.1301 9.46093 15.4709 7.49689 13.4807C5.50668 11.4905 3.84751 9.19407 2.62277 6.66737C2.06142 5.46749 2.29041 4.03864 3.23514 3.09522L4.8943 1.46221C4.99637 1.36014 5.09843 1.33398 5.20049 1.33398C5.32741 1.33398 5.45565 1.36014 5.53285 1.46221L9.43738 5.36675C9.53944 5.44264 9.56431 5.57087 9.56431 5.6991C9.56431 5.80117 9.53944 5.9281 9.43738 6.0053L7.88028 7.58724C8.51882 8.7361 9.33532 9.7816 10.2539 10.7263C11.1986 11.6449 12.2441 12.4614 13.3929 13.0999L14.95 11.5428C15.128 11.3636 15.4355 11.3636 15.6135 11.5428L19.518 15.4474C19.518 15.4474 19.518 15.4474 19.5442 15.4474C19.6946 15.6502 19.6946 15.9315 19.5154 16.1094Z" fill="black"/>
      </Svg>
        </View>
        <View style={{width:152 ,borderBottom:1, borderBottomColor:'#000000',borderLeftColor:'#000000'}}>
    <Text style={{paddingVertical:8,paddingLeft:15,fontSize:10,fontWeight:500,color:'#000000'}}>{data.mobileNumber}</Text>
        </View>
    ...
    <View style={{flexDirection:'row',display:'flex',alignItems:'center'}}>
        ...
        <View style={{width:152 ,borderBottom:1, borderBottomColor:'#000000',borderLeftColor:'#000000'}}>
    <Text style={{paddingVertical:8,paddingLeft:15,fontSize:10,fontWeight:500,color:'#000000'}}>{data.email}</Text>
        </View>
    ...
    <View style={{flexDirection:'row',display:'flex',alignItems:'center'}}>
        ...
        <View style={{width:152 ,borderBottom:1, borderBottomColor:'#000000',borderLeftColor:'#000000'}}>
    <Text style={{paddingVertical:8,paddingLeft:15,fontSize:10,fontWeight:500,color:'#000000'}}>www.nomedosite.com</Text>
        </View>
    ...
    <View style={{flexDirection:'row',display:'flex',alignItems:'center'}}>
        ...
        <View style={{width:152 ,borderBottom:1, borderBottomColor:'#000000',borderLeftColor:'#000000'}}>
    <Text style={{paddingVertical:8,paddingLeft:15,fontSize:10,fontWeight:500,color:'#000000'}}>{data.location}</Text>
        </View>
...
<View style={{display:'flex',flexDirection:'column',gap:18}}>
<View style={{borderTopColor:'#000000' , borderTop:1,borderBottom:1, borderBottomColor:'#000000'}}>
                <Text style={{padding:'5px 0px 5px 10px',fontSize:14,fontWeight:400}}>ABOUT ME</Text>
            </View>
    <View style={{paddingRight:10,wordBreak: "break-word",width:222}}>
     <Text style={{fontSize:10,fontWeight:500,color:'#414042'}}> {data.summery} </Text>
    </View>
    </View>
    ...
    <View style={{borderTopColor:'#000000' , borderTop:1,borderBottom:1, borderBottomColor:'#000000'}}>
                <Text style={{padding:'5px 0px 5px 10px',fontSize:14,fontWeight:400}}>SKILLS</Text>
            </View>
                                            ...
                                            <View key={i}>
                                                {
                                                    detail.rating[i] === 0 ? (                                                       
                                                        ...
                                                        <Path d="M2.88668 0.583984H0.0976562V3.37302H2.88668V0.583984Z" fill="black"/>
                                                        </Svg>
                                                    )
                                                }
                </View>
...
<Path d="M44.6406 44.4785V0.478516H0.640625C0.640625 24.7799 20.3393 44.4785 44.6406 44.4785Z" fill="black"/>
</Svg>
        </View>

        <View style={{display:'flex',flexDirection:'column',gap:26}}>
            <View style={{borderTopColor:'#000000' , borderTop:1,borderBottom:1, borderBottomColor:'#000000'}}>
                <Text style={{padding:'5px 0px 5px 10px',fontSize:14,fontWeight:400}}>EDUCATION</Text>
            </View>
            {data?.education?.map((detail, index) => (
                <>
            <View style={{display:'flex',flexDirection:'row',alignItems:'center',gap:5,width:282, wordBreak: "break-word"}}> 
            <Text style={{fontSize:14,fontWeight:700,color:'#000000',paddingVertical:5}}>{" "}{detail.duration?.start?.year}-{detail.duration?.end?.year}</Text>
            <View style={{height:'100%',width:1,backgroundColor:'#000000'}}></View>
            <View style={{width:194,display:'flex',flexDirection:'column',gap:4}}>
                <Text style={{fontSize:12,fontWeight:600,color:'#000000'}}>{detail.instituteName}</Text>
                <Text style={{fontSize:10,fontWeight:600,color:'#000000'}}>{detail.qualification} - {detail.specialization} </Text>
            </View>
            </View>
            </>
                    ))}
        ...
        <View style={{borderTopColor:'#000000' , borderTop:1,borderBottom:1, borderBottomColor:'#000000'}}>
                <Text style={{padding:'5px 0px 5px 10px',fontSize:14,fontWeight:400}}>EXPERIENCE</Text>
            </View>
            {data.experience?.map((detail, index) => (               
          <View style={{display:'flex',flexDirection:'column',gap:10}}>
                <Text style={{fontSize:12,fontWeight:700, color:'#000000',}}>{detail.designation} | {" "}{detail.duration?.start?.year}-{" "}{detail.currentlyWorking ? "Present" : detail.duration?.end?.year}</Text> 
                <Text style={{fontSize:12, fontWeight:500,color:'#000000',}}>{detail.organization} | {detail.location}</Text> 
                <Text style={{fontSize:10, fontWeight:500,color:'#000000',}}>{detail.description} </Text> 
          </View>
            ))} 
        </View>
        ...
        {/* <View style={{display:'flex',position:'absolute',bottom:15,left:0,flexDirection:'row',justifyContent:'space-between',width:282,alignItems:'center'}}>
           ...
           {e.logo}
          <Text style={{fontSize:10,fontWeight:500,color:'#000000'}}>{e.text}</Text>
