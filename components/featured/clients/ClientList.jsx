                    ...
                    {details?.map((detail, index) => (
                        <div onClick={() => toggleDetails(detail)} key={index} className='flex flex-col gap-4 cursor-pointer sm:p-6 p-4 rounded-[24px] min-w-[300px]' style={{ boxShadow: "0px 2px 7px 0px #00000040" }}>
                            <div className='flex justify-center relative'>
                                ...
                                <svg onClick={(e) => toggleOptions(index, e)} className='absolute right-[-4%] cursor-pointer' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                {openPopupIndex === index &&
                                    ...
                                    <div ref={taskRef} className='absolute right-[-38%] bg-white px-2 py-4 flex flex-col gap-1 rounded-[8px]' style={{
