...
function RecruiterHero() {
  return (
    <div className="min-h-[560px] bg-cover bg-no-repeat pt-[61px] overflow-hidden bg-recruiter_back w-screen">
      <div className="customMargins">
        ...
        <div className="get_started_button">
          <button class="mt-[13px] border-none rounded-2xl bg-[#ffda1d] flex items-center px-[48px] py-[18px] font-bold">
            Get started
          </button>
        </div>
      </div>
