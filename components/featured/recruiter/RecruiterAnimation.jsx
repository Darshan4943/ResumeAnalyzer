      ...
      <div className="recruiter_animation">
        {showAnimationn ? (
          <>
            ...
            <motion.div
              className="group2"
              animate={{ x: slideImage ? -900 : 0, opacity: slideImage ? 0 : 1 }}
            ...
            <motion.div
              className="group3"
              animate={{
                x: leftImage ? 450 : downImage ? 230 : upImage ? -150 : slideImage ? -300 : 0,
            ...
            <motion.div
              ...
              animate={{ x: slideImage ? -900 : 0, opacity: slideImage ? 0 : 1 }}
              initial={{ opacity: 0, x: -900 }} // Initial opacity
              transition={{ duration: 1, delay: slideImage ? 0 : 1.5, opacity: 0 }} // Animation duration
            >
            ...
            <motion.div className="white_class"
              animate={{ translateX: downImage ? '0%' : '0%', opacity: downImage ? 1 : 0 }}
              initial={{ translateX: downImage ? '-100%' : '0%', opacity: downImage ? 1 : 0, }}
              transition={{ duration: downImage ? 2 : 0, delay: downImage ? 3.5 : 0 }}
            >
            </motion.div>
            <motion.div className='collaborate_section'
              initial={{ opacity: slideCollab ? 1 : 0 }}
              animate={{ opacity: slideCollab ? 1 : 0 }}
              transition={{ duration: slideCollab ? 1 : 0, delay: 2, zIndex: slideCollab ? 1 : 0 }}
            >
              <div className="collaborate_left">
                ...
                <p3>Connect your consulting firm with a diverse range of employers through our platform. We offer a wide-reaching network to help you expand your reach and grow your business. Partner with us to access a broad spectrum of employment.</p3>
              </div>
              <motion.div className="collaborate_img"
                initial={{ opacity: slideCollab ? 1 : 0 }}
                animate={{ opacity: slideCollab ? 1 : 0 }}
                transition={{ duration: slideCollab ? 0.5 : 0, delay: 2, zIndex: slideCollab ? 1 : 0 }}
          ...
          <div className='collaborate_sectionn'
          initial={{ opacity: slideCollab ? 1 : 0 }}
          animate={{ opacity: slideCollab ? 1 : 0 }}
          transition={{ duration: slideCollab ? 0.5 : 0, delay: 1, zIndex: slideCollab ? 1 : 0 }}
        >
          <div className="collaborate_left">
