    ...
    <>
      <div class=" bg-InterviewQue bg-cover bg-no-repeat ">
        <div className="flex rounded-[16px] relative customMargins">
            ...
            <div className="flex flex-col gap-[16px] w-[47%]">
              <div className="flex flex-col gap-[16px]">
                ...
                <div className="text-[18px] font-[500] text-[#333]">
                  ...
                  qualifications, and demonstrate your enthusiasm for the role.{" "}
                </div>
              </div>
              <div>
                <button
          ...
          <div
            className="absolute w-[479px] p-[16px] rounded-[16px] flex flex-row gap-[16px] justify-between items-center right-[5.65%] top-[24px]"
            style={{
              background: "#06A9EF",
          ...
          <div
            className="absolute w-[480px] p-[16px] rounded-[16px] flex flex-row gap-[10px] justify-between items-center right-[11%] bottom-[24px]"
            style={{
              background: "#06A9EF",
              backdropFilter: " blur(8px)",
            }}
          >
            ...
            <div className="flex flex-col w-[312px]  text-[#fff]">
              <div className="text-[24px] font-[600]">Ai Generated Answers</div>
              <div className="text-[18px] font-[400]">
                Improve your resume with personalized tips suggestions from AI ,
                ensuring it stands out to potential employers
              </div>
