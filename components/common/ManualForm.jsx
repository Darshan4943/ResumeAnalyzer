            ...
            <div className=' grid grid-cols-12 gap-4'>
                ...
                <div className="flex flex-col gap-[8px] scr1300:col-span-4 scr1024:col-span-6 col-span-12 ">
                    ...
                    <Select
                        ...
                        className={`border rounded-[8px] h-[41.6px]  withoutBorder ${formError.country
                            ? "border-red"
                            : "border-[#DEDEDE]"
                            }`}
                ...
                <div className="flex flex-col gap-[8px] scr1300:col-span-4 scr1024:col-span-6 col-span-12">
                    ...
                    <div
                        className={`w-full flex gap-2  items-center border h-[41.6px]  rounded-[8px] px-2  ${formError.location
                            ? "border-red"
                            : "border-[#DEDEDE]"
                            }`}
                    >
