      ...
      >
        ...
        >
          ...
          <div className="flex gap-4">
            <div className="flex items-center rounded-lg border border-[#646464] bg-white text-[14px]  font-montserrat font-small  min-w-[80px] w-full overflow-hidden relative">
              <select
                // disabled={!isChecked}
            ...
            <div className="flex items-center rounded-lg border border-[#646464] bg-white text-[14px]  font-montserrat font-small relative min-w-[80px] w-full overflow-hidden">
              <select
