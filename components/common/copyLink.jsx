...
function CopyLink({ setShowPopup, generatedLink, popupRef }) {
  ...
  const handlePlatformShare = (platform) => {
    let modifiedLink = generatedLink;
    if (platform === "whatsapp") {
      modifiedLink += "&w=true";
      window.open(
        `https://wa.me/?text=${encodeURIComponent(modifiedLink)}`,
        "_blank"
      );
            ...
            <div className="flex ms:flex-row flex-col items-end gap-2">
              ...
              {!copied ? (
                ...
                >
                  ...
                  >
                    <path
                      d="M4.16913 7.3625L10.5254 1.00625C10.6754 0.85625 10.8504 0.78125 11.0504 0.78125C11.2504 0.78125 11.4254 0.85625 11.5754 1.00625C11.7254 1.15625 11.8004 1.33438 11.8004 1.54063C11.8004 1.74688 11.7254 1.925 11.5754 2.075L4.69413 8.975C4.54413 9.125 4.36913 9.2 4.16913 9.2C3.96913 9.2 3.79413 9.125 3.64413 8.975L0.419125 5.75C0.269125 5.6 0.19725 5.42188 0.2035 5.21563C0.20975 5.00938 0.287875 4.83125 0.437875 4.68125C0.587875 4.53125 0.766 4.45625 0.97225 4.45625C1.1785 4.45625 1.35662 4.53125 1.50662 4.68125L4.16913 7.3625Z"
                      fill="white"
                    />
                  </svg>
                  Link Copied
