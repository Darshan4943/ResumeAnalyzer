            ...
            <div className='customMargins w-full flex flex-col gap-6 py-[30px] transition-all duration-1000 ease-in-out'>
                ...
                <div className={`flex justify-evenly items-center flex-wrap  transition-all duration-1000 ease-in-out ${fade ? 'opacity-100' : 'opacity-0'}`}>
                    {steps.map((step, index) => (
                        <div key={index} className='flex flex-col items-center min-w-[272px] scr590:min-w-[362px] gap-2'>
                            <div className='flex flex-col items-center gap-4 w-[212px] scr590:w-[272px] transition-all duration-1000 ease-in-out'>
                                <img src={isCandidateView ? step.candidate.imgSrc : step.recruiter.imgSrc} alt='Step Image' className='w-[212px] scr590:w-[272px] h-[212px] scr590:h-[272px] object-contain' />
                                <p className='text-center text-[14px] font-semibold w-[200px]'>
                                    {isCandidateView ? step.candidate.name : step.recruiter.name}
                                </p>
                            </div>
                            <div className={index === steps.length - 1 ? 'w-0 h-0' : `w-[52px] h-[90px] flex items-center rotate-90`}>
