    ...
    <>
      ...
      {showResume ? (
        <>
          <div className="fixed z-[2000] top-0 left-0 right-0 bottom-0 bg-black opacity-60"></div>
          <div className="fixed z-[2000] top-0 left-0 right-0 bottom-0 flex items-center justify-center">
            <div className="bg-white rounded-[12px] px-8 pt-4 w-[730px] flex flex-col relative justify-between h-[470px] gap-4 overflow-y-scroll overflow-x-hidden ">
              {resumeList?.length > 0 ? (
                <div>
              ...
              <div className="flex justify-between p-4 sticky bottom-0 bg-white">
                <button
                  onClick={() =>{setLoading1(false); setShowResume(false)}}
