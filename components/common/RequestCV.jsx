                    ...
                    <div className="fixed z-[2000] top-0 left-0 right-0 bottom-0 flex items-center justify-center">
                        <div className="bg-white rounded-[12px] p-4 w-[700px] flex flex-col justify-between h-[400px] ">
                            ...
                            <div className="flex justify-between ">
                                <button onClick={() => setShowResume(false)} className="blue_border_Button px-6 h-[38px] rounded-[30px]">
                                    cancel
                                </button>
                                ...
                                {loading1 ?
                                    ...
                                    :
                                    <button onClick={handleSaveAll} className="bg_Button px-6 h-[38px] rounded-[30px] w-[77px]">
                                        Save
                                    </button>
                                }
                ...
                <div className='p-4 bg-white rounded-[16px] flex flex-col gap-4 min-h-[560px]'>
                    ...
                    {isResumes === "post" ?
                        <div>
                            ...
                            <SelectPostJd JobMatchforSkilotechCollection={JobMatchforSkilotechCollection} setSelectedJob={setSelectedJob} selectedJob={selectedJob} setResumeCount={setResumeCount} resumeCount={resumeCount} />
                        </div>

                        :

                        <ManualForm data={data} setData={setData} JobMatchforSkilotechCollection={JobMatchforSkilotechCollection} priority={priority} weightage={weightage} parameters={parameters} setResumeCount={setResumeCount} resumeCount={resumeCount} />
                    }
                </div>
