...
function BulkUploadPopUp({ setOpenPopup,setGetData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post(
        `https://api.skilotech.com/api/job/bulkUploadJobs/${userDataGlobal?._id}`,
        formData,
        {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 z-[9999] flex justify-center items-center">
      <div className="bg-white flex gap-4 flex-col  rounded-lg shadow-lg p-6 relative">
        ...
        <div className="text-[11px] font-[500] flex flex-col gap-2 w-full">
          <p>
            ...
            <span className="font-[400]">
              - Click on &quot;Download Bulk Upload File&quot; to get the
              required format.
            </span>
          </p>
          <p>
          ...
          <p>
            3. Upload the File{" "}
            <span className="font-[400]">
              - Click &quot;Browse&quot; or drag and drop your completed Bulk
              Upload file.
            </span>
          </p>
          <p>
        ...
        <div className="flex justify-end gap-4 ">
          <a
            href="https://freedygo-storage-bucket-production.s3.ap-south-1.amazonaws.com/Skilotech/Bulk_job_uploads.xlsx"
          ...
          {loading ? (
            <div className="flex items-center justify-center bg-blue h-[36px] w-[76.38px] rounded-[30px] ">
